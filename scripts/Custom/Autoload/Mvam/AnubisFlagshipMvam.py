...
MvamShips = ["AnubisFlagship", "Superweapon"]
...
IconNames = ["Power Up Weapon", "Power Down$Rein"]
...
def Superweapon(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def. (ie: "MvamGalaxySaucer")
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "Superweapon")
