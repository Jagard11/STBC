...
MvamShips = ["AlkeshTransport", "GoauldAlkesh", "Pod1", "Pod2", "Pod3", "Pod4"]
...
MvamDistances[0].SetXYZ(0.0, 1.600000, 0.000000)
MvamDistances[1].SetXYZ(0.0, 0.800000, 0.000000)
MvamDistances[2].SetXYZ(0.0, 0.000000, 0.000000)
MvamDistances[3].SetXYZ(0.0, -0.800000, 0.000000)
MvamDistances[4].SetXYZ(0.0, -1.600000, 0.000000)
...
MvamDirections[1].SetXYZ(0.0, 0.0, 0.0)
MvamDirections[2].SetXYZ(0.0, 0.0, 0.0)
MvamDirections[3].SetXYZ(0.0, 0.0, 0.0)
MvamDirections[4].SetXYZ(0.0, 0.0, 0.0)
...
MvamSpeeds = [2.0, 0.0, 0.0, 0.0, 0.0]
...
MvamReinSpeeds = [2.0, 0.0, 0.0, 0.0, 0.0]
...
def GoauldAlkesh(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def. (ie: "MvamGalaxySaucer")
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "GoauldAlkesh")
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "Pod1")
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "Pod2")


	pObject.CallNextHandler(pEvent)

###TO CHANGE: dont forget to change this name too.
def Pod3(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "Pod3")


	pObject.CallNextHandler(pEvent)

###TO CHANGE: dont forget to change this name too.
def Pod4(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "Pod4")
