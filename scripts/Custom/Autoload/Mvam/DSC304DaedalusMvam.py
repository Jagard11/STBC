...
MvamShips = ["DSC304Daedalus", "Daedalus", "F3021", "F3022", "F3023", "F3024", "F3025", "F3026"]
...
MvamReinDistances[1].SetXYZ(0.0, 2.300000, -0.080000)
MvamReinDistances[2].SetXYZ(0.0, 2.200000, -0.080000)
MvamReinDistances[3].SetXYZ(0.0, 2.100000, -0.080000)
MvamReinDistances[4].SetXYZ(0.0, 2.300000, -0.080000)
MvamReinDistances[5].SetXYZ(0.0, 2.200000, -0.080000)
MvamReinDistances[6].SetXYZ(0.0, 2.100000, -0.080000)
...
MvamReinSpeeds = [0.0, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3]
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def. (ie: "MvamGalaxySaucer")
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "Daedalus")
