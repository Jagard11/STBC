...
MvamShips = ["MvamPrometheus", "MvamPrometheusSaucer", "MvamPrometheusDorsal", "MvamPrometheusVentral"]
...
IconNames = ["Seperate - Saucer", "Seperate - Dorsal", "Seperate - Ventral", "Reintegrate$Rein"]
...
MvamDistances[0].SetXYZ(0.0, 0.828989, 0.144821)
MvamDistances[1].SetXYZ(0.0, -0.503057, 0.053076)
MvamDistances[2].SetXYZ(0.0, -0.512189, -0.20303)
...
MvamDirections[1].SetXYZ(0.0, 1.0, -0.25)
MvamDirections[2].SetXYZ(0.0, 1.0, -0.5)
...
MvamReinDistances[0].SetXYZ(0.0, -4.759312, 0.144821)
MvamReinDistances[1].SetXYZ(0.0, -5.924531, -1.3022925)
MvamReinDistances[2].SetXYZ(0.0, -5.510582, -2.702186)
...
MvamReinDirections[2].SetXYZ(0.0, 1.0, 0.5)
...
def MvamPrometheusSaucer(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def. (ie: "MvamGalaxySaucer")
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "MvamPrometheusSaucer")
...
def MvamPrometheusDorsal(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "MvamPrometheusDorsal")
...
###TO CHANGE: dont forget to change this name too.
def MvamPrometheusVentral(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "MvamPrometheusVentral")
