...
MvamShips = ["X303Refit", "PrometheusRefit", "F3021", "F3022", "F3023", "F3024", "F3025", "F3026"]
...
MvamDistances[1].SetXYZ(0.545, 0.000000, -0.120000)
MvamDistances[2].SetXYZ(0.545, -0.250000, -0.120000)
MvamDistances[3].SetXYZ(0.545, -0.500000, -0.120000)
MvamDistances[4].SetXYZ(-0.545, 0.000000, -0.120000)
MvamDistances[5].SetXYZ(-0.545, -0.250000, -0.120000)
MvamDistances[6].SetXYZ(-0.545, -0.500000, -0.120000)
...
MvamDirections[1].SetXYZ(0.0, 1.0, 0.1)
MvamDirections[2].SetXYZ(0.0, 1.0, 0.05)
MvamDirections[3].SetXYZ(0.0, 1.0, 0.0)
MvamDirections[4].SetXYZ(0.0, 1.0, 0.1)
MvamDirections[5].SetXYZ(0.0, 1.0, 0.05)
...
MvamSpeeds = [0.0, 2.5, 2.1, 1.7, 2.5, 2.1, 1.7]
...
MvamReinDirections[4].SetXYZ(0.0, -1.0, 0.25)
MvamReinDirections[5].SetXYZ(0.0, -1.0, 0.35)
MvamReinDirections[6].SetXYZ(0.0, -1.0, 0.45)
...
def PrometheusRefit(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def. (ie: "MvamGalaxySaucer")
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "PrometheusRefit")
