...
MvamShips = ["HatakRefit", "HatakRefit", "Glider1", "Glider2", "Glider3", "Glider4", "Glider5", "Glider6"]
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def. (ie: "MvamGalaxySaucer")
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "HatakRefit")
