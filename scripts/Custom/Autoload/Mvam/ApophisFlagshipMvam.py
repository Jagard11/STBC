...
MvamShips = ["ApophisFlagship", "Flagship"]
...
IconNames = ["Flight Mode", "Combat Mode$Rein"]
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def. (ie: "MvamGalaxySaucer")
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "Flagship")
