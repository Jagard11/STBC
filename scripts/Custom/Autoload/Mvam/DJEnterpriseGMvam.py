...
MvamShips = ["DJEnterpriseG", "DJEnterpriseGSaucer", "DJEnterpriseGDrive", "DJEnterpriseGThunderbird"]
...
IconNames = ["Sep - Saucer", "Sep - Drive", "Sep - Thunderbird", "Reintegrate$Rein"]
...
MvamDistances[0].SetXYZ(0.0, 3.0, 0.231)
MvamDistances[1].SetXYZ(0.0, -0.1, 0.0)
MvamDistances[2].SetXYZ(0.0, 4.95, -0.05)
...
#############    Get a ship by name: pShip1 = App.ShipClass_GetObject (pSet, "DJEnterpriseGSaucer")
...
MvamReinDistances[0].SetXYZ(0.0, 3.0, 2.95)
MvamReinDistances[1].SetXYZ(0.0, -0.05, 1.35)
MvamReinDistances[2].SetXYZ(0.0, 4.9, 0.05)
...
def DJEnterpriseGSaucer(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def. (ie: "MvamGalaxySaucer")
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "DJEnterpriseGSaucer")
...
def DJEnterpriseGDrive(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "DJEnterpriseGDrive")
...
###TO CHANGE: dont forget to change this name too.
def DJEnterpriseGThunderbird(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "DJEnterpriseGThunderbird")
