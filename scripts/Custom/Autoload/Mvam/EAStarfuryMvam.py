...
MvamShips = ["EAStarfury", "EAStarfuryEscapePod", "EAStarfuryNoEscapePod"]
...
def EAStarfuryEscapePod(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "EAStarfuryEscapePod")
...
def EAStarfuryNoEscapePod(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "EAStarfuryNoEscapePod")
