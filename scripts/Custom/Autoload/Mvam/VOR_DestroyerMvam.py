...
MvamShips = ["VOR_Destroyer", "VOR_DestroyerClosed"]
...
IconNames = ["Close Petals", "Open Petals$Rein"]
...
def VOR_DestroyerClosed(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def. (ie: "MvamGalaxySaucer")
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "VOR_DestroyerClosed")
