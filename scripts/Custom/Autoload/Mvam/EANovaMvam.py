...
MvamShips = ["EANova", "EANova", "EAStarfury", "EAStarfury1", "EAStarfury2", "EAStarfury3", "EAStarfury4", "EAStarfury5"]
...
MvamDistances[0].SetXYZ(0.0, 10.000000, 0.000000)
MvamDistances[1].SetXYZ(1.25, 11.125000, -1.050000)
MvamDistances[2].SetXYZ(-1.25, 11.125000, -1.050000)
MvamDistances[3].SetXYZ(1.35, 12.125000, -1.050000)
MvamDistances[4].SetXYZ(-1.35, 12.125000, -1.050000)
MvamDistances[5].SetXYZ(1.45, 13.125000, -1.050000)
MvamDistances[6].SetXYZ(-1.45, 13.125000, -1.050000)
...
MvamReinDistances[0].SetXYZ(0.0, 10.000000, 0.000000)
MvamReinDistances[1].SetXYZ(1.25, 11.125000, -1.050000)
MvamReinDistances[2].SetXYZ(-1.25, 11.125000, -1.050000)
MvamReinDistances[3].SetXYZ(1.35, 12.125000, -1.050000)
MvamReinDistances[4].SetXYZ(-1.35, 12.125000, -1.050000)
MvamReinDistances[5].SetXYZ(1.45, 13.125000, -1.050000)
MvamReinDistances[6].SetXYZ(-1.45, 13.125000, -1.050000)
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "EANova")
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "EAStarfury")
...
###TO CHANGE: dont forget to change this name too.
def EAStarfury1(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "EAStarfury1")
...
###TO CHANGE: dont forget to change this name too.
def EAStarfury2(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "EAStarfury2")
...
###TO CHANGE: dont forget to change this name too.
def EAStarfury3(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "EAStarfury3")
...
###TO CHANGE: dont forget to change this name too.
def EAStarfury4(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "EAStarfury4")


	pObject.CallNextHandler(pEvent)

###TO CHANGE: dont forget to change this name too.
def EAStarfury5(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "EAStarfury5")
