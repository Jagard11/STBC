...
MvamShips = ["PyramidShip", "PyramidShip", "Glider1", "Glider2", "Glider3", "Glider4"]
...
MvamDistances[1].SetXYZ(0.0, 2.125000, -0.850000)
MvamDistances[2].SetXYZ(0.0, 2.525000, -0.850000)
MvamDistances[3].SetXYZ(0.0, 3.125000, -0.850000)
MvamDistances[4].SetXYZ(0.0, 3.525000, -0.850000)
...
MvamSpeeds = [0.0, 1.25, 1.75, 2.25, 2.75]
...
MvamReinSpeeds = [0.0, 0.1, 0.1, 0,1, 0.1,]
...
def PyramidShip(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def. (ie: "MvamGalaxySaucer")
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "PyramidShip")
