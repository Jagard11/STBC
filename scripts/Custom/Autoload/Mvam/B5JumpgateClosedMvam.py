...
MvamShips = ["B5JumpgateClosed", "B5JumpgateOpen"]
...
IconNames = ["Open Jump point", "Power Down$Rein"]
...
def B5JumpgateOpen(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def. (ie: "MvamGalaxySaucer")
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "B5JumpgateOpen")
