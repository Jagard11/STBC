...
MvamShips = ["B5TechnomageTransport", "B5TechnomageTransportIllusion"]
...
IconNames = ["Cast Illusion", "Power Down$Rein"]
...
def B5TechnomageTransportIllusion(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def. (ie: "MvamGalaxySaucer")
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "B5TechnomageTransportIllusion")
