...
MvamShips = ["EAWorkerPod", "EAWorkerEscapePod", "EAWorkerNoEscapePod"]
...
MvamReinDistances[1].SetXYZ(0.0, 0.025000, 0.000000)
...
def EAWorkerEscapePod(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "EAWorkerEscapePod")
...
def EAWorkerNoEscapePod(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "EAWorkerNoEscapePod")
