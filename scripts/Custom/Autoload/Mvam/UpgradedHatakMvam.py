...
MvamShips = ["UpgradedHatak", "UpgradedHatak", "Glider1", "Glider2", "Glider3", "Glider4", "Glider5", "Glider6"]
...
IconNames = ["Launch Gliders", "Fly Glider"]
...
MvamDirections[1].SetXYZ(0.1, 1.0, 0.0)
MvamDirections[2].SetXYZ(-0.1, 1.0, 0.0)
MvamDirections[3].SetXYZ(0.25, 1.0, 0.0)
MvamDirections[4].SetXYZ(-0.25, 1.0, 0.0)
MvamDirections[5].SetXYZ(0.4, 1.0, 0.0)
MvamDirections[6].SetXYZ(-0.4, 1.0, 0.0)
...
MvamSpeeds = [0.0, 1.25, 1.25, 2.0, 2.0, 2.75, 2.75]
...
MvamReinDistances[1].SetXYZ(1.05, -0.100000, -1.150000)
MvamReinDistances[2].SetXYZ(-1.05, -0.100000, -1.150000)
MvamReinDistances[3].SetXYZ(1.05, -0.225000, -1.150000)
MvamReinDistances[4].SetXYZ(-1.05, -0.225000, -1.150000)
MvamReinDistances[5].SetXYZ(1.05, -0.350000, -1.150000)
MvamReinDistances[6].SetXYZ(-1.05, -0.350000, -1.150000)
...
MvamReinSpeeds = [0.0, 0.5, 0.5, 0,5, 0.5, 0.5, 0.5]
...
def UpgradedHatak(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def. (ie: "MvamGalaxySaucer")
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "UpgradedHatak")
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "Glider1")
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "Glider2")
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "Glider3")
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "Glider4")
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "Glider5")
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "Glider6")
