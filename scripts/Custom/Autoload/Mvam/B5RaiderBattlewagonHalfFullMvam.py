...
MvamShips = ["B5RaiderBattlewagonHalfFull", "B5RaiderBattlewagon", "B5ZephyrRaider", "B5ZephyrRaider2", "B5ZephyrRaider3", "B5ZephyrRaider4", "B5ZephyrRaider5", "B5ZephyrRaider6", "B5ZephyrRaider7", "B5ZephyrRaider8"]
...
IconNames = ["Launch raiders", "Pilot a raider", "Dock with Wagon$Rein"]
...
MvamDistances[3].SetXYZ(1.55, 1.125000, 0.550000)
MvamDistances[4].SetXYZ(-1.55, 1.125000, 0.550000)
MvamDistances[5].SetXYZ(1.95, 1.125000, -0.100000)
MvamDistances[6].SetXYZ(-1.95, 1.125000, -0.100000)
MvamDistances[7].SetXYZ(-1.54, 1.125000, -0.510000)
MvamDistances[8].SetXYZ(-1.54, 1.125000, -0.510000)
...
MvamDirections[3].SetXYZ(0.0, 1.0, 0.0)
MvamDirections[4].SetXYZ(0.0, 1.0, 0.0)
MvamDirections[5].SetXYZ(0.0, 1.0, 0.0)
MvamDirections[6].SetXYZ(0.0, 1.0, 0.0)
MvamDirections[7].SetXYZ(0.0, 1.0, 0.0)
MvamDirections[8].SetXYZ(0.0, 1.0, 0.0)
...
MvamSpeeds = [1.0, 4.0, 4.0, 4.0, 4.0, 4.0, 4.0, 4.0, 4.0]
...
MvamReinDistances[3].SetXYZ(1.55, -1.125000, 0.550000)
MvamReinDistances[4].SetXYZ(-1.55, -1.125000, 0.550000)
MvamReinDistances[5].SetXYZ(1.95, -1.125000, -0.100000)
MvamReinDistances[6].SetXYZ(-1.95, -1.125000, -0.100000)
MvamReinDistances[7].SetXYZ(-1.54, -1.125000, -0.510000)
MvamReinDistances[8].SetXYZ(-1.54, -1.125000, -0.510000)
...
MvamReinDirections[3].SetXYZ(0.0, 1.0, 0.0)
MvamReinDirections[4].SetXYZ(0.0, 1.0, 0.0)
MvamReinDirections[5].SetXYZ(0.0, 1.0, 0.0)
MvamReinDirections[6].SetXYZ(0.0, 1.0, 0.0)
MvamReinDirections[7].SetXYZ(0.0, 1.0, 0.0)
MvamReinDirections[8].SetXYZ(0.0, 1.0, 0.0)
...
MvamReinSpeeds = [0.3, 0.3, 0.3, 0,3, 0.3, 0.3, 0.3, 0.3, 0.3]
...
def B5RaiderBattlewagon(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "B5RaiderBattlewagon")
...
def B5ZephyrRaider(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "B5ZephyrRaider")
...
###TO CHANGE: dont forget to change this name too.
def B5ZephyrRaider2(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "B5ZephyrRaider2")
...
###TO CHANGE: dont forget to change this name too.
def B5ZephyrRaider3(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "B5ZephyrRaider3")
...
###TO CHANGE: dont forget to change this name too.
def B5ZephyrRaider4(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "B5ZephyrRaider4")
...
###TO CHANGE: dont forget to change this name too.
def B5ZephyrRaider5(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "B5ZephyrRaider5")


	pObject.CallNextHandler(pEvent)

###TO CHANGE: dont forget to change this name too.
def B5ZephyrRaider6(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "B5ZephyrRaider6")


	pObject.CallNextHandler(pEvent)

###TO CHANGE: dont forget to change this name too.
def B5ZephyrRaider7(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "B5ZephyrRaider7")


	pObject.CallNextHandler(pEvent)

###TO CHANGE: dont forget to change this name too.
def B5ZephyrRaider8(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "B5ZephyrRaider8")
...
def CheckSeperate (pShip):
	...
	if (pEnemies.IsNameInGroup(pShip.GetName())):
		#seperate if there is a hostile
		if ((pFriendlies.GetNumActiveObjects() >= 1)):
			return 1
	...
	#the ship is a friendly or neutral
		...
		#seperate if there is a hostile
		if (pEnemies.GetNumActiveObjects() >= 1):
			return 1
		#seperate if 50% damaged and enemies or friendlies are in the area
		if ((pShip.GetHull().GetConditionPercentage() <= 0.5) and ((pEnemies.GetNumActiveObjects() >= 1 ) or (pFriendlies.GetNumActiveObjects() >= 1)) and (snkAiRanSep == 4)):
			return 1
	return 0
