...
MvamShips = ["Galaxy", "GalaxySaucer", "GalaxyStardrive"]
...
IconNames = ["Saucer Seperate", "Stardrive Seperate", "Reintegrate$Rein"]
...
MvamDistances[0].SetXYZ(0.05, 2.4, 0.42)
MvamDistances[1].SetXYZ(0.0, 0.0, 0.0)
...
MvamDirections[1].SetXYZ(0.0, 1.0, -0.5)
...
MvamReinDistances[0].SetXYZ(0.0, 0.6, 8.6)
MvamReinDistances[1].SetXYZ(0.0, -2.0, 6.7)
...
MvamReinDirections[1].SetXYZ(0.0, 1.0, 0.5)
...
def GalaxySaucer(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def. (ie: "MvamGalaxySaucer")
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "GalaxySaucer")
...
def GalaxyStardrive(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "GalaxyStardrive")
