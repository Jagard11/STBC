...
MvamShips = ["VOR_Fighter", "VOR_FighterOpen"]
...
IconNames = ["Open Petals", "Close Petals$Rein"]
...
def VOR_FighterOpen(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def. (ie: "MvamGalaxySaucer")
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "VOR_FighterOpen")
