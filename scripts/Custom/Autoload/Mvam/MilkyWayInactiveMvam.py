...
MvamShips = ["MilkyWayInactive", "MilkyWayActive"]
...
IconNames = ["Dial Gate", "Shut Down$Rein"]
...
def MilkyWayActive(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def. (ie: "MvamGalaxySaucer")
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "MilkyWayActive")
