...
MvamShips = ["DSC304OdysseyUpgrade", "OdysseyUpgrade", "F3021", "F3022", "F3023", "F3024", "F3025", "F3026"]
...
MvamDistances[1].SetXYZ(0.615, 0.300000, -0.080000)
MvamDistances[2].SetXYZ(0.615, -0.100000, -0.080000)
MvamDistances[3].SetXYZ(0.615, -0.500000, -0.080000)
MvamDistances[4].SetXYZ(-0.615, 0.300000, -0.080000)
MvamDistances[5].SetXYZ(-0.615, -0.100000, -0.080000)
MvamDistances[6].SetXYZ(-0.615, -0.500000, -0.080000)
...
MvamDirections[1].SetXYZ(0.0, 1.0, 0.025)
MvamDirections[2].SetXYZ(0.0, 1.0, 0.0125)
MvamDirections[3].SetXYZ(0.0, 1.0, 0.0)
MvamDirections[4].SetXYZ(0.0, 1.0, 0.025)
MvamDirections[5].SetXYZ(0.0, 1.0, 0.0125)
...
MvamSpeeds = [0.0, 2.55, 2.15, 1.75, 2.55, 2.15, 1.75]
...
def OdysseyUpgrade(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def. (ie: "MvamGalaxySaucer")
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "OdysseyUpgrade")
