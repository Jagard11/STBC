...
MvamShips = ["HatakVariant", "HatakVariant", "Glider1", "Glider2", "Glider3", "Glider4", "Glider5", "Glider6"]
...
MvamReinDirections[1].SetXYZ(0.1, -1.0, 0.0)
MvamReinDirections[2].SetXYZ(-0.1, -1.0, 0.0)
MvamReinDirections[3].SetXYZ(0.25, -1.0, 0.0)
MvamReinDirections[4].SetXYZ(-0.25, -1.0, 0.0)
MvamReinDirections[5].SetXYZ(0.4, -1.0, 0.0)
MvamReinDirections[6].SetXYZ(-0.4, -1.0, 0.0)
...
MvamReinSpeeds = [0.0, 0.1, 0.1, 0,1, 0.1, 0.5, 0.1]
...
def HatakVariant(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def. (ie: "MvamGalaxySaucer")
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "HatakVariant")
