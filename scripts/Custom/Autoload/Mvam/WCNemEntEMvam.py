...
MvamShips = ["Sovereign", "WCNemEntEnoyacht", "WCNemEntEyacht"]
...
IconNames = ["Sovereign No Yacht", "Captains Yacht Seperate", "Reintegrate$Rein"]
...
MvamDistances[1].SetXYZ(-0.001895, 1.788826, -0.06)
...
MvamDirections[0].SetXYZ(0.0, 0.0, 0.1)
MvamDirections[1].SetXYZ(0.0, 0.0, -0.3)
...
MvamReinDistances[1].SetXYZ(-0.001895, 1.788826, -0.38)
...
MvamReinDirections[0].SetXYZ(0.0, 0.0, -3.0)
MvamReinDirections[1].SetXYZ(0.0, 0.0, 1.5)
...
def WCNemEntEnoyacht(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def. (ie: "MvamGalaxySaucer")
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "WCNemEntEnoyacht")
...
def WCNemEntEyacht(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "WCNemEntEyacht")
