...
MvamShips = ["PuddleJumper", "ClosedJumper"]
...
IconNames = ["Retract Pods", "Deploy Pods$Rein"]
...
def ClosedJumper(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def. (ie: "MvamGalaxySaucer")
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "ClosedJumper")
