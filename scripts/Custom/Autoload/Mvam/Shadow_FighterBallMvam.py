...
MvamShips = ["Shadow_FighterBall", "Shadow_Fighter1", "Shadow_Fighter2", "Shadow_Fighter3", "Shadow_Fighter4", "Shadow_Fighter5", "Shadow_Fighter6", "Shadow_Fighter7"]
...
def Shadow_Fighter1(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "Shadow_Fighter1")
...
def CheckSeperate (pShip):
	...
	snkAiRanSep = App.g_kSystemWrapper.GetRandomNumber(5)
        ...
        #This needs to separate immediately
	return 1
