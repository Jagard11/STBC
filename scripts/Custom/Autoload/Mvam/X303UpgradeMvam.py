...
MvamShips = ["X303Upgrade", "PrometheusUpgrade", "F3021", "F3022", "F3023", "F3024", "F3025", "F3026"]
...
IconNames = ["Launch F302s", "Fly F302"]
...
MvamDistances[1].SetXYZ(0.0, 1.800000, 0.125000)
MvamDistances[2].SetXYZ(0.0, 1.450000, 0.125000)
MvamDistances[3].SetXYZ(0.0, 1.100000, 0.125000)
MvamDistances[4].SetXYZ(0.0, 0.750000, 0.125000)
MvamDistances[5].SetXYZ(0.0, 0.400000, 0.125000)
MvamDistances[6].SetXYZ(0.0, 0.050000, 0.125000)
...
MvamDirections[0].SetXYZ(0.0, 0.0, 0.0)
MvamDirections[1].SetXYZ(0.0, 1.0, 0.40)
MvamDirections[2].SetXYZ(0.0, 1.0, 0.35)
MvamDirections[3].SetXYZ(0.0, 1.0, 0.30)
MvamDirections[4].SetXYZ(0.0, 1.0, 0.25)
MvamDirections[5].SetXYZ(0.0, 1.0, 0.20)
MvamDirections[6].SetXYZ(0.0, 1.0, 0.15)
...
MvamSpeeds = [0.0, 2.65, 2.45, 2.25, 2.05, 1.85, 1.65]
...
MvamReinDistances[0].SetXYZ(0.0, 0.000000, 0.144821)
MvamReinDistances[1].SetXYZ(0.0, -0.003057, 1.553076)
MvamReinDistances[2].SetXYZ(0.0, -0.012189, 1.50303)
MvamReinDistances[3].SetXYZ(0.0, -0.024000, 1.55303)
MvamReinDistances[4].SetXYZ(0.0, -0.024000, 1.50303)
MvamReinDistances[5].SetXYZ(0.0, -0.024000, -2.25303)
MvamReinDistances[6].SetXYZ(0.0, -0.024000, -2.30303)
...
MvamReinDirections[1].SetXYZ(0.0, -1.0, -0.25)
MvamReinDirections[2].SetXYZ(0.0, -1.0, -0.35)
MvamReinDirections[3].SetXYZ(0.0, -1.0, -0.45)
MvamReinDirections[4].SetXYZ(0.0, -1.0, -0.55)
MvamReinDirections[5].SetXYZ(0.0, -1.0, 0.25)
MvamReinDirections[6].SetXYZ(0.0, -1.0, 0.35)
...
MvamReinSpeeds = [0.0, 0.8, 0.8, 0.8, 0.8, 0.8, 0.8]
...
BridgeSoundName = "MvamPromBridge"
...
############# file too, if you decide to have one. Leave blank ("") if you don't want a sound
BridgeReinSoundName = "MvamPromBridgeRein"
...
def PrometheusUpgrade(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def. (ie: "MvamGalaxySaucer")
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "PrometheusUpgrade")
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "F3021")
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "F3022")


	pObject.CallNextHandler(pEvent)

###TO CHANGE: dont forget to change this name too.
def F3023(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "F3023")


	pObject.CallNextHandler(pEvent)

###TO CHANGE: dont forget to change this name too.
def F3024(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "F3024")


	pObject.CallNextHandler(pEvent)

###TO CHANGE: dont forget to change this name too.
def F3025(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "F3025")


	pObject.CallNextHandler(pEvent)

###TO CHANGE: dont forget to change this name too.
def F3026(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "F3026")
