...
MvamShips = ["AlphaWing", "AlphaWingEscapePod", "AlphaWingNoEscapePod"]
...
def AlphaWingEscapePod(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "AlphaWingEscapePod")
...
def AlphaWingNoEscapePod(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "AlphaWingNoEscapePod")
