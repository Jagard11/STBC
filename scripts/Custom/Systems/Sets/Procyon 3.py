...
Name = "Procyon 3"
AltName = "Alpha Canis Minoris 3"
ScriptFile = "Systems.Procyon.Procyon3"
Economy = 0
StrategicValue = 30
DefaultDefence = 0
Description = "Procyon 3 doesn't have any astronomical bodies, but it still bears stratetical importance being the border set of a important Federation system."
