...
Name = "Ascella 3"
AltName = "Ascella 3"
ScriptFile = "Systems.Ascella.Ascella3"
Economy = 0
StrategicValue = 0
DefaultDefence = 0
Description = "Ascella 3 is a dull dusty planet in the heart of the Ascella system, The Planet is similar to earths moon with the acceptation that Ascella 3 is much bigger."
