...
Name = "Kavis Alpha 2"
AltName = "Kavis Alpha II"
ScriptFile = "Systems.KavisAlpha.KavisAlpha2"
Economy = 0
StrategicValue = 0
DefaultDefence = 0
Description = "Just like Kavis Alpha 3, Kavis Alpha 2 is a lonely class-K planet with a few nebulas around."
