...
Name = "CJones8"
AltName = "CJones 8"
ScriptFile = "Systems.CJones.CJones8"
Economy = 0
StrategicValue = 1
DefaultDefence = 0
Description = "On this Planet is Thalaron radiation, so the Tholians use it to execute slaves (and similar) ."
