...
Name = "Beol 1"
AltName = "Beol 1"
ScriptFile = "Systems.Beol.Beol1"
Economy = 10
StrategicValue = 10
DefaultDefence = 10
Description = "Beol 1 is a gas giant located near to the Beol Star it is unusual for a gas giant to be so close to a star, Due to the high levels of solar heat several of the moons are class O however some could be terraformed to class M"
