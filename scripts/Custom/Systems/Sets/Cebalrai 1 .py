...
Name = "Cebalrai 1 "
AltName = "Cebalrai 1"
ScriptFile = "Systems.Cebalrai.Cebalrai1"
Economy = 10
StrategicValue = 10
DefaultDefence = 10
Description = "Cebalrai 1 is a gas giant located close to the Cebalrai star it is surrounded by a faint ring system which is slowly being erroded by the solar wind from the Cebalrai star, The system also features a dense asteroid belt which formed when the Moons orbiting the planet exploded due to the intense heat from the Cebalrai sun"
