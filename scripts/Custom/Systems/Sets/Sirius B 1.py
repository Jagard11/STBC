...
Name = "Sirius B 1"
AltName = "Alpha Canis Majoris I"
ScriptFile = "Systems.Sirius_B.Sirius_B1"
Economy = 0
StrategicValue = 0
DefaultDefence = 0
Description = "This set however, besides the 2 suns like Sirius B 2 has, also has a bit of ship activity: some ships, of different races, can be found flying here, possibly battling eachother or you if you come in."
