...
Name = "Ona 2"
AltName = "Ona 2"
ScriptFile = "Systems.Ona.Ona2"
Economy = 5
StrategicValue = 5
DefaultDefence = 5
Description = "Ona 2 is a gas giant located in the Ona System before the Sun turned Red giant Ona 2 would have been the largest gas giant recorded by the federation, However when the Sun turned red giant much of Ona2s cloud layer was stripped away"
