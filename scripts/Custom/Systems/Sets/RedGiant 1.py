...
Name = "RedGiant 1"
AltName = "RedGiant 1"
ScriptFile = "Systems.RedGiant.RedGiant1"
Economy = 0
StrategicValue = 0
DefaultDefence = 0
Description = "A system containing 1 red giant star, and 2 smaller stars. The fact that it doesn't contain anything else, like a planet or a moon, is probably the reason why this system is so uninportant, and with no apparent controlling empire."
