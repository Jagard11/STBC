...
Name = "Tevron 2"
AltName = "Tevron 2"
ScriptFile = "Systems.Tevron.Tevron2"
Economy = 10
StrategicValue = 10
DefaultDefence = 0
Description = "Tevron 2 lies at the outermost edge of the Tevron System The planet is class P and is mostly covered in Ice, Increased heat from the Tevron Star has lead to the Surface temperature rising and some of the ice melting scientists believe that at some point in the near future the planet may support live, as will its Moon which is in a similar state of melting."
