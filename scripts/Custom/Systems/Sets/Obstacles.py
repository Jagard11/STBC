...
Name = "Obstacles"
AltName = "Obstacles"
ScriptFile = "Systems.Obstacles.Obstacles1"
Economy = 0
StrategicValue = 0
DefaultDefence = 0
Description = "A star, one planet and it's moon. Lots of asteroids. One starbase, used as a resupply and repair base to the ships training, and as a spectators' spot to see the ships.  Those are the things to be found here."
