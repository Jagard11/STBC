...
Name = "Itari 2"
AltName = "Itari 2"
ScriptFile = "Systems.Itari.Itari2"
Economy = 10
StrategicValue = 10
DefaultDefence = 10
Description = "Itari 2 Is similar to venus in the Sol system the difference being the planets distictive purple surface clouds."
