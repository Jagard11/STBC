...
Name = "Unicomplex"
AltName = "Unicomplex"
ScriptFile = "Systems.Unicomplex.Unicomplex1"
Economy = 800
StrategicValue = 500
DefaultDefence = 30
Description = "This System is where the Queen of the Borg is located."
Biographical = Description

##########  SYSTEM ENVIRONMENTAL INFORMATION  ##########
#####  RADIATIONS  (0.1 = lowest possible ,  10.0 = maximum possible) #####
ChronitonRadiation = 1.1
CosmicRadiation = 3.1
DeltaRadiation = 0.1
EMRadiation = 0.1
GammaRadiation = 0.6
