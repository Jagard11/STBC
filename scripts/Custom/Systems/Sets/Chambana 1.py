...
Name = "Chambana 1"
AltName = "Chambana 1"
ScriptFile = "Systems.Chambana.Chambana1"
Economy = 10
StrategicValue = 10
DefaultDefence = 10
Description = "Chambana 1 is a purple planet which is on the verge of becoming uninhabital due to increased radiation from the dieing Chambana star."
