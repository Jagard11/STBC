...
Name = "Sol 3"
AltName = "Earth"
ScriptFile = "Systems.Sol.Sol3"
Economy = 800
StrategicValue = 1000
DefaultDefence = 1000
Description = "The only Class-M planet in the Sol system, and 3rd in line, Earth is the homeworld of the humans, one of the founding races of the United Federation of Planets. It has one moon, which is simply called as 'Moon'. The Federation's Council, Starfleet Command, and a few other places of top-most importance to the Federation are located in this planet, making it the most defended planet of the Federation."
