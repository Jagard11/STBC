...
Name = "Rainbow 2"
AltName = "Rainbow Copy"
ScriptFile = "Systems.Rainbow.Rainbow2"
Economy = 0
StrategicValue = 0
DefaultDefence = 0
Description = "This set, just like Rainbow 1, shows Rainbow's 4 stars, 3 planets, and some nebulas. The main presence of the unknown insectoid species is a outpost."
