...
Name = "GasGiant 1"
AltName = "GasGiant 1"
ScriptFile = "Systems.GasGiant.GasGiant1"
Economy = 0
StrategicValue = 0
DefaultDefence = 0
Description = "Strange system with a nebula, 1 identified planet, and another one which is unknown. A few ships can also be found roaming around the system."
