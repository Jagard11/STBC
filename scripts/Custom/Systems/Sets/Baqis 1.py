...
Name = "Baqis 1"
AltName = "Baqis I"
ScriptFile = "Systems.Baqis.Baqis1"
Economy = 0
StrategicValue = 0
DefaultDefence = 0
Description = "Baqis 1 is the name of the set itself, because unlike most cases in which the set's name matches the name of the most proficient planet in it, Baqis 1 doesn't have any planets. It is a zero-importance set, holding only it's three stars and various nebulas."
