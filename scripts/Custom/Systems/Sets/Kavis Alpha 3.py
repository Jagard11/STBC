...
Name = "Kavis Alpha 3"
AltName = "Kavis Alpha III"
ScriptFile = "Systems.KavisAlpha.KavisAlpha3"
Economy = 0
StrategicValue = 0
DefaultDefence = 0
Description = "Kavis Alpha 3 is a importanceless class-N planet, with just a few nebulas to keep him in company."
