...
Name = "Kavis Alpha 1"
AltName = "Kavis Alpha I"
ScriptFile = "Systems.KavisAlpha.KavisAlpha1"
Economy = 0
StrategicValue = 0
DefaultDefence = 0
Description = "Also just like Kavis Alpha 2 and 3, KA 1 is a class D planet with a few nebulas around."
