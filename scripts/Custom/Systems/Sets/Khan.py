...
Name = "Khan"
AltName = "Regula/Ceti Alpha"
ScriptFile = "Systems.Khan.Khan1"
Economy = 2
StrategicValue = 12
DefaultDefence = 2
Description = "This set mixes both the Regula system and the Ceti Alpha system. Thus containing the Regula star and planet, the Ceti Alpha star and it's 6 planets, the Regula Nebula, Khan's ship, the Botany Bay, and the Regula Science Station."
