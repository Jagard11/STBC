...
Name = "Junkyard"
AltName = "Junkyard"
ScriptFile = "Systems.Junkyard.Junkyard1"
Economy = 3
StrategicValue = 1
DefaultDefence = 0
Description = "In here you'll find the system's star, various ship hulks from various species, and a Cardassian Starbase guarding the system. The system itself is of a pretty low importance."
