...
Name = "Tezle 1"
AltName = "Tezle 1"
ScriptFile = "Systems.Tezle.Tezle1"
Economy = 20
StrategicValue = 10
DefaultDefence = 10
Description = "Tezle 1 is Blue gas giant in close proximity to the Tezle Star some scientists believe that had Tezle 1 become larger it would have eventually become a star making Tezle the only binary system in the Measlstrom."
