...
Name = "Banzai"
AltName = "Banzai"
ScriptFile = "Systems.Banzai.Banzai1"
Economy = 4
StrategicValue = 6
DefaultDefence = 1
Description = "For such a distant system from the Federation core center, this system does have quite a activity in it. Besides it's astronomical bodies, and the Federation Outpost, it has also some ships, some friendly, some not."
