...
Name = "Comet"
AltName = "Regula"
ScriptFile = "Systems.Comet.Comet1"
Economy = 3
StrategicValue = 10
DefaultDefence = 2
Description = "In the astronomical bodies classification, the Comet set contains only 1 sun, called Regula, various nebulae and the comet. However, this set also contains a cardassian starbase, that gives it the economical, strategical and defensive values it has."
