...
Name = "Sirius B 2"
AltName = "Alpha Canis Majoris II"
ScriptFile = "Systems.Sirius_B.Sirius_B2"
Economy = 0
StrategicValue = 0
DefaultDefence = 0
Description = "Sirius B  2 would be a completely empty region of space if it weren't for the 2 suns."
