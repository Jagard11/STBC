...
Name = "Calufrax 3"
AltName = "Calufrax III"
ScriptFile = "Systems.Calufrax.Calufrax3"
Economy = 3
StrategicValue = 3
DefaultDefence = 0
Description = "In this set, the main noticeable thing that the Kessok population made was a communications array. You can also find here various nebulas besides some planets and their moons."
