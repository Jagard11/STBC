...
Name = "Pleides 1"
AltName = "Pleides I"
ScriptFile = "Systems.Pleides.Pleides1"
Economy = 2
StrategicValue = 0
DefaultDefence = 0
Description = "The class-M planet Pleides 1, the single planet in the Pleides system, is actually named Eridian, and has a couple of nebula as neighboors, besides the fact that it is lighted by 11 stars."
