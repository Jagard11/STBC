...
Name = "Alioth 3"
AltName = "Alioth 3"
ScriptFile = "Systems.Alioth.Alioth3"
Economy = 0
StrategicValue = 0
DefaultDefence = 0
Description = "Alioth 3 is a Class G Planet in the Alioth System it is Similar in size to that of venus and also has a Dense layer of Clouds, Unlike venus these clouds keep the planets temperatur well below normal levels."
