...
Name = "String 1"
AltName = "String I"
ScriptFile = "Systems.String.String1"
Economy = 0
StrategicValue = 2
DefaultDefence = 0
Description = "Like it was already noted, the set besides having multiple stars, also has a Cardassian and a Federation outpost. Besides that, it's importance is minimal, and the major part it has comes from the fact that it is a border region."
