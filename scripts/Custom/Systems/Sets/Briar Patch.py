...
Name = "Briar Patch"
AltName = "Ba'ku "
ScriptFile = "Systems.BriarPatch.BriarPatch1"
Economy = 9
StrategicValue = 35
DefaultDefence = 5
Description = "The Briar Patch has 2 suns, the ringed Ba'ku homeworld, and various nebulae. You can also find the wreckage of a sunbuster here. This region is very important for the Son'a, because of the metaphasic radiation from the Ba'ku rings, and so they have taken it. Thus caution is advised when entering this region, as the Son'a can send ships to fight you."
