...
Name = "Canopus 1"
AltName = "Alpha Carinae I"
ScriptFile = "Systems.Canopus.Canopus1"
Economy = 4
StrategicValue = 4
DefaultDefence = 0
Description = "The first planet of the Canopus system is a Class J planet. This set also contains Canopus 1 moons: a class D and a class F."
