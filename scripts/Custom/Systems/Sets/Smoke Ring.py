...
Name = "Smoke Ring"
AltName = "Smoke Ring"
ScriptFile = "Systems.SmokeRing.SmokeRing1"
Economy = 0
StrategicValue = 0
DefaultDefence = 0
Description = "The nebulas that exist here for a strange pattern. The system also has some debris floating around. Plus, you can find here 2 barely operational ships, that have battled to the last degree, in a struggle to survive, in a fight with no winners."
