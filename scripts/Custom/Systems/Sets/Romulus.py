...
Name = "Romulus"
AltName = "Romulus & Remus"
ScriptFile = "Systems.Romulus.Romulus1"
Economy = 750
StrategicValue = 1000
DefaultDefence = 1000
Description = "The homeworld of the Romulans has one moon planet, called Remus, which has always one side turned to their star, and a bunch of dilithium mines, and a nebula. A few Romulan Warbirds can be found patrolling the set, yet more reinforcements can come anytime if Romulus is found under attack by an race enemy to the empire."
