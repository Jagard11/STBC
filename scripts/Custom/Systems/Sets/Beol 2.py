...
Name = "Beol 2"
AltName = "Beol 2"
ScriptFile = "Systems.Beol.Beol2"
Economy = 2
StrategicValue = 2
DefaultDefence = 2
Description = "Beol 2 is a Binary planetary system Beol 2a is class M planet with little abundance of Surface water most of it being deep below the planets crust Starfleeet has proposed a colony in this system for many years but the cardassians objected."
