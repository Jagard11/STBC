...
Name = "Void 1"
AltName = "Emptiness"
ScriptFile = "Systems.Void.Void1"
Economy = 0
StrategicValue = 0
DefaultDefence = 0
Description = "Completely emptied system. If you are lucky, it is possible that you find a asteroid floating around, cortesy of a few comets that passes by from time to time."
