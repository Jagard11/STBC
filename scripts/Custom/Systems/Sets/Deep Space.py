...
Name = "Deep Space"
AltName = "Deep Space"
ScriptFile = "Systems.DeepSpace.DeepSpace"
Economy = 0
StrategicValue = 0
DefaultDefence = 0
Description = "Deep Space is a empty system, with no strategical or economical importance, located in the far border of the Maelstrom, opposite to the Maelstrom-Federation border."
