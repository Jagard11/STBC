...
Name = "Calufrax 2"
AltName = "Calufrax II"
ScriptFile = "Systems.Calufrax.Calufrax2"
Economy = 3
StrategicValue = 4
DefaultDefence = 0
Description = "Here is where the main part of the Kessok population has settled in, and they have left one of their two battle ships that came in pattroling this set."
