...
Name = "Belaruz 4"
AltName = "Belaruz 4"
ScriptFile = "Systems.Belaruz.Belaruz4"
Economy = 10
StrategicValue = 20
DefaultDefence = 21
Description = "Belaruz Is located near the Edge of the Mealstrom It is home to the only M-Class Planet in the mealstrom that does not require terraforming, The many space faring species have not settled a colonoy on the planet due to the lack of a sun which will eventually render the planet uninhabitable"
