...
Name = "Arcturus 1"
AltName = "Alpha Bootis I"
ScriptFile = "Systems.Arcturus.Arcturus1"
Economy = 5
StrategicValue = 0
DefaultDefence = 0
Description = "The closest planet to the two suns of this system is a Y class planet that has a class H moon."
