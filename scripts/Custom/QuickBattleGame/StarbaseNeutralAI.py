...
def CreateAI(pShip):
	#########################################
	# Creating CompoundAI StarbaseAttackNeutrals2 at (250, 54)
	import AI.Compound.StarbaseAttack
	pStarbaseAttackNeutrals2 = AI.Compound.StarbaseAttack.CreateAI(pShip, App.ObjectGroup_FromModule("Custom.QuickBattleGame.QuickBattle", "pNeutrals2"))
	# Done creating CompoundAI StarbaseAttackNeutrals2
	#########################################
	#########################################
	...
	pPriorityList.AddAI(pStarbaseAttackNeutrals2, 1)
