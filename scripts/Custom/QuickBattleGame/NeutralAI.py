...
def CreateAI(pShip, aiLevel, warp):
	#########################################
	# Creating CompoundAI AttackNeutrals2 at (19, 36)
	import AI.Compound.BasicAttack
	pAttackNeutrals2 = AI.Compound.BasicAttack.CreateAI(pShip, App.ObjectGroup_FromModule('Custom.QuickBattleGame.QuickBattle', 'pNeutrals2'), Difficulty=aiLevel, FollowTargetThroughWarp=warp, UseCloaking = 1)
	# Done creating CompoundAI AttackNeutrals2
	#########################################
	#########################################
	# Creating CompoundAI AttackEnemies at (138, 36)
	import AI.Compound.BasicAttack
	pAttackEnemies = AI.Compound.BasicAttack.CreateAI(pShip, App.ObjectGroup_FromModule('Custom.QuickBattleGame.QuickBattle', 'pEnemies'), Difficulty=aiLevel, FollowTargetThroughWarp=warp, UseCloaking = 1)
	...
	pPriorityList.AddAI(pAttackNeutrals2, 1)
