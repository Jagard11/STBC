...
# Config path
sPath = "scripts\\Custom\\UnifiedMainMenu\\ConfigModules\\Options\\SavedConfigs\\JumpspaceConfiguration.py"
...
# dicts
dGFXTunnel = {"Default" : "Default", "Alternate 1" : "JumpspaceTunnelAlt1.tga", "Alternate 2" : "JumpspaceTunnelAlt2.tga", "Alternate 3" : "JumpspaceTunnelAlt3.tga", "Alternate 4" : "JumpspaceTunnelAlt4.tga", "Alternate 5" : "JumpspaceTunnelAlt5.tga", "Alternate 6" : "JumpspaceTunnelAlt6.tga", "Alternate 7" : "JumpspaceTunnelAlt7.tga"}
dGFXTunnelTrans = {"Default" : "Default", "JumpspaceTunnelAlt1.tga" : "Alternate 1", "JumpspaceTunnelAlt2.tga": "Alternate 2", "JumpspaceTunnelAlt3.tga" : "Alternate 3", "JumpspaceTunnelAlt4.tga" : "Alternate 4", "JumpspaceTunnelAlt5.tga" : "Alternate 5", "JumpspaceTunnelAlt6.tga" : "Alternate 6", "JumpspaceTunnelAlt7.tga" : "Alternate 7"}
dFlash = {"Default" : "Default", "Alternate" : "JumpspaceFlashAlternate.tga"}
dFlashTrans = {"Default" : "Default", "JumpspaceFlashAlternate.tga" : "Alternate"}
dBackdrop = {"Default" : "Default", "Alternate" : "JumpspaceBackdropAlt.tga", "Off" : "Off"}
dBackdropTrans = {"Default" : "Default", "JumpspaceBackdropAlt.tga" : "Alternate", "Off" : "Off"}


# Returns a name to Unified Main Menu
def GetName():
        return "The Jumpspace"
...
def CreateGFXOptions(pOptionPane, pContentPanel):
        ...
        pMainMenu = App.STCharacterMenu_Create("Jumpspace GFX")
        ...
        for s in lGFXTunnel:
            if dGFXTunnelTrans[JumpspaceConfiguration.TunnelGFX] == s:
                pGFX.SetName(App.TGString("Tunnel GFX:  " + s))
                break

        for s in lFlash:
            if dFlashTrans[JumpspaceConfiguration.FlashGFX] == s:
                pFlash.SetName(App.TGString("Flash GFX:  " + s))
                break

        for s in lBackdrop:
            if dBackdropTrans[JumpspaceConfiguration.BackdropGFX] == s:
...
def CreateMiscOptions(pOptionPane, pContentPanel):
        ...
        pLoop = JumpspaceConfiguration.LoopSound
        ...
        pPrints = JumpspaceConfiguration.Prints
        ...
        pArrivingAt = JumpspaceConfiguration.ArrivingAt
...
def CreateAdditionalOptions(pOptionPane, pContentPanel):
        ...
        pButton = CreateButton("Jumpspace Credits", pMainMenu, pOptionPane, pContentPanel, __name__ + ".ModCredits", EventInt = 0)
...
def PreviewAllGFX(pObject, pEvent):
        ...
        from Custom.Jumpspace.Libs import PreviewVid
...
def ModCredits(pObject, pEvent):
        from Custom.Jumpspace.Libs import Credits
...
def SaveConfiguration(strGFX = None, strFlash = None, strBackdrop = None):
        ...
        if not strGFX == None:
            ...
            sGFX = JumpspaceConfiguration.TunnelGFX
        if not strFlash == None:
            sFlash = dFlash[strFlash]
        else:
            sFlash = JumpspaceConfiguration.FlashGFX
        if not strBackdrop == None:
            sBackdrop = dBackdrop[strBackdrop]
        else:
            sBackdrop = JumpspaceConfiguration.BackdropGFX
