...
def LoadPlacements(sSetName):
	...
	# Position "BirdOfPrey 1 Start"
	kThis = App.Waypoint_Create("BirdOfPrey 1 Start", sSetName, None)
	kThis.SetStatic(0)
	kThis.SetNavPoint(0)
	...
	kThis.Update(0)
	kThis = None
	# End position "BirdOfPrey 1 Start"

	# Position "BirdOfPrey 2 Start"
	kThis = App.Waypoint_Create("BirdOfPrey 2 Start", sSetName, None)
	kThis.SetStatic(0)
	kThis.SetNavPoint(0)
	kThis.SetTranslateXYZ(1.670154, 1059.980103, 41.357456)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.168154, -0.953186, -0.251318)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.287709, -0.196391, 0.937366)
	...
	kThis.Update(0)
	kThis = None
	# End position "BirdOfPrey 2 Start"
