...
def PreLoadAssets(pMission):
	# Pre-create one Enterprise, Freighter, and nine D7s.
	loadspacehelper.PreloadShip("EnterpriseNCC1701", 1)
	loadspacehelper.PreloadShip("KTinga", 9)
...
def Initialize(pMission):
	...
	g_pMissionTGL = App.g_kLocalizationManager.Load("data/TGL/RHCD/Episode/M3.tgl")
...
def CreateRegions():
	...
	import M3Voltair2_P
	M3Voltair2_P.LoadPlacements(pVoltair2Set.GetName())
...
def CreateStartingObjects(pMission):
	...
	pPlayer	= MissionLib.CreatePlayerShip("EnterpriseNCC1701", pVoltair1Set, "player", "Player Start")
...
def HandleObjectExploding(pMission, pEvent):
	...
	if (pPlayer != None) and (g_eMissionState == MS_ARRIVED_VOLTAIR2):
		...
		for i in range(9):
			pShip = App.ShipClass_Cast(App.ShipClass_GetObject(pSet, "D7 " + str(i + 1)))
...
#	three D7s warping in to attack the player.
#	
#	Args:	none
#	
#	Return:	none
...
def Voltair2Cutscene():
	...
	# Create the D7s, and have them warp in. The extra parameter at the end
	...
	# would be unfair.
	pD71 = loadspacehelper.CreateShip("KTinga", pVoltair2Set, "D7 1", "D7 1 Start", 1)
	pD72 = loadspacehelper.CreateShip("KTinga", pVoltair2Set, "D7 2", "D7 2 Start", 1)
	pD73 = loadspacehelper.CreateShip("KTinga", pVoltair2Set, "D7 3", "D7 3 Start", 1)
	...
	# Assign the AIs for the D7s.
	pSeq.AppendAction(App.TGScriptAction_Create(__name__, "AssignD7AI"))
...
#	AssignD7AI(pAction)
#	
#	Script action that assigns the attack AI for the D7s that warp into
#	Voltair 2.
#	
#	Args:	pAction		- this action
#	
#	Return:	zero, to indicate normal action termination
###############################################################################
def AssignD7AI(pAction):
	pVoltair2Set = App.g_kSetManager.GetSet("Voltair2")
	pD71 = App.ShipClass_GetObject(pVoltair2Set, "D7 1")
	pD72 = App.ShipClass_GetObject(pVoltair2Set, "D7 2")
	pD73 = App.ShipClass_GetObject(pVoltair2Set, "D7 3")

	import D7AI
	pD71.SetAI(D7AI.CreateAI(pD71))
	pD72.SetAI(D7AI.CreateAI(pD72))
	pD73.SetAI(D7AI.CreateAI(pD73))
...
def CreateSecondWave(pObject, pEvent):
	...
	# Create ships
	pD74 = loadspacehelper.CreateShip("KTinga", pVoltair2Set, "D7 4", "D7 4 Start", 1)
	pD75 = loadspacehelper.CreateShip("KTinga", pVoltair2Set, "D7 5", "D7 5 Start", 1)
	pD76 = loadspacehelper.CreateShip("KTinga", pVoltair2Set, "D7 6", "D7 6 Start", 1)	

	# Assign AI
	import D7AI
	pD74.SetAI(D7AI.CreateAI(pD74))
	pD75.SetAI(D7AI.CreateAI(pD75))
	pD76.SetAI(D7AI.CreateAI(pD76))

###############################################################################
#	CreateThirdWave()
#
#	Create the third wave of D7s
#
#	Args:	pObject	- TGObject object
#		pEvent	- TGEvent object
#
...
def CreateThirdWave(pObject, pEvent):
	...
	# Create ships
	pD77 = loadspacehelper.CreateShip("KTinga", pVoltair2Set, "D7 7", "D7 7 Start", 1)
	pD78 = loadspacehelper.CreateShip("KTinga", pVoltair2Set, "D7 8", "D7 8 Start", 1)
	pD79 = loadspacehelper.CreateShip("KTinga", pVoltair2Set, "D7 9", "D7 9 Start", 1)	

	# Assign AI
	import D7AI
	pD77.SetAI(D7AI.CreateAI(pD77))
	pD78.SetAI(D7AI.CreateAI(pD78))
	pD79.SetAI(D7AI.CreateAI(pD79))
