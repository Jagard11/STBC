...
def PreLoadAssets(pMission):
	# Pre-create one Sovereign, Freighter, and nine Vorchas.
	loadspacehelper.PreloadShip("Sovereign", 1)
	loadspacehelper.PreloadShip("Vorcha", 9)
...
def Initialize(pMission):
	...
	g_pMissionTGL = App.g_kLocalizationManager.Load("data/TGL/RHCD/Episode/M1.tgl")
...
def CreateRegions():
	...
	import M1Voltair2_P
	M1Voltair2_P.LoadPlacements(pVoltair2Set.GetName())
...
def Voltair2Cutscene():
	...
	# would be unfair.
	pVorcha1 = loadspacehelper.CreateShip("Vorcha", pVoltair2Set, "Vorcha 1", "Vorcha 1 Start", 1)
	pVorcha2 = loadspacehelper.CreateShip("Vorcha", pVoltair2Set, "Vorcha 2", "Vorcha 2 Start", 1)
	pVorcha3 = loadspacehelper.CreateShip("Vorcha", pVoltair2Set, "Vorcha 3", "Vorcha 3 Start", 1)
...
#	
#	Script action that assigns the attack AI for the Vorchas that warp into
#	Voltair 2.
#	
#	Args:	pAction		- this action
#	
...
def AssignVorchaAI(pAction):
	pVoltair2Set = App.g_kSetManager.GetSet("Voltair2")
	pVorcha1 = App.ShipClass_GetObject(pVoltair2Set, "Vorcha 1")
	pVorcha2 = App.ShipClass_GetObject(pVoltair2Set, "Vorcha 2")
	pVorcha3 = App.ShipClass_GetObject(pVoltair2Set, "Vorcha 3")
...
def CreateSecondWave(pObject, pEvent):
	...
	# Create ships
	pVorcha4 = loadspacehelper.CreateShip("Vorcha", pVoltair2Set, "Vorcha 4", "Vorcha 4 Start", 1)
	pVorcha5 = loadspacehelper.CreateShip("Vorcha", pVoltair2Set, "Vorcha 5", "Vorcha 5 Start", 1)
	pVorcha6 = loadspacehelper.CreateShip("Vorcha", pVoltair2Set, "Vorcha 6", "Vorcha 6 Start", 1)	
...
def CreateThirdWave(pObject, pEvent):
	...
	# Create ships
	pVorcha7 = loadspacehelper.CreateShip("Vorcha", pVoltair2Set, "Vorcha 7", "Vorcha 7 Start", 1)
	pVorcha8 = loadspacehelper.CreateShip("Vorcha", pVoltair2Set, "Vorcha 8", "Vorcha 8 Start", 1)
	pVorcha9 = loadspacehelper.CreateShip("Vorcha", pVoltair2Set, "Vorcha 9", "Vorcha 9 Start", 1)	
