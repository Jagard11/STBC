...
#	
#	Creates Riha 1 static objects.  Called by Riha1.py when region is created
#	
#	Created:	09/17/00 
...
#		data/Textures/Effects/SunFlaresWhite.tga
	...
	pSun = App.Sun_Create(6000.0, 6000, 500)
