###############################################################################
#	Filename:	Cebalrai3_S.py
#	
#	Confidential and Proprietary, Copyright 2001 by Totally Games
#	
#	Creates Cebalrai 3 static objects.  Called by Cebalrai3.py when region is created
#	
...
def Initialize(pSet):
	...
	pSun = App.Sun_Create(1000.0, 1000, 500, "data/Textures/SunRed.tga", "data/Textures/Effects/SunFlaresRed.tga")
