...
abbrev = "Shadow_Fighter5"
iconName = "Shadow_Fighter"
longName = "Shadow Fighter"
shipFile = "Shadow_Fighter"
species = App.SPECIES_SHUTTLE

Foundation.ShipDef.Shadow_Fighter5 = Foundation.ShipDef(abbrev, species, { 'name': longName, 'iconName': iconName, 'shipFile': shipFile})

Foundation.ShipDef.Shadow_Fighter5.dTechs = { "Phase Cloak": 10, 'Breen Drainer Immune': 1, 'Shadow Dispersive Hull': 1}
