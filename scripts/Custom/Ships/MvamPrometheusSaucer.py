...
Foundation.ShipDef.MvamPrometheusSaucer.dTechs = { 'Fed Ablative Armor': {
	"Plates": ["Saucer Left Ablative Armor", "Saucer Right Ablative Armor", "Saucer Forward Ablative Armor"]
}}
#                                                                                     #
#######################################################################################
#                                                                                     #
