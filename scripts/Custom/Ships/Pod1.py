...
#                                                                                     #
Foundation.ShipDef.Pod1 = Foundation.FedShipDef(abbrev, species, { 'iconName': iconName, 'shipFile': shipFile })
#                                                                                     #
...
#                                                                                     #
# Foundation.ShipDef.Pod1.hasTGLName = 1
# Foundation.ShipDef.Pod1.hasTGLDesc = 1
#                                                                                     #
# Otherwise, uncomment this and type something in:                                    #
#                                                                                     #
Foundation.ShipDef.Pod1.desc = 'No Description Available'
#                                                                                     #
#######################################################################################
#                                                                                     #
