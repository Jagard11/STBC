...
#                                                                                     #
Foundation.ShipDef.Pod4 = Foundation.FedShipDef(abbrev, species, { 'iconName': iconName, 'shipFile': shipFile })
#                                                                                     #
...
#                                                                                     #
# Foundation.ShipDef.Pod4.hasTGLName = 1
# Foundation.ShipDef.Pod4.hasTGLDesc = 1
#                                                                                     #
# Otherwise, uncomment this and type something in:                                    #
#                                                                                     #
Foundation.ShipDef.Pod4.desc = 'No Description Available'
#                                                                                     #
#######################################################################################
#                                                                                     #
