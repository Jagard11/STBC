...
#                                                                                     #
Foundation.ShipDef.Flagship = Foundation.FedShipDef(abbrev, species, { 'iconName': iconName, 'shipFile': shipFile })
#                                                                                     #
...
#                                                                                     #
# Foundation.ShipDef.Flagship.hasTGLName = 1
# Foundation.ShipDef.Flagship.hasTGLDesc = 1
#                                                                                     #
# Otherwise, uncomment this and type something in:                                    #
#                                                                                     #
Foundation.ShipDef.Flagship.desc = 'No Description Available'
#                                                                                     #
#######################################################################################
#                                                                                     #
