...
longName = 'DeathStarII'
shipFile = 'DeathStarII' 
menuGroup = 'Bases'
playerMenuGroup = 'Bases'
...
#                                                                                     #
Foundation.ShipDef.DeathStarII = Foundation.StarBaseDef(abbrev, species, { 'name': longName, 'iconName': iconName, 'shipFile': shipFile })
#                                                                                     #
#######################################################################################
#                                                                                     #
...
#                                                                                     #
Foundation.ShipDef.DeathStarII.desc = 'No Description Available'
#                                                                                     #
#######################################################################################
#                                                                                     #
