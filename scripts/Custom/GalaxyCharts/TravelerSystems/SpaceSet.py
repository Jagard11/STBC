...
def Initialize():
	...
	pSet.SetRegionModule("Custom.GalaxyCharts.TravelerSystems."+SET_NAME)
	...
	Custom.GalaxyCharts.Cartographer.RegionManager.AddRegion(SET_NAME, "Custom.GalaxyCharts.TravelerSystems."+SET_NAME, None, None)
