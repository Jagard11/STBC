...
class PyramidShip( Carrier.Carrier):
    def __init__( self, pShip):
        ...
        launcher.AddLaunchable( "Glider1", "ftb.friendlyAI", 1)
        launcher.AddLaunchable( "Glider2", "ftb.friendlyAI", 1)
        launcher.AddLaunchable( "Glider3", "ftb.friendlyAI", 1)
        launcher.AddLaunchable( "Glider4", "ftb.friendlyAI", 1)
...
ShipManager.RegisterShipClass( "PyramidShip", PyramidShip)
