...
class ApophisFlagship( Carrier.Carrier):
    def __init__( self, pShip):
        ...
        launcher.AddLaunchable( "TelTakUpgrade", "ftb.friendlyAI", 2)
...
ShipManager.RegisterShipClass( "ApophisFlagship", ApophisFlagship)
