...
class DSC304Apollo( Carrier.Carrier):
    def __init__( self, pShip):
        ...
        launcher.AddLaunchable( "Horizon", "ftb.friendlyAI", 1)
...
# "DSC304Apollo" is the "ShipProperty" name of the ship to be registered as
# defined in the Hardpoints PY file for your ship
ShipManager = __import__( "ftb.ShipManager")
ShipManager.RegisterShipClass( "DSC304Apollo", DSC304Apollo)
