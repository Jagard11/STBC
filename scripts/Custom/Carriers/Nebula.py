# Carrier file Nebula.py autogenerated by http://defiant.homedns.org/~erik/STBC/carrier/

Carrier = __import__("ftb.Carrier")
class Nebula(Carrier.Carrier):
...
ShipManager.RegisterShipClass("Nebula", Nebula)
