...
class PrometheusRefit( Carrier.Carrier):
    def __init__( self, pShip):
        ...
        launcher.AddLaunchable( "F3022", "ftb.friendlyAI", 1)
        launcher.AddLaunchable( "F3023", "ftb.friendlyAI", 1)

        #launcher = LauncherManager.GetLauncher( "Shuttle Bay 2", pShip)
        #group.AddLauncher( "Shuttle Bay 2", launcher)
        #launcher.AddLaunchable( "F3024", "ftb.friendlyAI", 1)
        #launcher.AddLaunchable( "F3025", "ftb.friendlyAI", 1)
        #launcher.AddLaunchable( "F3026", "ftb.friendlyAI", 1)
...
ShipManager.RegisterShipClass( "PrometheusRefit", PrometheusRefit)
