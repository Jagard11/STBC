...
class Voyager( Carrier.Carrier):
    def __init__( self, pShip):
        ...
        launcher.AddLaunchable( "JLSType9", "ftb.friendlyAI", 3)
        launcher.AddLaunchable( "JLSDeltaflyer", "ftb.friendlyAI", 1)
...
ShipManager.RegisterShipClass( "Voyager", Voyager)
