...
class EnterpriseNCC1701( Carrier.Carrier):
    def __init__( self, pShip):
        ...
        launcher.AddLaunchable( "Shuttle", "QuickBattle.QuickBattleFriendlyAI", 8)
...
ShipManager.RegisterShipClass( "EnterpriseNCC1701", EnterpriseNCC1701)
