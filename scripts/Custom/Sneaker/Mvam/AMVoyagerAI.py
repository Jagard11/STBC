...
def CreateAI(pShip):
	...
	if (pEnemies.IsNameInGroup(pShip.GetName())):
		pAttackEnemies = AI.Compound.DSAttack.CreateAI(pShip,  pMission.GetFriendlyGroup(), Difficulty = 0.1, InaccurateTorps = 1)
	else:
		pAttackEnemies = AI.Compound.DSAttack.CreateAI(pShip,  pMission.GetEnemyGroup(), Difficulty = 0.1, InaccurateTorps = 1)
