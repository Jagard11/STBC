...
lEnemies = ["Borg", "Kessok", "Federation", "Klingon", "8472", "Romulan"]

########
## List of strings containing the names of the friendly races
lFriendlies = ["Cardassian", "Breen", "Sona"]
