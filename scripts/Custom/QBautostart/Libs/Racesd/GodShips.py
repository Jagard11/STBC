...
sLookInMenu = "God Ships"

########
## list of the ship script name  of ships of this race, to be added manually (that is, besides looking in the above 
## mentioned menu)
lDefaultShips = ["CUBE", "LowCube", "TacticalCube", "TNGBorgCube", "Borg", "BorgCube", "Cube", "VoyagerCube", "Hutet", "MPneghvar", "Neghvar", "ftbneghvar", "Reman Scimitar", "Reman ScimitarP", "scimitarJH", "Scimitar", "CloakFireBirdOfPrey", "DomBB", "CowpAsteroid", "cOWP", "DYExcalibur"]
