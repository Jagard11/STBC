...
lEnemies = ["Borg", "Kazon", "Vaadwaur", "Hirogen", "Bomar" ]

########
## List of strings containing the names of the friendly races
lFriendlies = ["Federation", "Caretaker", "Suspiria", "Dralian", "Talaxian" ]
...
## mentioned menu)
lDefaultShips = ["JLSNygeanPrisonTransport", ]
