...
def CreateAI(pShip):
	...
	#########################################
	# Creating CompoundAI DS9FXExcalAI at (256, 130)
	...
	#########################################
	#########################################
	# Creating SequenceAI Sequence at (256, 275)
	...
	# SeqBlock is at (208, 371)
	pPriorityList.AddAI(pDS9FXExcalAI, 1)
	pPriorityList.AddAI(pSequence, 2)
	# Done creating PriorityListAI PriorityList
	#########################################
	#########################################
	# Creating PreprocessingAI ExcalAvoidObstacles at (40, 324)
	## Setup:
