# by USS Sovereign, AI based on the Malinche AI
...
def CreateAI(pShip):
	...
	pAttackplayer = AI.Compound.BasicAttack.CreateAI(pShip, pPlayer.GetName(), Easy_Difficulty = 1.0, Easy_MaxFiringRange = 1000.0, Easy_AvoidTorps = 1, Easy_AggressivePulseWeapons = 1, Easy_ChooseSubsystemTargets = 1, Easy_SmartPhasers = 1, Easy_SmartShields = 1, Difficulty = 1.0, MaxFiringRange = 1000.0, AvoidTorps = 1, AggressivePulseWeapons = 1, ChooseSubsystemTargets = 1, SmartPhasers = 1, SmartShields = 1, Hard_Difficulty = 1.0, Hard_MaxFiringRange = 1000.0, Hard_AvoidTorps = 1, Hard_AggressivePulseWeapons = 1, Hard_ChooseSubsystemTargets = 1, Hard_SmartPhasers = 1, Hard_SmartShields = 1)
