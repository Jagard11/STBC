...
pMainPane = None
pPaneID = App.NULL_ID
pName = MissionIDs.MM6
sName = "Section 31"
sObjectives = "-Locate the Section 31 ship\n-Destroy the Section 31 ship"
sBriefing = "A Dominion delegation is coming over to DS9 in a hope to start the healing process between us. Not everybody approves this! The infamous Section 31 seems to be trying to sabotage the talks. We have received word that they have dispatched a starship to spoil the talks, destroy this ship immediately Captain. We must stop Section 31 at all costs or they could risk another war."
...
def CreateEntries(pObject, pEvent):
        ...
        pIconWindow = App.STStylizedWindow_CreateW("StylizedWindow", "NoMinimize", App.TGString("Mission: Section 31"), 0.0, 0.0, None, 1, 0.30, 0.30, kColor)
...
def MissionSetup():
        ...
        loadspacehelper.CreateShip(DS9FXShips.Galaxy, pSet, "Section 31", "DomDread Pos")
