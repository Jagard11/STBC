...
pName = MissionIDs.MM12
sName = "Section 31 Surprise"
sObjectives = "-Go to Trialus system\n-Destroy any Section 31 ships there\n-Return to DS9"
sBriefing = "Captain we have just learned that Section 31 is planning some kind of biological attack on the Dominion, we need you to stop them. Go at your best speed to Trialus system and engage and destroy any Section 31 ships."
sModule = "Custom.DS9FX.DS9FXMissions.MiniMissionMode.MiniMission12"
lShips = []
...
def MissionInitiate():
    global lShips
    lShips =["S-31 Ship 1", "S-32 Ship 2"]
...
def ObjectiveTxt():
    sText = "There are the Section 31 ships, we must destroy them sir at all costs!"
    iPos = 6
    iFont = 12
    iDur = 12
    iDelay = 20
...
def CreateShips():
    ...
    for s in lShips:
        sShip = s
        pShip = loadspacehelper.CreateShip(DS9FXShips.Defiant, pSet, sShip, "Dummy Location")
...
def GoHomeTxt():
    sText = "Section 31 ships have been destroyed. Time to go home sir!"
    iPos = 6
    iFont = 12
    iDur = 12
    iDelay = 3
