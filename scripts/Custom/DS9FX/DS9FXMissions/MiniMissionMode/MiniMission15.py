...
pName = MissionIDs.MM15
sName = "Distress Call"
sObjectives = "-Go to Gaia system\n-Find out what happened to our covert ops ship\n-Report back"
sBriefing = "Captain we have recived a distress call from our covert operation ship in the Gaia system. Go there and check it out."
sModule = "Custom.DS9FX.DS9FXMissions.MiniMissionMode.MiniMission15"
...
def ObjectiveTxt():
    sText = "Sir, its a trap. We've been lured here..."
    iPos = 6
    iFont = 12
    iDur = 12
    iDelay = 20
...
def GoHomeTxt():
    sText = "Sir, we should report this to Starfleet Command ASAP!"
    iPos = 6
    iFont = 12
    iDur = 12
    iDelay = 3
