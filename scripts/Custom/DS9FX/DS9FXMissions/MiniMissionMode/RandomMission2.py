...
pName = MissionIDs.RM2
sName = "Random Borg Mission"
sObjectives = ""
sBriefing = ""
sModule = "Custom.DS9FX.DS9FXMissions.MiniMissionMode.RandomMission2"
...
lShips = [DS9FXShips.BorgCube, DS9FXShips.BorgDetector, DS9FXShips.BorgSphere, DS9FXShips.BorgTacticalCube]
...
def Briefing():
    ...
    sObjectives = "-Go to " + sSet + "\n-Destroy any Borg ships found there"
    sBriefing = "Captain you are to go to "  + sSet + " system and engage and destroy any Borg ships found there.\n\nGood luck."
