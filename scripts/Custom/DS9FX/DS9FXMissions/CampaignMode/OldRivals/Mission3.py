...
pPlayerName = ""
pName = MissionIDs.ORM3
sName = "Duplicity"
sObjectives = "-Go back to Vandros system\n-Destroy the processing facility and all the ships in the area\n-Return to DS9"
sBriefing = ""
sModule = "Custom.DS9FX.DS9FXMissions.CampaignMode.OldRivals.Mission3"
...
def Briefing():
    ...
    sBriefing = "Stardate 64725.08\n\nCaptain " + str(pPlayerName) + " excellent job on the last mission. We have finished analyzing the data you brought back. Based on the data, we have found some kind of Dominion processing facility whose purpose is yet unknown. Starfleet Command wants you to destroy that facility. We have assembled a taskforce for you which will assist you in this mission.\n\nUSS Tibet: We are ready and standing by to assist you Captain. It will be our honor to serve with you on this mission.\nUSS Osiris: Standing by\nUSS Tiberious: Standing by\nUSS Moscow: Standing by"
    DS9FXMissionLib.Briefing(sName, sObjectives, sBriefing, pName, sModule)
    
def MissionInitiate():
    global lEnemies, lFriendlies, pShipType

    SetupPlayer()
    
    lFriendlies = ["USS Tibet", "USS Osiris", "USS Tiberious", "USS Moscow"]
    lEnemies = ["Dominion Guard 1", "Dominion Guard 2", "Dominion Guard 3", "Dominion Facility"]
...
def CreateFriendlies():
    ...
    for s in lFriendlies:
        ...
        if sShip == lFriendlies[0]:
            ...
            pShip = loadspacehelper.CreateShip(DS9FXShips.Nebula, pSet, sShip, "FriendlyPos1")
        else:
            pShip = loadspacehelper.CreateShip(DS9FXShips.Miranda, pSet, sShip, "FriendlyPos1")
...
def ObjectiveTxt():
    sText = "Looks like they reinforced system defences since the last time we were here...\nReady to attack sir!"
    iPos = 6
    iFont = 12
    iDur = 12
    iDelay = 20
...
def GoHomeTxt():
    sText = "We have destroyed all ships and stations in the vicinity, time to return to DS9..."
    iPos = 6
    iFont = 12
    iDur = 12
    iDelay = 3
