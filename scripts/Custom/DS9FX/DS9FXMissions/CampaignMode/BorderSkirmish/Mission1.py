...
def CreateEntries(pObject, pEvent):
        ...
        pIconWindow = App.STStylizedWindow_CreateW("StylizedWindow", "NoMinimize", App.TGString("Mission: Patrol Duty"), 0.0, 0.0, None, 1, 0.30, 0.30, kColor)
        ...
        pText = App.TGParagraph_CreateW(App.TGString("-Patrol the far side of the wormhole\n-Destroy any Dominion ships"), pObjectivesWindow.GetMaximumInteriorWidth(), None, '', pObjectivesWindow.GetMaximumInteriorWidth(), App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
        pObjectivesWindow.AddChild(pText, 0, 0.01)

        pText = App.TGParagraph_CreateW(App.TGString("Captain, You are required to patrol the far side of the Wormhole. Starfleet has received word, that a number of rogue Jem'Hadar are up to something big. The Founders have authorized you to destroy any ships you may encounter."), pBriefingWindow.GetMaximumInteriorWidth(), None, '', pBriefingWindow.GetMaximumInteriorWidth(), App.TGParagraph.TGPF_WORD_WRAP | App.TGParagraph.TGPF_READ_ONLY)
