...
SCREEN_PIXEL_WIDTH		= 1366.0
SCREEN_PIXEL_HEIGHT		= 768.0

DEFAULT_ST_INDENT_HORIZ	= 5.5		/ SCREEN_PIXEL_WIDTH
DEFAULT_ST_INDENT_VERT	= 3		/ SCREEN_PIXEL_HEIGHT
MARKER_INDENT_HORIZ		= 2		/ SCREEN_PIXEL_WIDTH
TAC_WEAPONS_CTRL_INDENT_HORIZ = 7 / SCREEN_PIXEL_WIDTH
...
POWER_GAUGE_WIDTH			= 40.0 / 1366.0
POWER_GAUGE_HEIGHT			= 104.0 / 768.0
...
def Switch():
	...
	App.globals.DEFAULT_ST_INDENT_HORIZ	= 5.5		/ SCREEN_PIXEL_WIDTH
	App.globals.DEFAULT_ST_INDENT_VERT	= 3		/ SCREEN_PIXEL_HEIGHT
	App.globals.MARKER_INDENT_HORIZ		= 2		/ SCREEN_PIXEL_WIDTH
	App.globals.TAC_WEAPONS_CTRL_INDENT_HORIZ = 7 / SCREEN_PIXEL_WIDTH
