...
def CreateBridgeModel(pBridgeSet):
	...
	pcEnvPath = "data/Models/Sets/TNGMirandaBridge/" + pcDetail[iDetail]

	# Pre-load the Bridge model and viewscreen
	App.g_kModelManager.LoadModel("data/Models/Sets/TNGMirandaBridge/TNGMirandaBridge.NIF", None, pcEnvPath)
	App.g_kModelManager.LoadModel("data/Models/Sets/TNGMirandaBridge/TNGMirandaViewScreen.NIF", None, pcEnvPath)

	# Load the viewscreen and set it up specially with SetViewScreen()
	pViewScreen = App.ViewScreenObject_Create("data/Models/Sets/TNGMirandaBridge/TNGMirandaViewScreen.NIF")
	pBridgeSet.SetViewScreen(pViewScreen, "viewscreen")

	# Setup bridge object
	pBridgeObject = App.BridgeObjectClass_Create("data/Models/Sets/TNGMirandaBridge/TNGMirandaBridge.NIF")
	...
	import Bridge.TNGmirandaBridgeProperties
	App.g_kModelPropertyManager.ClearLocalTemplates()
	reload(Bridge.TNGmirandaBridgeProperties)
	Bridge.TNGmirandaBridgeProperties.LoadPropertySet(pPropertySet)
...
#	debug("Loading EnterpriseA red alert sound")
	...
	pGame = App.Game_GetCurrentGame()
	pGame.LoadSoundInGroup("sfx/dredalert.wav",  "RedAlertSound", "BridgeGeneric")
...
#	debug("Loading EnterpriseA Ambient sound")
	...
	pGame = App.Game_GetCurrentGame()
	pGame.LoadSoundInGroup("sfx/bridge2.loop.wav",  "AmbBridge", "BridgeGeneric")
