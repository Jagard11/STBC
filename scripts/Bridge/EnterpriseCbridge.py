...
def CreateBridgeModel(pBridgeSet):
	...
	pcEnvPath = "data/Models/Sets/EnterpriseCBridge/" + pcDetail[iDetail]

	# Pre-load the Bridge model and viewscreen
	App.g_kModelManager.LoadModel("data/Models/Sets/EnterpriseCBridge/EnterpriseC.NIF", None, pcEnvPath)
	App.g_kModelManager.LoadModel("data/Models/Sets/EnterpriseCBridge/EnterpriseCViewScreen.NIF", None, pcEnvPath)

	# Load the viewscreen and set it up specially with SetViewScreen()
	pViewScreen = App.ViewScreenObject_Create("data/Models/Sets/EnterpriseCBridge/EnterpriseCViewScreen.NIF")
	pBridgeSet.SetViewScreen(pViewScreen, "viewscreen")

	# Setup bridge object
	pBridgeObject = App.BridgeObjectClass_Create("data/Models/Sets/EnterpriseCBridge/EnterpriseC.NIF")
