...
#	debug("Configuring Saffi for the Ambassador bridge")
	...
	pAmbSaffi.AddAnimation("AmbCommanderTurnCaptain", "Bridge.Characters.AmbMediumAnimations.AmbTurnAtCTowardsCaptain")
	pAmbSaffi.AddAnimation("AmbCommanderBackCaptain", "Bridge.Characters.AmbMediumAnimations.AmbTurnBackAtCFromCaptain")
...
#	debug("Finished configuring Saffi")
	pAmbSaffi.SetAudioMode(App.CharacterClass.CAM_EXTREMELY_VOCAL)
