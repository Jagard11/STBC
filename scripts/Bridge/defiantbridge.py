##############################################################################
#	Filename:	defiantbridge.py
#	
#	Confidential and Proprietary, Copyright 2000 by Totally Games
#	
#	This contains the code to create and configure the Defiant class bridge.
#	It is only called by LoadBridge.Initialize("defiantbridge"), so don't
...
def CreateBridgeModel(pBridgeSet):
	...
	pcDetail = [ "Medium/", "Medium/", "High/" ]
	pcEnvPath = "data/Models/Sets/defiantbridge/" + pcDetail[iDetail]

	# Pre-load the Bridge model and viewscreen
	App.g_kModelManager.LoadModel("data/Models/Sets/defiantbridge/defiantbridge.nif", None, pcEnvPath)
	App.g_kModelManager.LoadModel("data/Models/Sets/defiantbridge/defiantbridgeviewscreen.NIF", None, pcEnvPath)

	# Load the viewscreen and set it up specially with SetViewScreen()
	pViewScreen = App.ViewScreenObject_Create("data/Models/Sets/defiantbridge/defiantbridgeviewscreen.NIF")
	pBridgeSet.SetViewScreen(pViewScreen, "viewscreen")

	# Setup bridge object
	pBridgeObject = App.BridgeObjectClass_Create("data/Models/Sets/defiantbridge/defiantbridge.nif")
...
def ConfigureCharacters(pBridgeSet):
	...
	import Bridge.Characters.DFFelix
	import Bridge.Characters.DFKiska
	import Bridge.Characters.DFSaffi
	import Bridge.Characters.DFBrex
	import Bridge.Characters.DFMiguel

	import Bridge.Characters.DFFemaleExtra1
	import Bridge.Characters.DFFemaleExtra2
	import Bridge.Characters.DFFemaleExtra3
	import Bridge.Characters.DFMaleExtra1
	import Bridge.Characters.DFMaleExtra2
	import Bridge.Characters.DFMaleExtra3

	pDFFelix = App.CharacterClass_Cast(pBridgeSet.GetObject("Tactical"))
	pDFKiska = App.CharacterClass_Cast(pBridgeSet.GetObject("Helm"))
	pDFSaffi = App.CharacterClass_Cast(pBridgeSet.GetObject("XO"))
	pDFMiguel = App.CharacterClass_Cast(pBridgeSet.GetObject("Science"))
	pDFBrex = App.CharacterClass_Cast(pBridgeSet.GetObject("Engineer"))

	pDFFemaleExtra1 = App.CharacterClass_Cast(pBridgeSet.GetObject("FemaleExtra1"))
	pDFFemaleExtra2 = App.CharacterClass_Cast(pBridgeSet.GetObject("FemaleExtra2"))
	pDFFemaleExtra3 = App.CharacterClass_Cast(pBridgeSet.GetObject("FemaleExtra3"))

	pDFMaleExtra1 = App.CharacterClass_Cast(pBridgeSet.GetObject("MaleExtra1"))
	pDFMaleExtra2 = App.CharacterClass_Cast(pBridgeSet.GetObject("MaleExtra2"))
	pDFMaleExtra3 = App.CharacterClass_Cast(pBridgeSet.GetObject("MaleExtra3"))

	Bridge.Characters.DFFelix.ConfigureForDefiant(pDFFelix)
	Bridge.Characters.DFKiska.ConfigureForDefiant(pDFKiska)
	Bridge.Characters.DFSaffi.ConfigureForDefiant(pDFSaffi)
	Bridge.Characters.DFMiguel.ConfigureForDefiant(pDFMiguel)
	Bridge.Characters.DFBrex.ConfigureForDefiant(pDFBrex)

	if (pDFFemaleExtra1):
		Bridge.Characters.DFFemaleExtra1.ConfigureForDefiant(pDFFemaleExtra1)
	if (pDFFemaleExtra2):
		Bridge.Characters.DFFemaleExtra2.ConfigureForDefiant(pDFFemaleExtra2)
	if (pDFFemaleExtra3):
		Bridge.Characters.DFFemaleExtra3.ConfigureForDefiant(pDFFemaleExtra3)
	if (pDFMaleExtra1):
		Bridge.Characters.DFMaleExtra1.ConfigureForDefiant(pDFMaleExtra1)
	if (pDFMaleExtra2):
		Bridge.Characters.DFMaleExtra2.ConfigureForDefiant(pDFMaleExtra2)
	if (pDFMaleExtra3):
		Bridge.Characters.DFMaleExtra3.ConfigureForDefiant(pDFMaleExtra3)
...
#	LoadSounds()
#
#	Load any Defiant bridge specific sounds
#
#	Args:	none
#
#	Return:	none
...
#	debug("Loading Defiant door sound")
...
#	UnloadSounds()
#
#	Unload any Defiant bridge specific sounds
#
#	Args:	none
#
#	Return:	none
...
#	PreloadAnimations()
#
#	Load any Defiant bridge specific animations that are common
#
#	Args:	none
#
#	Return:	none
...
def PreloadAnimations ():
	...
	kAM.LoadAnimation ("data/animations/DF_door_L1.nif", "DF_Door_L1")
	kAM.LoadAnimation ("data/animations/DF_door_L2.nif", "DF_Door_L2")

	# Small animations
	# Science Movement
	kAM.LoadAnimation ("data/animations/DF_stand_s_s.nif", "DF_stand_s_s")
	kAM.LoadAnimation ("data/animations/DF_seated_s_s.nif", "DF_seated_s_s")
	kAM.LoadAnimation ("data/animations/DF_face_capt_s.nif", "DF_face_capt_s")
	kAM.LoadAnimation ("data/animations/DF_chair_s_face_capt.nif", "DF_chair_s_face_capt")
	kAM.LoadAnimation ("data/animations/DF_face_capt_s_reverse.nif", "DF_face_capt_s_reverse")
	kAM.LoadAnimation ("data/animations/DF_chair_s_face_capt_reverse.nif", "DF_chair_s_face_capt_reverse")
	...
	# Engineer Movement
	kAM.LoadAnimation ("data/animations/DF_stand_e_s.nif", "DF_stand_e_s")
	kAM.LoadAnimation ("data/animations/DF_seated_e_s.nif", "DF_seated_e_s")
	kAM.LoadAnimation ("data/animations/DF_face_capt_e.nif", "DF_face_capt_e")
	kAM.LoadAnimation ("data/animations/DF_chair_e_face_capt.nif", "DF_chair_e_face_capt")
	kAM.LoadAnimation ("data/animations/DF_face_capt_e_reverse.nif", "DF_face_capt_e_reverse")
	kAM.LoadAnimation ("data/animations/DF_chair_e_face_capt_reverse.nif", "DF_chair_e_face_capt_reverse")
	...
	# medium animations
	# Helm Movement
	kAM.LoadAnimation ("data/animations/DF_stand_h_m.nif", "DF_stand_h_m")
	kAM.LoadAnimation ("data/animations/DF_seated_h_m.nif", "DF_seated_h_m")
	kAM.LoadAnimation ("data/animations/DF_face_capt_h.nif", "DF_face_capt_h")
	kAM.LoadAnimation ("data/animations/DF_chair_H_face_capt.nif", "DF_chair_H_face_capt")
	kAM.LoadAnimation ("data/animations/DF_face_capt_h_reverse.nif", "DF_face_capt_h_reverse")
	kAM.LoadAnimation ("data/animations/DF_chair_H_face_capt_reverse.nif", "DF_chair_H_face_capt_reverse")
	kAM.LoadAnimation ("data/animations/EB_glance_h_m.nif", "DF_glance_h_m")
	kAM.LoadAnimation ("data/animations/EB_glance_h_m_reverse.nif", "DF_glance_h_m_reverse")

	kAM.LoadAnimation ("data/animations/EB_hit_h.NIF", "DF_hit_h")
	...
	# XO Movement
	kAM.LoadAnimation ("data/animations/DF_seated_C_M.nif", "DF_seated_c_m")
	kAM.LoadAnimation ("data/animations/DF_seatedm_C_M.nif", "DF_seatedm_c_m")
	kAM.LoadAnimation ("data/animations/DF_stand_V_M.nif", "DF_stand_c_m")
	kAM.LoadAnimation ("data/animations/DF_face_capt_c1.nif", "DF_face_capt_c1")
	kAM.LoadAnimation ("data/animations/DF_face_capt_c.nif", "DF_face_capt_c")
	kAM.LoadAnimation ("data/animations/DF_face_capt_C_reverse.NIF", "DF_face_capt_C_reverse")
	kAM.LoadAnimation ("data/animations/DF_face_capt_c1_reverse.NIF", "DF_face_capt_c1_reverse")
	...
	kAM.LoadAnimation ("data/animations/EB_hit_x.NIF", "DF_hit_x")

	# Extras
	kAM.LoadAnimation ("data/animations/DF_L1toG3_S.nif", "DF_L1toG3_S")
	kAM.LoadAnimation ("data/animations/DF_L1toG3_M.nif", "DF_L1toG3_M")
	kAM.LoadAnimation ("data/animations/DF_L1toG3_L.nif", "DF_L1toG3_L")

	kAM.LoadAnimation ("data/animations/DF_L2toG1_S.nif", "DF_L2toG1_S")
	kAM.LoadAnimation ("data/animations/DF_L2toG1_M.nif", "DF_L2toG1_M")
	kAM.LoadAnimation ("data/animations/DF_L2toG1_L.nif", "DF_L2toG1_L")

	kAM.LoadAnimation ("data/animations/DF_L2toG2_S.nif", "DF_L2toG2_S")
	kAM.LoadAnimation ("data/animations/DF_L2toG2_M.nif", "DF_L2toG2_M")
	kAM.LoadAnimation ("data/animations/DF_L2toG2_L.nif", "DF_L2toG2_L")

	kAM.LoadAnimation ("data/animations/DF_G1toL2_S.nif", "DF_G1toL2_S")
	kAM.LoadAnimation ("data/animations/DF_G1toL2_M.nif", "DF_G1toL2_M")
	kAM.LoadAnimation ("data/animations/DF_G1toL2_L.nif", "DF_G1toL2_L")
	
	kAM.LoadAnimation ("data/animations/DF_G2toL2_S.nif", "DF_G2toL2_S")
	kAM.LoadAnimation ("data/animations/DF_G2toL2_M.nif", "DF_G2toL2_M")
	kAM.LoadAnimation ("data/animations/DF_G2toL2_L.nif", "DF_G2toL2_L")
	
	kAM.LoadAnimation ("data/animations/DF_G3toL1_S.nif", "DF_G3toL1_S")
	kAM.LoadAnimation ("data/animations/DF_G3toL1_M.nif", "DF_G3toL1_M")
	kAM.LoadAnimation ("data/animations/DF_G3toL1_L.nif", "DF_G3toL1_L")


	# Large animations
	# Tactical Movement
	kAM.LoadAnimation ("data/animations/DF_stand_t_l.nif", "DF_stand_t_l")
	kAM.LoadAnimation ("data/animations/DF_seated_t_l.nif", "DF_seated_t_l")
	kAM.LoadAnimation ("data/animations/DF_seatedm_t_l.nif", "DF_seatedm_t_l")
	kAM.LoadAnimation ("data/animations/DF_face_capt_t.nif", "DF_face_capt_t")
	kAM.LoadAnimation ("data/animations/DF_chair_T_face_capt.nif", "DF_chair_T_face_capt")
	kAM.LoadAnimation ("data/animations/DF_face_capt_t_reverse.nif", "DF_face_capt_t_reverse")
	kAM.LoadAnimation ("data/animations/DF_chair_T_face_capt_reverse.nif", "DF_chair_T_face_capt_reverse")
	kAM.LoadAnimation ("data/animations/EB_hit_t.NIF", "DF_hit_t")
...
def UnloadAnimations ():
	...
	kAM.FreeAnimation("DF_Door_L1")
	kAM.FreeAnimation("DF_Door_L2")

	# Small animations
	# Science Movement
	kAM.FreeAnimation("DF_stand_s_s")
	kAM.FreeAnimation("DF_seated_s_s")
	kAM.FreeAnimation("DF_face_capt_s")
	kAM.FreeAnimation("DF_chair_s_face_capt")
	kAM.FreeAnimation("DF_face_capt_s_reverse")
	kAM.FreeAnimation("DF_chair_s_face_capt_reverse")
	...
	# Engineer Movement
	kAM.FreeAnimation("DF_stand_e_s")
	kAM.FreeAnimation("DF_seated_e_s")
	kAM.FreeAnimation("DF_face_capt_e")
	kAM.FreeAnimation("DF_chair_e_face_capt")
	kAM.FreeAnimation("DF_face_capt_e_reverse")
	kAM.FreeAnimation("DF_chair_e_face_capt_reverse")
	...
	# medium animations
	# Helm Movement
	kAM.FreeAnimation("DF_stand_h_m")
	kAM.FreeAnimation("DF_seated_h_m")
	kAM.FreeAnimation("DF_face_capt_h")
	kAM.FreeAnimation("DF_face_capt_h_reverse")
	kAM.FreeAnimation("DF_hit_h")
	...
	# XO Movement
	kAM.FreeAnimation("DF_seated_c_m")
	kAM.FreeAnimation("DF_seatedm_c_m")
	kAM.FreeAnimation("DF_stand_c_m")
	kAM.FreeAnimation("DF_face_capt_c1")
	kAM.FreeAnimation("DF_face_capt_c")
	kAM.FreeAnimation("DF_face_capt_C_reverse")
	kAM.FreeAnimation("DF_face_capt_c1_reverse")
	kAM.FreeAnimation("DF_hit_c")
	kAM.FreeAnimation("DF_stand_D_M")
	kAM.FreeAnimation("DF_seated_D_M")
	...
	#Extra
	kAM.FreeAnimation("DF_L1toG3_S")
	kAM.FreeAnimation("DF_L1toG3_M")
	kAM.FreeAnimation("DF_L1toG3_L")

	kAM.FreeAnimation("DF_L2toG1_S")
	kAM.FreeAnimation("DF_L2toG1_M")
	kAM.FreeAnimation("DF_L2toG1_L")

	kAM.FreeAnimation("DF_L2toG2_S")
	kAM.FreeAnimation("DF_L2toG2_M")
	kAM.FreeAnimation("DF_L2toG2_L")

	kAM.FreeAnimation("DF_G1toL2_S")
	kAM.FreeAnimation("DF_G1toL2_M")
	kAM.FreeAnimation("DF_G1toL2_L")
	
	kAM.FreeAnimation("DF_G2toL2_S")
	kAM.FreeAnimation("DF_G2toL2_M")
	kAM.FreeAnimation("DF_G2toL2_L")
	
	kAM.FreeAnimation("DF_G3toL1_S")
	kAM.FreeAnimation("DF_G3toL1_M")
	kAM.FreeAnimation("DF_G3toL1_L")
	
	# Large animations
	# Tactical Movement
	kAM.FreeAnimation("DF_stand_t_l")
	kAM.FreeAnimation("DF_seated_t_l")
	kAM.FreeAnimation("DF_seatedm_t_l")
	kAM.FreeAnimation("DF_face_capt_t")
	kAM.FreeAnimation("DF_chair_T_face_capt")
	kAM.FreeAnimation("DF_face_capt_t_reverse")
	kAM.FreeAnimation("DF_chair_T_face_capt_reverse")
	kAM.FreeAnimation("DF_hit_t")
