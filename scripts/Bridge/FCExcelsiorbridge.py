...
def CreateBridgeModel(pBridgeSet):
	...
	pcEnvPath = "data/Models/Sets/FCExcelsiorBridge/" + pcDetail[iDetail]

	# Pre-load the Bridge model and viewscreen
	App.g_kModelManager.LoadModel("data/Models/Sets/FCExcelsiorbridge/Excelsiorbridge.nif", None, pcEnvPath)
	App.g_kModelManager.LoadModel("data/Models/Sets/FCExcelsiorbridge/ExcelsiorViewScreen.NIF", None, pcEnvPath)

	# Load the viewscreen and set it up specially with SetViewScreen()
	pViewScreen = App.ViewScreenObject_Create("data/Models/Sets/FCExcelsiorbridge/ExcelsiorViewScreen.NIF")
	pBridgeSet.SetViewScreen(pViewScreen, "viewscreen")

	# Setup bridge object
	pBridgeObject = App.BridgeObjectClass_Create("data/Models/Sets/FCExcelsiorbridge/Excelsiorbridge.nif")
	...
	import Bridge.FCExcelsiorBridgeProperties
	App.g_kModelPropertyManager.ClearLocalTemplates()
	reload(Bridge.FCExcelsiorBridgeProperties)
	Bridge.FCExcelsiorBridgeProperties.LoadPropertySet(pPropertySet)
