...
def Initialize():
	# Create the set ("OcampaV1")
	pSet = App.SetClass_Create()
	App.g_kSetManager.AddSet(pSet, "OcampaV1")

	# Save the name of the region file that's creating the set.
	pSet.SetRegionModule("Systems.OcampaV.OcampaV1")
	...
	# "OcampaV1_S.py" file with an Initialize function that creates them.
	try:
		import OcampaV1_S
		OcampaV1_S.Initialize(pSet)
	except ImportError:
...
def GetSet():
	return App.g_kSetManager.GetSet("OcampaV1")

def Terminate():
	App.g_kSetManager.DeleteSet("OcampaV1")
...
##	placer = Systems.FoundationUtils.SystemPlacer(728.91, 3, 2)
	...
	# Position "Ocampa"
	kThis = App.Waypoint_Create("Ocampa", sSetName, None)
	kThis.SetStatic(1)
	kThis.SetNavPoint(1)
	kThis.SetTranslateXYZ(4000.827942, 50.803833, 40.0)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000000, 1.000000, 0.000000)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.000000, 0.000000, 1.000000)
	...
	# Position "Ocampa Location"
	kThis = App.Waypoint_Create("Ocampa Location", sSetName, None)
	kThis.SetStatic(1)
	kThis.SetTranslateXYZ(4000.827942, 50.803833, 40.0)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000000, 1.000000, 0.000000)
