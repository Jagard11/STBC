...
def Initialize():
	...
	App.g_kSetManager.AddSet(pSet, "Canopus2")

	# Save the name of the region file that's creating the set.
	pSet.SetRegionModule("Systems.Canopus.Canopus2")

	# Activate the proximity manager for our set.
	pSet.SetProximityManagerActive(1)

	# Load the placements and backdrops for this set.
	LoadPlacements("Canopus2")
	LoadBackdrops(pSet)
	...
	# "Canopus2_S.py" file with an Initialize function that creates them.
	try:
		import Canopus2_S
		Canopus2_S.Initialize(pSet)
	except ImportError:
...
def GetSet():
	return App.g_kSetManager.GetSet("Canopus2")

def Terminate():
	App.g_kSetManager.DeleteSet("Canopus2")
...
def LoadPlacements(sSetName):
	...
	kThis.ConfigAmbientLight(1.000000, 1.000000, 1.000000, 0.08)
	kThis.Update(0)
	kThis = None
	...
	kThis.AlignToVectors(kForward, kUp)
	kThis.ConfigDirectionalLight(.6, .6, 1, 1)
	kThis.Update(0)
	kThis = None
	...
	kThis.SetStatic(1)
	kThis.SetTranslateXYZ(0.0, -4500000.0, 0.0)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000000, 1.000000, 0.000000)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.000000, 0.000000, 1.000000)
	...
	kThis.SetStatic(1)
	kThis.SetNavPoint(1)
	kThis.SetTranslateXYZ(0.0, -4300000.0, 0.0)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000000, 1.000000, 0.000000)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.000000, 0.000000, 1.000000)
	...
	kThis.SetStatic(1)
	kThis.SetNavPoint(0)
	kThis.SetTranslateXYZ(-33000.00, -8900.0, 2000.00)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000000, 1.000000, 0.000000)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.080718, 0.000000, 0.996737)
	...
	kThis.SetStatic(1)
	kThis.SetNavPoint(0)
	kThis.SetTranslateXYZ(-27500.00, 19000.0, 200.00)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000000, 1.000000, 0.000000)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.080718, 0.000000, 0.996737)
	...
	kThis.SetStatic(1)
	kThis.SetNavPoint(0)
	kThis.SetTranslateXYZ(-6900.00, 34000.0, 0.0)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000000, 1.000000, 0.000000)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.080718, 0.000000, 0.996737)
