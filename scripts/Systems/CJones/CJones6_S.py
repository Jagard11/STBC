###############################################################################
#	Filename:	CJones6_S.py
#	
#	Confidential and Proprietary, Copyright 2001 by Totally Games/Ben Howard
#	
#	Creates Fluidic Space static objects.  Called by CJones6.py when region is created
#	
#	Created:	09/17/00 
#	Modified:	10/04/01 - Tony Evans
#	Modified:	04/05/02 - Ben Howard (Banzai Zap)
#       Modified:       08/22/03 - Chris Jones
#       Modified for MultiPlayer 12/10/03 Chris Jones
###############################################################################
import App
