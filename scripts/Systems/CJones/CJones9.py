...
def Initialize():
	# Create the set ("CJones9")
	pSet = App.SetClass_Create()
	App.g_kSetManager.AddSet(pSet, "CJones9")

	# Save the name of the region file that's creating the set.
	pSet.SetRegionModule("Systems.CJones.CJones9")

	# Activate the proximity manager for our set.
	pSet.SetProximityManagerActive(1)

	# Load the placements and backdrops for this set.
	LoadPlacements("CJones9")
	LoadBackdrops(pSet)
	...
	# "CJones9_S.py" file with an Initialize function that creates them.
	try:
		import CJones9_S
		CJones9_S.Initialize(pSet)
	except ImportError:
...
def GetSet():
	return App.g_kSetManager.GetSet("CJones9")

def Terminate():
	App.g_kSetManager.DeleteSet("CJones9")
...
def LoadPlacements(sSetName):
	...
	# Position "Sun"
	kThis = App.Waypoint_Create("White Blue Giant", sSetName, None)
	kThis.SetStatic(1)
	kThis.SetTranslateXYZ(0.0, 98571.98, 0.0)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000000, 1.000000, 0.000000)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.000000, 0.000000, 1.000000)
	...
	kThis.SetStatic(1)
	kThis.SetTranslateXYZ(240.0, 9970.0, 920.0)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000000, 1.000000, 0.000000)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.000000, 0.000000, 1.000000)
	...
	kThis.SetStatic(1)
	kThis.SetTranslateXYZ(320.0, 10045.0, 1010.0)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000000, 1.000000, 0.000000)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.000000, 0.000000, 1.000000)
	...
	kThis.SetStatic(1)
	kThis.SetTranslateXYZ(290.0, 10010.0, 1035.0)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000000, 1.000000, 0.000000)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.000000, 0.000000, 1.000000)
	...
	kThis.SetStatic(1)
	kThis.SetTranslateXYZ(350.0, 9950.0, 975.0)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000000, 1.000000, 0.000000)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.000000, 0.000000, 1.000000)
	...
	kThis.SetStatic(1)
	kThis.SetTranslateXYZ(-1000.0, 12000.0, -1000.0)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000000, 1.000000, 0.000000)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.000000, 0.000000, 1.000000)
	...
	kThis.SetStatic(1)
	kThis.SetTranslateXYZ(300.0, 10045.0, 970.0)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000000, 1.000000, 0.000000)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.000000, 0.000000, 1.000000)
	...
	kThis.SetStatic(1)
	kThis.SetTranslateXYZ(100, 10000, 500.0)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000000, 1.000000, 0.000000)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.000000, 0.000000, 1.000000)
	...
	kThis.SetStatic(1)
	kThis.SetNavPoint(0)
	kThis.SetTranslateXYZ(-19.792000, 0.000000, 1.000000)
	kForward = App.TGPoint3()
	...
	# Position "Sun"
	kThis = App.Waypoint_Create("Sun View", sSetName, None)
	kThis.SetStatic(1)
	kThis.SetNavPoint(1)
	kThis.SetTranslateXYZ(0.0, 78571.98, 1000.0)
	kForward = App.TGPoint3()
	...
	# Position "Sun"
	kThis = App.Waypoint_Create("Sun Corona", sSetName, None)
	kThis.SetStatic(1)
	kThis.SetNavPoint(1)
	kThis.SetTranslateXYZ(0.0, 97571.98, 200.0)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.208765, 0.512881, 0.832689)
	kUp = App.TGPoint3()
	kUp.SetXYZ(-0.249968, 0.851151, -0.461582)
...
##	kThis.SetTranslateXYZ(0.0, 40000.0, 0.0)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000000, 1.000000, 0.000000)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.000000, 0.000000, 1.000000)
	...
	# Position "Warbird"
	kThis = App.Waypoint_Create("Warbird2 Location", sSetName, None)
	kThis.SetStatic(1)
	kThis.SetTranslateXYZ(0.0, 400.0, 0.0)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000000, 1.000000, 0.000000)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.000000, 0.000000, 1.000000)
	...
	# Position "Keldon"
	kThis = App.Waypoint_Create("Keldon Location", sSetName, None)
	kThis.SetStatic(1)
	kThis.SetTranslateXYZ(1230.0, -1400.0, 0.0)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000000, 1.000000, 0.000000)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.000000, 0.000000, 1.000000)
	...
	# Position "Keldon2"
	kThis = App.Waypoint_Create("Keldon2 Location", sSetName, None)
	kThis.SetStatic(1)
	kThis.SetTranslateXYZ(-1880.0, -4400.0, -1000.0)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000000, 1.000000, 0.000000)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.000000, 0.000000, 1.000000)
	...
	kThis = App.Waypoint_Create("Freighter Location", sSetName, None)
	kThis.SetStatic(1)
	kThis.SetTranslateXYZ(-1000.0, 1000.0, -40.0)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000000, 1.000000, 0.000000)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.000000, 0.000000, 1.000000)
	...
	kThis.SetStatic(1)
	kThis.SetTranslateXYZ(-10.0, 578.0, 0.0)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000000, 1.000000, 0.000000)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.000000, 0.000000, 1.000000)
	...
	kThis.SetStatic(1)
	kThis.SetTranslateXYZ(-10.0, 978.0, 200.0)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000000, 1.000000, 0.000000)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.000000, 0.000000, 1.000000)
	...
	# Position "Akira2"
	kThis = App.Waypoint_Create("Akira2 Location", sSetName, None)
	kThis.SetStatic(1)
	kThis.SetTranslateXYZ(-10.0, -978.0, -200.0)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000000, 1.000000, 0.000000)
