...
def Initialize():
	# Create the set ("CJones7")
	pSet = App.SetClass_Create()
	App.g_kSetManager.AddSet(pSet, "CJones7")

	# Save the name of the region file that's creating the set.
	pSet.SetRegionModule("Systems.CJones.CJones7")
	...
	# "CJones7_S.py" file with an Initialize function that creates them.
	try:
		import CJones7_S
		CJones7_S.Initialize(pSet)
	except ImportError:
...
def GetSet():
	return App.g_kSetManager.GetSet("CJones7")

def Terminate():
	App.g_kSetManager.DeleteSet("CJones7")
...
def LoadPlacements(sSetName):
	...
	kThis.SetStatic(1)
	kThis.SetTranslateXYZ(0.0, 99000.0, 100.0)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000000, 1.000000, 0.000000)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.000000, 0.000000, 1.000000)
	...
	kThis.SetStatic(1)
	kThis.SetTranslateXYZ(-60000.0, 98000.0, 100.0)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000000, 1.000000, 0.000000)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.000000, 0.000000, 1.000000)
	...
	kThis.SetStatic(1)
	kThis.SetTranslateXYZ(-41100.0, 98000.0, 100.0)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000000, 1.000000, 0.000000)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.000000, 0.000000, 1.000000)
	...
	kThis = App.Waypoint_Create("Distant Stars", sSetName, None)
	kThis.SetStatic(1)
	kThis.SetNavPoint(1)
	kThis.SetTranslateXYZ(-50090.0, 97000.0, 100.0)
	kForward = App.TGPoint3()
	...
	kThis = App.Waypoint_Create("Proxima 1", sSetName, None)
	kThis.SetStatic(1)
	kThis.SetNavPoint(0)
	kThis.SetTranslateXYZ(724.827942, 888.803833, 8975.455322)
	kForward = App.TGPoint3()
	...
	# Position "SCL"
	kThis = App.Waypoint_Create("Stellar Cosmos locale", sSetName, None)
	kThis.SetStatic(1)
	kThis.SetTranslateXYZ(-8.0, -200.0, -70.0)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000000, 1.000000, 0.000000)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.000000, 0.000000, 1.000000)
