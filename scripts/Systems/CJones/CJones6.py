...
def Initialize():
	# Create the set ("CJones6")
	pSet = App.SetClass_Create()
	App.g_kSetManager.AddSet(pSet, "CJones6")

	# Save the name of the region file that's creating the set.
	pSet.SetRegionModule("Systems.Fluid.CJones6")

	# Activate the proximity manager for our set.
	pSet.SetProximityManagerActive(1)

	# Load the placements and backdrops for this set.
	LoadPlacements("CJones6")
	LoadBackdrops(pSet)
	...
	# "CJones6_S.py" file with an Initialize function that creates them.
	try:
		import CJones6_S
		CJones6_S.Initialize(pSet)
	except ImportError:
...
def GetSet():
	return App.g_kSetManager.GetSet("CJones6")

def Terminate():
	App.g_kSetManager.DeleteSet("CJones6")
...
def LoadPlacements(sSetName):
	...
	kThis.SetStatic(1)
	kThis.SetTranslateXYZ(-500.0, 32000.0, 500.0)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000000, 1.000000, 0.000000)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.000000, 0.000000, 1.000000)
	...
	kThis.SetStatic(1)
	kThis.SetTranslateXYZ(14500.0, 32000.0, -2500.0)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000000, 1.000000, 0.000000)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.000000, 0.000000, 1.000000)
	...
	kThis.SetStatic(1)
	kThis.SetTranslateXYZ(500.0, -42000.0, 9500.0)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000000, 1.000000, 0.000000)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.000000, 0.000000, 1.000000)
...
def LoadBackdrops(pSet):
	...
	# Star Sphere "Backdrop starsbz3"
	kThis = App.StarSphere_Create()
	kThis.SetName("Backdrop starsbz3")
	kThis.SetTranslateXYZ(0.000000, 0.000000, 0.000000)
	kForward = App.TGPoint3()
	...
	kThis.AlignToVectors(kForward, kUp)
	kThis.SetTextureFileName("data/starsbz3.tga")
	...
	kThis.Rebuild()
	pSet.AddBackdropToSet(kThis,"Backdrop starsnz3")
	kThis.Update(0)
	kThis = None
	# End Backdrop Sphere "Backdrop starsnz3"
