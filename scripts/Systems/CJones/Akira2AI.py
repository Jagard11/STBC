...
def CreateAI(pShip):
	...
	#
	# -Jeff
	pAttack = AI.Compound.BasicAttack.CreateAI(pShip, ["RIS Tomalok", "Tasha Yar", "Cardassia II", "Dukat Revenge"], FollowTargetThroughWarp = 1, SmartPhasers = 1, UseCloaking = 1)
