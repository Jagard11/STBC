...
def Initialize():
	# Create the set ("CaretakerArray1")
	pSet = App.SetClass_Create()
	App.g_kSetManager.AddSet(pSet, "CaretakerArray1")

	# Save the name of the region file that's creating the set.
	pSet.SetRegionModule("Systems.CaretakerArray.CaretakerArray1")

	# Activate the proximity manager for our set.
	pSet.SetProximityManagerActive(1)

	# Load the placements and backdrops for this set.
	LoadPlacements("CaretakerArray1")
	LoadBackdrops(pSet)
	...
	# "CaretakerArray1_S.py" file with an Initialize function that creates them.
	try:
		import CaretakerArray1_S
		CaretakerArray1_S.Initialize(pSet)
	except ImportError:
...
def GetSetName():
	return "CaretakerArray1"

def GetSet():
	return App.g_kSetManager.GetSet("CaretakerArray1")

def Terminate():
	App.g_kSetManager.DeleteSet("CaretakerArray1")
...
def LoadPlacements(sSetName):
	...
	# Position "JLSCaretakerArray"
	kThis = App.Waypoint_Create("Caretaker Location", sSetName, None)
	kThis.SetStatic(1)
	kThis.SetNavPoint(1)
	...
	kThis.Update(0)
	kThis = None
	# End position "JLSCaretakerArray"
	...
	kThis.SetStatic(0)
	kThis.SetNavPoint(0)
	kThis.SetTranslateXYZ(-5218.321289, -216.457336, 585.013000)
	kForward = App.TGPoint3()
	...
	kThis.SetStatic(0)
	kThis.SetNavPoint(0)
	kThis.SetTranslateXYZ(-57.417576, -202.809982, 302.952881)
	kForward = App.TGPoint3()
	kForward.SetXYZ(-0.406281, 0.200935, -0.891382)
	kUp = App.TGPoint3()
	kUp.SetXYZ(-0.913416, -0.115596, 0.390267)
	kThis.AlignToVectors(kForward, kUp)
	kThis.ConfigDirectionalLight(0.600000, 0.900000, 0.800000, 1.000000)
	kThis.Update(0)
	kThis = None
