...
def Initialize():
	# Create the set ("MalonHomeworld1")
	pSet = App.SetClass_Create()
	App.g_kSetManager.AddSet(pSet, "MalonHomeworld1")

	# Save the name of the region file that's creating the set.
	pSet.SetRegionModule("Systems.MalonHomeworld.MalonHomeworld1")
	...
	LoadPlacements("MalonHomeworld1")
	LoadBackdrops(pSet)
	...
	# "MalonHomeworld1_S.py" file with an Initialize function that creates them.
	try:
		import MalonHomeworld1_S
		MalonHomeworld1_S.Initialize(pSet)
	except ImportError:
...
def GetSetName():
	return "MalonHomeworld1"

def GetSet():
	return App.g_kSetManager.GetSet("MalonHomeworld1")

def Terminate():
	App.g_kSetManager.DeleteSet("MalonHomeworld1")
...
##	placer = Systems.FoundationUtils.SystemPlacer(728.91, 3, 2)
	...
	# Position "Alpha1"
	kThis = App.Waypoint_Create("Alpha1", sSetName, None)
	kThis.SetStatic(1)
	...
	# Position "Alpha 1"
	kThis = App.Waypoint_Create("Alpha 1", sSetName, None)
	kThis.SetStatic(1)
	kThis.SetTranslateXYZ(4295000.0, -314000.0, 37000.0)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000000, 1.000000, 0.000000)
	...
	kThis.Update(0)
	kThis = None
	# End position "Alpha 1"

	# Position "Malon Homeworld"
	kThis = App.Waypoint_Create("Malon Homeworld", sSetName, None)
	kThis.SetStatic(1)
	kThis.SetNavPoint(1)
	...
	kThis.Update(0)
	kThis = None
	# End position "Malon Homeworld"

	# Position "Malon Location"
	kThis = App.Waypoint_Create("Malon Location", sSetName, None)
	kThis.SetStatic(1)
	kThis.SetTranslateXYZ(1500.827942, 50.803833, 40.0)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000000, 1.000000, 0.000000)
	...
	kThis.Update(0)
	kThis = None
	# End position "Malon Location"

	# Position "Moon"
	kThis = App.Waypoint_Create("Alpha", sSetName, None)
	kThis.SetStatic(1)
	kThis.SetTranslateXYZ(5500.827942, 500.803833, 40.0)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000000, 1.000000, 0.000000)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.000000, 0.000000, 1.000000)
...
# Backdrop Sphere "Backdrop nebula2"
	...
	kThis.AlignToVectors(kForward, kUp)
	kThis.SetTextureFileName("data/Backgrounds/JLSMalon1.tga")
	kThis.SetTargetPolyCount(256)
	kThis.SetHorizontalSpan(0.150000)
	kThis.SetVerticalSpan(0.300000)
	kThis.SetSphereRadius(380.000000)
