...
def Initialize():
	# Create the set ("Rainbow2")
	pSet = App.SetClass_Create()
	App.g_kSetManager.AddSet(pSet, "Rainbow2")

	# Save the name of the region file that's creating the set.
	pSet.SetRegionModule("Systems.Rainbow.Rainbow2")

	# Activate the proximity manager for our set.
	pSet.SetProximityManagerActive(1)

	# Load the placements and backdrops for this set.
	LoadPlacements("Rainbow2")
	LoadBackdrops(pSet)
	...
	# "Rainbow2_S.py" file with an Initialize function that creates them.
	try:
		import Rainbow2_S
		Rainbow2_S.Initialize(pSet)
	except ImportError:
...
def GetSet():
	return App.g_kSetManager.GetSet("Rainbow2")

def Terminate():
	App.g_kSetManager.DeleteSet("Rainbow2")
...
def LoadPlacements(sSetName):
	...
	kThis.SetStatic(1)
	kThis.SetTranslateXYZ(450.0, 56000.0, 0.0)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000000, 1.000000, 0.000000)
	kUp = App.TGPoint3()
	...
	kThis.SetStatic(1)
	kThis.SetTranslateXYZ(450.0, 56000.0, -1.0)
	kForward = App.TGPoint3()
	kForward.SetXYZ(1.000000, 0.000000, 0.000000)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.000000, 0.000000, 1.000000)
	...
	kThis.SetStatic(1)
	kThis.SetTranslateXYZ(449.0, 56000.0, 0.0)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000000, 1.000000, 0.000000)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.000000, 0.000000, 1.000000)
	...
	kThis.SetStatic(1)
	kThis.SetNavPoint(1)
	kThis.SetTranslateXYZ(0.0, 53500.0, 200.0)
	kForward = App.TGPoint3()
	...
	kThis.SetStatic(1)
	kThis.SetTranslateXYZ(-400, 3500.0, 1000.0)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000000, 1.000000, 0.000000)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.000000, 0.000000, 1.000000)
	...
	kThis.SetStatic(1)
	kThis.SetNavPoint(0)
	kThis.SetTranslateXYZ(500, 2300.0, 800.0)
	kForward = App.TGPoint3()
	...
	kThis.SetStatic(1)
	kThis.SetNavPoint(0)
	kThis.SetTranslateXYZ(-200, 3100.0, 1600.0)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.483651, 0.589455, 0.647012)
	kUp = App.TGPoint3()
	kUp.SetXYZ(-0.864987, 0.434828, 0.250444)
	...
	kThis.SetStatic(1)
	kThis.SetTranslateXYZ(1060.0, 54950.0, -530.0)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000000, 1.000000, 0.000000)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.000000, 0.000000, 1.000000)
	...
	# Position "Odin Dark Side"
	kThis = App.Waypoint_Create("Odin Dark Side", sSetName, None)
	kThis.SetStatic(1)
	kThis.SetNavPoint(1)
	kThis.SetTranslateXYZ(-500, -900.0, 2000.0)
	kForward = App.TGPoint3()
