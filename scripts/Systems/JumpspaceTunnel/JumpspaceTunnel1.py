...
def Initialize():
	# Create the set ("JumpspaceTunnel1")
	pSet = App.SetClass_Create()
	App.g_kSetManager.AddSet(pSet, "JumpspaceTunnel1")

	# Save the name of the region file that's creating the set.
	pSet.SetRegionModule("Systems.JumpspaceTunnel.JumpspaceTunnel1")
	...
	LoadPlacements("JumpspaceTunnel1")
	LoadBackdrops(pSet)
...
def GetSetName():
	return "JumpspaceTunnel1"

def GetSet():
	return App.g_kSetManager.GetSet("JumpspaceTunnel1")

def Terminate():
	App.g_kSetManager.DeleteSet("JumpspaceTunnel1")
