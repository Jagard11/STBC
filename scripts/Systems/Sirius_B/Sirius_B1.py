...
def Initialize():
	# Create the set ("Sirius_B1")
	pSet = App.SetClass_Create()
	App.g_kSetManager.AddSet(pSet, "Sirius_B1")

	# Save the name of the region file that's creating the set.
	pSet.SetRegionModule("Systems.Sirius_B.Sirius_B1")
	...
	# "Sirius_B1_S.py" file with an Initialize function that creates them.
	try:
		import Sirius_B1_S
		Sirius_B1_S.Initialize(pSet)
	except ImportError:
		print "Couldn't find Sirius_B1_S..."
...
def GetSet():
	return App.g_kSetManager.GetSet("Sirius_B1")

def Terminate():
	App.g_kSetManager.DeleteSet("Sirius_B1")
...
def LoadPlacements(sSetName):
	...
	kThis.SetStatic(1)
	kThis.SetTranslateXYZ(0.0, 93308.57143, 3000.0)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000000, 1.000000, 0.000000)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.000000, 0.000000, 1.000000)
...
##	kThis.SetTranslateXYZ(0.0, 40000.0, 0.0)
	...
	kThis.SetStatic(1)
	kThis.SetTranslateXYZ(-10.0, -9978.0, -200.0)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000000, 1.000000, 0.000000)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.000000, 0.000000, 1.000000)
	...
	kThis.SetStatic(1)
	kThis.SetNavPoint(1)
	kThis.SetTranslateXYZ(0.0, 92308.57143, 3000.0)
	kForward = App.TGPoint3()
