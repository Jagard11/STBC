...
def Initialize():
	...
	App.g_kSetManager.AddSet(pSet, "Sol3")

	# Save the name of the region file that's creating the set.
	pSet.SetRegionModule("Systems.Sol.Sol3")
	...
	# "Sol3_S.py" file with an Initialize function that creates them.
	try:
		import Sol3_S
		Sol3_S.Initialize(pSet)
	except ImportError:
...
def GetSet():
	...
	return App.g_kSetManager.GetSet("Sol3")

def Terminate():
	debug(__name__ + ", Terminate")
	App.g_kSetManager.DeleteSet("Sol3")
