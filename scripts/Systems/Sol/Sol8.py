...
def Initialize():
	...
	App.g_kSetManager.AddSet(pSet, "Sol8")

	# Save the name of the region file that's creating the set.
	pSet.SetRegionModule("Systems.Sol.Sol8")
...
def GetSet():
	...
	return App.g_kSetManager.GetSet("Sol8")

def Terminate():
	debug(__name__ + ", Terminate")
	App.g_kSetManager.DeleteSet("Sol8")
...
def LoadPlacements(sSetName):
	...
	# Position "Planet1"
	kThis = App.Waypoint_Create("Neptune", sSetName, None)
	kThis.SetStatic(1)
	...
	# Position "Planet1" - 354,760 km average average distance
	kThis = App.Waypoint_Create("Triton", sSetName, None)
	kThis.SetStatic(1)
	coord = placer.SetOnOrbit(20272.00)
	kThis.SetTranslateXYZ(coord[0], coord[1], coord[2])
	kForward = App.TGPoint3()
	...
	kThis.SetStatic(1)
	kThis.SetTranslateXYZ(0.0, -257142857.14, -3000.0)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000000, 1.000000, 0.000000)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.000000, 0.000000, 1.000000)
