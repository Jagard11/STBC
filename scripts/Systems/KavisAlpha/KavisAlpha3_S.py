...
def Initialize(pSet):
	...
	pPlanet = App.Planet_Create(65.0, "data/models/environment/LavenderPlanet.NIF")
	pSet.AddObjectToSet(pPlanet, "Kavis Alpha 3")
	...
	try:    
                ...
                Custom.NanoFXv2.NanoFX_Lib.CreateAtmosphereFX(pPlanet, "data/models/environment/LavenderPlanet.NIF", "Class-N")        
	except ImportError:
	...
	pNebula.AddNebulaSphere(-38500.0, -500000.0, 4000.0,  20000.0)
	...
	# Adds a fuzzy sphere at x, y, z (in world coord) of specified size (1000.0 in this case)
	pNebula1.AddNebulaSphere(-43500.0, -500000.0, 4000.0,  20000.0)
	# Puts the nebula in the set
	...
	# Adds a fuzzy sphere at x, y, z (in world coord) of specified size (1000.0 in this case)
	pNebula2.AddNebulaSphere(-47500.0, -500000.0, 4000.0,  20000.0)
	# Puts the nebula in the set
