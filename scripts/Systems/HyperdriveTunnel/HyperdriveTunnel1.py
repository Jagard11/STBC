# A very basic system, like the bajoran wormhole map. Dummy to be more precise

import App

def Initialize():
	# Create the set ("HyperdriveTunnel1")
	pSet = App.SetClass_Create()
	App.g_kSetManager.AddSet(pSet, "HyperdriveTunnel1")

	# Save the name of the region file that's creating the set.
	pSet.SetRegionModule("Systems.HyperdriveTunnel.HyperdriveTunnel1")
	...
	LoadPlacements("HyperdriveTunnel1")
	LoadBackdrops(pSet)
...
def GetSetName():
	return "HyperdriveTunnel1"

def GetSet():
	return App.g_kSetManager.GetSet("HyperdriveTunnel1")

def Terminate():
	App.g_kSetManager.DeleteSet("HyperdriveTunnel1")
