...
def Initialize():
	# Create the set ("GravitonCatapult1")
	pSet = App.SetClass_Create()
	App.g_kSetManager.AddSet(pSet, "GravitonCatapult1")

	# Save the name of the region file that's creating the set.
	pSet.SetRegionModule("Systems.GravitonCatapult.GravitonCatapult1")

	# Activate the proximity manager for our set.
	pSet.SetProximityManagerActive(1)

	# Load the placements and backdrops for this set.
	LoadPlacements("GravitonCatapult1")
	LoadBackdrops(pSet)
	...
	# "GravitonCatapult1_S.py" file with an Initialize function that creates them.
	try:
		import GravitonCatapult1_S
		GravitonCatapult1_S.Initialize(pSet)
	except ImportError:
...
def GetSetName():
	return "GravitonCatapult1"

def GetSet():
	return App.g_kSetManager.GetSet("GravitonCatapult1")

def Terminate():
	App.g_kSetManager.DeleteSet("GravitonCatapult1")
...
def LoadPlacements(sSetName):
	...
	# Position "JLSGravitonCatapult"
	kThis = App.Waypoint_Create("Catapult", sSetName, None)
	kThis.SetStatic(1)
	kThis.SetNavPoint(1)
	...
	kThis.Update(0)
	kThis = None
	# End position "JLSGravitonCatapult"
