...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/EAStarfury/EAStarfuryNoEscapePod.nif",
		"FilenameLow": "data/Models/Ships/EAStarfury/EAStarfuryNoEscapePod.nif",
		"Name": "EAStarfuryNoEscapePod",
		"HardpointFile": "EAStarfuryNoEscapePod",
