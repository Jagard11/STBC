...
def GetShipStats():
	kShipStats = {
		"DamageRadMod" : 0.75, 
		"DamageStrMod" : 0.75, 
		"FilenameHigh": "data/Models/Bases/Malon/MalonHomeworld.nif",
		"FilenameMed": "data/Models/Bases/Malon/MalonHomeworld.nif",
		"FilenameLow": "data/Models/Bases/Malon/MalonHomeworld.nif",
		"Name": "MaloneHomeworld",
		"HardpointFile": "MalonPlanet",
