...
def GetShipStats():
	kShipStats = {
		"DamageRadMod" : 0.75, 
		"DamageStrMod" : 0.75, 
		"FilenameHigh": "data/Models/Ships/AncientWarship/AncientWarship.nif",
		"FilenameMed": "data/Models/Ships/AncientWarship/AncientWarship.nif",
		"FilenameLow": "data/Models/Ships/AncientWarship/AncientWarship.nif",
		"Name": "DamagedWarship",
		"HardpointFile": "DamagedWarship",
