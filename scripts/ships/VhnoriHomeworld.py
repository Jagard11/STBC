...
def GetShipStats():
	kShipStats = {
		"DamageRadMod" : 0.75, 
		"DamageStrMod" : 0.75, 
		"FilenameHigh": "data/Models/Bases/VhnoriHomeworld/Rings.nif",
		"FilenameMed": "data/Models/Bases/VhnoriHomeworld/Rings.nif",
		"FilenameLow": "data/Models/Bases/VhnoriHomeworld/Rings.nif",
		"Name": "Vhnori",
		"HardpointFile": "VhnoriHomeworld",
