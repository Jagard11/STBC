...
def GetShipStats():
	kShipStats = { 
		"FilenameHigh": "data/Models/Ships/ThirdspaceFighter/ThirdspaceFighter.nif",
		"FilenameMed": "data/Models/Ships/ThirdspaceFighter/ThirdspaceFighter.nif",
		"FilenameLow": "data/Models/Ships/ThirdspaceFighter/ThirdspaceFighter.nif",
		"Name": "ThirdspaceFighter",
		"HardpointFile": "ThirdspaceFighter",
