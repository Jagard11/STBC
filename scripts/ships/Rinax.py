...
def GetShipStats():
	kShipStats = {
		"DamageRadMod" : 0.75, 
		"DamageStrMod" : 0.75, 
		"FilenameHigh": "data/Models/Bases/Talax/Rinax/Rinax.nif",
		"FilenameMed": "data/Models/Bases/Talax/Rinax/Rinax.nif",
		"FilenameLow": "data/Models/Bases/Talax/Rinax/Rinax.nif",
		"Name": "Rinax",
		"HardpointFile": "Rinax",
