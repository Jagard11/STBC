...
def GetShipStats():
	kShipStats = {
		"DamageRadMod" : 0.75, 
		"DamageStrMod" : 0.75, 
		"FilenameHigh": "data/Models/Bases/VhnoriHomeworld/Rings1.nif",
		"FilenameMed": "data/Models/Bases/VhnoriHomeworld/Rings1.nif",
		"FilenameLow": "data/Models/Bases/VhnoriHomeworld/Rings1.nif",
		"Name": "VhnoriRings",
		"HardpointFile": "VhnoriRings",
