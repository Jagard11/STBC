...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/TelTak/TelTak.nif",
		"FilenameMed": "data/Models/Ships/TelTak/TelTak.nif",
		"FilenameLow": "data/Models/Ships/TelTak/TelTak.nif",
		"Name": "ModifiedTelTak",
		"HardpointFile": "ModifiedTelTak",
...
def HyperdriveCustomizations():
        dict = {'TunnelTexture' : 'Hyperspace3.tga',
