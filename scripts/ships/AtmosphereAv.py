...
def GetShipStats():
	kShipStats = {
		"DamageRadMod" : 0.75, 
		"DamageStrMod" : 0.75, 
		"FilenameHigh": "data/Models/Bases/AveryIII/AtmosphereAv.nif",
		"FilenameMed": "data/Models/Bases/AveryIII/AtmosphereAv.nif",
		"FilenameLow": "data/Models/Bases/AveryIII/AtmosphereAv.nif",
		"Name": "AtmosphereAv",
		"HardpointFile": "AtmosphereAv",
