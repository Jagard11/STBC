...
def GetShipStats():
	kShipStats = {
		"DamageRadMod" : 0.75, 
		"DamageStrMod" : 0.75, 
		"FilenameHigh": "data/Models/Bases/BorgPrime/BorgPrime.nif",
		"FilenameMed": "data/Models/Bases/BorgPrime/BorgPrime.nif",
		"FilenameLow": "data/Models/Bases/BorgPrime/BorgPrime.nif",
		"Name": "BorgPrime",
		"HardpointFile": "BorgPrime",
