...
def GetShipStats():
	kShipStats = { 
		"FilenameHigh": "data/Models/Ships/EAShadow_Hybrid/EAShadow_Hybrid.nif",
		"FilenameMed": "data/Models/Ships/EAShadow_Hybrid/EAShadow_Hybrid.nif",
		"FilenameLow": "data/Models/Ships/EAShadow_Hybrid/EAShadow_Hybrid.nif",
		"Name": "EAShadow_Hybrid",
		"HardpointFile": "EAShadow_Hybrid",
