...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Bases/jumpspace/outer.NIF",
		"FilenameMed": "data/Models/Bases/jumpspace/outer.NIF",
		"FilenameLow": "data/Models/Bases/jumpspace/outer.NIF",
		"Name": "jumpspace",
		"HardpointFile": "jumpspace",
