...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/Stargates/MilkyWayInactive.nif",
		"FilenameMed": "data/Models/Ships/Stargates/MilkyWayInactive.nif",
		"FilenameLow": "data/Models/Ships/Stargates/MilkyWayInactive.nif",
		"Name": "MilkyWayInactive",
		"HardpointFile": "MilkyWayInactive",
