...
def GetShipStats():
	kShipStats = {
		"DamageRadMod" : 0.75, 
		"DamageStrMod" : 0.75, 
		"FilenameHigh": "data/Models/Bases/Sikaris/Sikaris.nif",
		"FilenameMed": "data/Models/Bases/Sikaris/Sikaris.nif",
		"FilenameLow": "data/Models/Bases/Sikaris/Sikaris.nif",
		"Name": "Sikaris",
		"HardpointFile": "Sikaris",
