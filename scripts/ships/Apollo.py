...
def GetShipStats():
	kShipStats = {
		"DamageRadMod" : 0.75, 
		"DamageStrMod" : 0.75, 
		"FilenameHigh": "data/Models/Ships/DSC304/Apollo.nif",
		"FilenameMed": "data/Models/Ships/DSC304/Apollo.nif",
		"FilenameLow": "data/Models/Ships/DSC304/Apollo.nif",
		"Name": "Apollo",
		"HardpointFile": "Apollo",
