...
def GetShipStats():
	kShipStats = {
		"DamageRadMod" : 0.75, 
		"DamageStrMod" : 0.75, 
		"FilenameHigh": "data/Models/Bases/Veloce/Veloce.nif",
		"FilenameMed": "data/Models/Bases/Veloce/Veloce.nif",
		"FilenameLow": "data/Models/Bases/Veloce/Veloce.nif",
		"Name": "JLSTractor",
		"HardpointFile": "JLSTractor",
