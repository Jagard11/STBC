...
def GetShipStats():
	kShipStats = { 
		"FilenameHigh": "data/Models/Ships/Shadow_Fighter/Shadow_FighterBall.nif",
		"FilenameMed": "data/Models/Ships/Shadow_Fighter/Shadow_FighterBall.nif",
		"FilenameLow": "data/Models/Ships/Shadow_Fighter/Shadow_FighterBall.nif",
		"Name": "Shadow_FighterBal",
		"HardpointFile": "Shadow_FighterBall",
