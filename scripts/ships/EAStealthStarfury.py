...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/EAStarfury/EAStealthStarfury.nif",
		"FilenameLow": "data/Models/Ships/EAStarfury/EAStealthStarfury.nif",
		"Name": "EAStealthStarfury",
		"HardpointFile": "EAStealthStarfury",
