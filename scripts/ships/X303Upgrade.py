...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/x303/x303.nif",
		"FilenameMed": "data/Models/Ships/x303/x303.nif",
		"FilenameLow": "data/Models/Ships/x303/x303.nif",
		"Name": "X303Upgrade",
		"HardpointFile": "X303Upgrade",
