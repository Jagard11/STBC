...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/VreeXill/VreeXill.nif",
		"FilenameMed": "data/Models/Ships/VreeXill/VreeXill.nif",
		"FilenameLow": "data/Models/Ships/VreeXill/VreeXill.nif",
		"Name": "VreeXill",
		"HardpointFile": "VreeXill",
