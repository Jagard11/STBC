...
def GetShipStats():
	kShipStats = {
		"DamageRadMod" : 0.75, 
		"DamageStrMod" : 0.75, 
		"FilenameHigh": "data/Models/Bases/Veloce/AtmosphereUn.nif",
		"FilenameMed": "data/Models/Bases/Veloce/AtmosphereUn.nif",
		"FilenameLow": "data/Models/Bases/Veloce/AtmosphereUn.nif",
		"Name": "AtmosphereUn",
		"HardpointFile": "AtmosphereUn",
