...
def GetShipStats():
	kShipStats = {
		"DamageRadMod" : 0.75, 
		"DamageStrMod" : 0.75, 
		"FilenameHigh": "data/Models/Ships/DSC304/Korolev.nif",
		"FilenameMed": "data/Models/Ships/DSC304/Korolev.nif",
		"FilenameLow": "data/Models/Ships/DSC304/Korolev.nif",
		"Name": "Korolev",
		"HardpointFile": "Korolev",
