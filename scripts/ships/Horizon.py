...
def GetShipStats():
	kShipStats = {
		"DamageRadMod" : 0.75, 
		"DamageStrMod" : 0.75, 
		"FilenameHigh": "data/Models/Ships/Horizon/Horizon.nif",
		"FilenameMed": "data/Models/Ships/Horizon/Horizon.nif",
		"FilenameLow": "data/Models/Ships/Horizon/Horizon.nif",
		"Name": "Horizon",
		"HardpointFile": "Horizon",
