...
def GetShipStats():
	kShipStats = {
		"DamageRadMod" : 0.75, 
		"DamageStrMod" : 0.75, 
		"FilenameHigh": "data/Models/Bases/Deltoria/Deltoria.nif",
		"FilenameMed": "data/Models/Bases/Deltoria/Deltoria.nif",
		"FilenameLow": "data/Models/Bases/Deltoria/Deltoria.nif",
		"Name": "Deltoria",
		"HardpointFile": "Deltoria",
