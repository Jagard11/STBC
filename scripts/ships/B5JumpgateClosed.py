...
def GetShipStats():
	kShipStats = { 
		"FilenameHigh": "data/Models/Ships/B5Jumpgate/B5JumpgateClosed.nif",
		"FilenameMed": "data/Models/Ships/B5Jumpgate/B5JumpgateClosed.nif",
		"FilenameLow": "data/Models/Ships/B5Jumpgate/B5JumpgateClosed.nif",
		"Name": "B5JumpgateClosed",
		"HardpointFile": "B5JumpgateClosed",
