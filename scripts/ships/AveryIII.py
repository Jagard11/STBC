...
def GetShipStats():
	kShipStats = {
		"DamageRadMod" : 0.75, 
		"DamageStrMod" : 0.75, 
		"FilenameHigh": "data/Models/Bases/AveryIII/AveryIII.nif",
		"FilenameMed": "data/Models/Bases/AveryIII/AveryIII.nif",
		"FilenameLow": "data/Models/Bases/AveryIII/AveryIII.nif",
		"Name": "AveryIII",
		"HardpointFile": "AveryIII",
