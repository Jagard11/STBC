...
def GetShipStats():
	kShipStats = {
		"DamageRadMod" : 0.75, 
		"DamageStrMod" : 0.75, 
		"FilenameHigh": "data/Models/Bases/TranswarpHub/THub.nif",
		"FilenameMed": "data/Models/Bases/TranswarpHub/THub.nif",
		"FilenameLow": "data/Models/Bases/TranswarpHub/THub.nif",
		"Name": "TranswarpHubSun",
		"HardpointFile": "TranswarpHubSun",
