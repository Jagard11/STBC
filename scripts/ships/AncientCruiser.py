...
def GetShipStats():
	kShipStats = {
		"DamageRadMod" : 0.75, 
		"DamageStrMod" : 0.75, 
		"FilenameHigh": "data/Models/Ships/AncientWarship/AncientCruiser.nif",
		"FilenameMed": "data/Models/Ships/AncientWarship/AncientCruiser.nif",
		"FilenameLow": "data/Models/Ships/AncientWarship/AncientCruiser.nif",
		"Name": "AncientCruiser",
		"HardpointFile": "AncientCruiser",
