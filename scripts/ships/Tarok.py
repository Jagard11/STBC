...
def GetShipStats():
	kShipStats = {
		"DamageRadMod" : 0.75, 
		"DamageStrMod" : 0.75, 
		"FilenameHigh": "data/Models/Bases/Deltoria/Tarok/Tarok.nif",
		"FilenameMed": "data/Models/Bases/Deltoria/Tarok/Tarok.nif",
		"FilenameLow": "data/Models/Bases/Deltoria/Tarok/Tarok.nif",
		"Name": "Tarok",
		"HardpointFile": "Tarok",
