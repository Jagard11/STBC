...
def GetShipStats():
	kShipStats = {
		...
		"FilenameMed": "data/Models/Ships/B5TechnomageTransport/B5TechnomageTransport.nif",
		"FilenameLow": "data/Models/Ships/B5TechnomageTransport/B5TechnomageTransport.nif",
		"Name": "B5TechnomageTransport",
