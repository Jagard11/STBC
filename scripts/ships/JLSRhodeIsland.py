...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/DQP/JLSRhodeIsland/RhodeIsland.nif",
		"FilenameMed": "data/Models/Ships/DQP/JLSRhodeIsland/RhodeIsland.nif",
		"FilenameLow": "data/Models/ships/DQP/JLSRhodeIsland/RhodeIsland.nif",
		"Name": "USS RhodeIsland",
		"HardpointFile": "JLSRhodeIsland",
