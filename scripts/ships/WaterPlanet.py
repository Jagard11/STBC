...
def GetShipStats():
	kShipStats = {
		"DamageRadMod" : 0.75, 
		"DamageStrMod" : 0.75, 
		"FilenameHigh": "data/Models/Bases/WaterPlanet/WaterPlanet.nif",
		"FilenameMed": "data/Models/Bases/WaterPlanet/WaterPlanet.nif",
		"FilenameLow": "data/Models/Bases/WaterPlanet/WaterPlanet.nif",
		"Name": "WaterPlanet",
		"HardpointFile": "WaterPlanet",
