...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Bases/DQP/JLSBorgHub/BorgHub.nif",
		"FilenameMed": "data/Models/Bases/DQP/JLSBorgHub/BorgHubMed.nif",
		"FilenameLow": "data/Models/Bases/DQP/JLSBorgHub/BorgHubLow.nif",
		"Name": "TranswarpHub",
		"HardpointFile": "JLSBorgHub",
