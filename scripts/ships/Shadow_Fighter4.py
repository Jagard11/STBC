...
def GetShipStats():
	kShipStats = { 
		"FilenameHigh": "data/Models/Ships/Shadow_Fighter/Shadow_Fighter.nif",
		"FilenameMed": "data/Models/Ships/Shadow_Fighter/Shadow_Fighter.nif",
		"FilenameLow": "data/Models/Ships/Shadow_Fighter/Shadow_Fighter.nif",
		"Name": "Shadow_Fighter4",
		"HardpointFile": "Shadow_Fighter",
