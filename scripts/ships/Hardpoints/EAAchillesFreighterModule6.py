# C:\Program Files\Activision\AllStuff\Bridge Commander\scripts\ships\Hardpoints\EAAchillesFreighterModule6.py
...
#################################################
EAAchillesFreighterModule6 = App.ShipProperty_Create("EAAchillesFreighterModule6")

EAAchillesFreighterModule6.SetGenus(1)
EAAchillesFreighterModule6.SetSpecies(106)
EAAchillesFreighterModule6.SetMass(20.000000)
EAAchillesFreighterModule6.SetRotationalInertia(1000.000000)
EAAchillesFreighterModule6.SetShipName("EAAchillesFreighterModule6")
EAAchillesFreighterModule6.SetModelFilename("data/Models/Ships/EAAchillesFreighter/EAAchillesFreighterRightModule.nif")
EAAchillesFreighterModule6.SetDamageResolution(5.000000)
EAAchillesFreighterModule6.SetAffiliation(0)
EAAchillesFreighterModule6.SetStationary(0)
EAAchillesFreighterModule6.SetAIString("NonFedAttack")
EAAchillesFreighterModule6.SetDeathExplosionSound("g_lsDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(EAAchillesFreighterModule6)
#################################################
...
#################################################
CargoModule1 = App.HullProperty_Create("Cargo Module 6")
