...
DeathRay.SetRechargeRate(0.005000)
...
TelepathAttack.SetArcWidthAngles(-5.094395, 5.094395)
TelepathAttack.SetArcHeightAngles(-5.094395, 5.094395)
TelepathAttack.SetCooldownTime(120.000000)
TelepathAttack.SetModuleName("Tactical.Projectiles.B5ThirdspaceTeleAttack2")
