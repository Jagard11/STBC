...
EAAchillesFreighterModule2.SetShipName("EAAchillesFreighterModule1")
EAAchillesFreighterModule2.SetModelFilename("data/Models/Ships/EAAchillesFreighter/EAAchillesFreighterLeftModule.nif")
