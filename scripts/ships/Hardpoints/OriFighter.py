# C:\Program Files\Activision\Bridge Commander\scripts\ships\Hardpoints\OriFighter.py
...
#################################################
OriFighter = App.ShipProperty_Create("Ori Fighter")

OriFighter.SetGenus(1)
OriFighter.SetSpecies(759)
OriFighter.SetMass(25.000000)
OriFighter.SetRotationalInertia(2000.000000)
OriFighter.SetShipName("OriFighter")
OriFighter.SetModelFilename("data/Models/Ships/OriWarship/OriFighter.NIF")
OriFighter.SetDamageResolution(0.000100)
OriFighter.SetAffiliation(0)
OriFighter.SetStationary(0)
OriFighter.SetAIString("RomulanAttack")
OriFighter.SetDeathExplosionSound("g_lsDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(OriFighter)
#################################################
...
#################################################
Orb10 = App.BlinkingLightProperty_Create("Orb 10")

Orb10Forward = App.TGPoint3()
Orb10Forward.SetXYZ(0.000000, -1.000000, 0.000000)
Orb10Up = App.TGPoint3()
Orb10Up.SetXYZ(0.000000, 0.000000, 1.000000)
Orb10Right = App.TGPoint3()
Orb10Right.SetXYZ(-1.000000, 0.000000, 0.000000)
Orb10.SetOrientation(Orb10Forward, Orb10Up, Orb10Right)
Orb10Position = App.TGPoint3()
Orb10Position.SetXYZ(0.000000, -0.061000, -0.006500)
Orb10.SetPosition(Orb10Position)
Orb10LightColor = App.TGColorA()
Orb10LightColor.SetRGBA(0.703137, 0.685882, 0.952941, 0.200000)
Orb10.SetColor(Orb10LightColor)
Orb10.SetRadius(20.000000)
Orb10.SetPeriod(3.000000)
Orb10.SetDuration(0.000000)
Orb10.SetTextureName("scripts/Custom/NanoFXv2/SpecialFX/Gfx/Blinker/Blank.tga")
App.g_kModelPropertyManager.RegisterLocalTemplate(Orb10)
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("Ori Fighter", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("Orb 10", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
