# F:\Program Files\Activision\Bridge Commander Enemys Of Life\scripts\ships\Hardpoints\Pod1.py
...
#################################################
Pod1 = App.ShipProperty_Create("Pod 1")

Pod1.SetGenus(1)
Pod1.SetSpecies(747)
Pod1.SetMass(1000.010000)
Pod1.SetRotationalInertia(2000.000000)
Pod1.SetShipName("Pod1")
Pod1.SetModelFilename("data/Models/Ships/Alkesh/Pod.nif")
Pod1.SetDamageResolution(0.000100)
Pod1.SetAffiliation(0)
Pod1.SetStationary(0)
Pod1.SetAIString("FedAttack")
Pod1.SetDeathExplosionSound("g_lsDeathExplosions")
