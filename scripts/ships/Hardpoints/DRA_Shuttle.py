...
ShieldGenerator.SetShieldGlowDecay(0.050000)
...
SensorArray.SetPosition(0.000000, 1.535871, 0.000000)
...
WarpCore.SetPosition(0.000000, -0.050000, 0.000000)
...
ImpulseEngines.SetMaxCondition(80.000000)
...
Torpedoes.SetPosition(0.000000, 0.981951, 0.000000)
...
Torpedoes.SetNormalPowerPerSecond(0.100000)
...
Bridge.SetMaxCondition(90.000000)
Bridge.SetCritical(1)
Bridge.SetTargetable(1)
Bridge.SetPrimary(0)
Bridge.SetPosition(0.000000, 0.030950, 0.000000)
...
Mengine.SetMaxCondition(90.000000)
Mengine.SetCritical(0)
Mengine.SetTargetable(1)
Mengine.SetPrimary(1)
Mengine.SetPosition(0.000000, -0.041430, 0.000000)
...
enginelightPosition.SetXYZ(0.000000, -0.041430, 0.000000)
...
enginelight.SetRadius(20.000000)
...
Drakh.SetMass(5.000000)
Drakh.SetRotationalInertia(8000.000000)
Drakh.SetShipName("DRA_Shuttle")
Drakh.SetModelFilename("data/Models/Ships/DRA_Shuttle/DRA_Shuttle.nif")
...
DrakhWeapon.SetMaxCondition(80.000000)
...
DrakhWeapon.SetNormalPowerPerSecond(20.000000)
...
MainEmitter.SetMaxCondition(20.000000)
MainEmitter.SetCritical(0)
MainEmitter.SetTargetable(1)
MainEmitter.SetPrimary(1)
MainEmitter.SetPosition(0.000000, 0.040000, 0.000000)
...
MainEmitter.SetMaxCharge(1.000000)
MainEmitter.SetMaxDamage(40.000000)
MainEmitter.SetMaxDamageDistance(10.000000)
MainEmitter.SetMinFiringCharge(1.000000)
...
MainEmitter.SetMainRadius(0.001000)
MainEmitter.SetTaperRadius(0.001000)
