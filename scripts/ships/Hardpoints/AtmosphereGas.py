# C:\Program Files (x86)\Activision\Bridge Commander  KM v1 plus\scripts\ships\Hardpoints\AtmosphereGas.py
...
#################################################
AtmosphereGas = App.ShipProperty_Create("AtmosphereGas")

AtmosphereGas.SetGenus(2)
AtmosphereGas.SetSpecies(145)
AtmosphereGas.SetMass(60.000000)
AtmosphereGas.SetRotationalInertia(7000.000000)
AtmosphereGas.SetShipName("AtmosphereGas")
AtmosphereGas.SetModelFilename("data/Models/Bases/Deltoria/AtmosphereGas.nif")
AtmosphereGas.SetDamageResolution(75.000000)
AtmosphereGas.SetAffiliation(0)
AtmosphereGas.SetStationary(0)
AtmosphereGas.SetAIString("StarbaseAttack")
AtmosphereGas.SetDeathExplosionSound("g_lsBigDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(AtmosphereGas)
#################################################
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("AtmosphereGas", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
