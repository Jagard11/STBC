# C:\Program Files\Activision\Bridge Commander\scripts\ships\Hardpoints\Cloud9.py
...
SubLight2.SetMaxCondition(3200.000000)
...
SubLight1.SetMaxCondition(3200.000000)
...
SubLight3.SetMaxCondition(3200.000000)
