# C:\Program Files\Activision\Bridge Commander\scripts\ships\Hardpoints\F302.py
...
Hull.SetMaxCondition(650.000000)
Hull.SetCritical(1)
...
FuelReserves.SetPosition2D(65, 60)
...
#################################################
F302 = App.ShipProperty_Create("F302")

F302.SetGenus(1)
F302.SetSpecies(750)
F302.SetMass(30.000000)
F302.SetRotationalInertia(2000.000000)
F302.SetShipName("F302")
F302.SetModelFilename("data/Models/Ships/F302/F302.NIF")
F302.SetDamageResolution(0.000100)
F302.SetAffiliation(0)
F302.SetStationary(0)
F302.SetAIString("RomulanAttack")
F302.SetDeathExplosionSound("g_lsDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(F302)
#################################################
...
JetEngine1.SetPosition(-0.020000, -0.040000, 0.000000)
JetEngine1.SetPosition2D(52, 70)
...
JetEngine2.SetPosition(0.020000, -0.040000, 0.000000)
JetEngine2.SetPosition2D(78, 70)
...
PortMissiles.SetPosition2D(52, 35)
...
PortMissiles.SetIconPositionX(67)
PortMissiles.SetIconPositionY(65)
...
StarMissiles.SetPosition2D(78, 35)
...
StarMissiles.SetIconPositionX(86)
StarMissiles.SetIconPositionY(65)
...
#################################################
Canon = App.WeaponSystemProperty_Create("Canon")

Canon.SetMaxCondition(1800.000000)
Canon.SetCritical(0)
Canon.SetTargetable(0)
Canon.SetPrimary(1)
Canon.SetPosition(0.000000, 0.000000, 0.000000)
Canon.SetPosition2D(0.000000, 0.000000)
Canon.SetRepairComplexity(1.000000)
Canon.SetDisabledPercentage(0.500000)
Canon.SetRadius(0.001000)
Canon.SetNormalPowerPerSecond(1.000000)
Canon.SetWeaponSystemType(Canon.WST_PULSE)
Canon.SetSingleFire(0)
Canon.SetAimedWeapon(0)
kFiringChainString = App.TGString()
kFiringChainString.SetString("")
Canon.SetFiringChainString(kFiringChainString)
App.g_kModelPropertyManager.RegisterLocalTemplate(Canon)
#################################################
MainCanon = App.PulseWeaponProperty_Create("Main Canon")

MainCanon.SetMaxCondition(1200.000000)
MainCanon.SetCritical(0)
MainCanon.SetTargetable(1)
MainCanon.SetPrimary(1)
MainCanon.SetPosition(0.000000, 0.030000, -0.002000)
MainCanon.SetPosition2D(64, 12)
MainCanon.SetRepairComplexity(1.000000)
MainCanon.SetDisabledPercentage(0.500000)
MainCanon.SetRadius(0.001000)
MainCanon.SetDumbfire(1)
MainCanon.SetWeaponID(0)
MainCanon.SetGroups(0)
MainCanon.SetDamageRadiusFactor(0.100000)
MainCanon.SetIconNum(365)
MainCanon.SetIconPositionX(76)
MainCanon.SetIconPositionY(55)
MainCanon.SetIconAboveShip(1)
MainCanon.SetFireSound("")
MainCanon.SetMaxCharge(350.000000)
MainCanon.SetMaxDamage(1.000000)
MainCanon.SetMaxDamageDistance(50.000000)
MainCanon.SetMinFiringCharge(3.000000)
MainCanon.SetNormalDischargeRate(1.000000)
MainCanon.SetRechargeRate(0.000000)
MainCanon.SetIndicatorIconNum(0)
MainCanon.SetIndicatorIconPositionX(0)
MainCanon.SetIndicatorIconPositionY(0)
MainCanonForward = App.TGPoint3()
MainCanonForward.SetXYZ(0.000000, 1.000000, 0.000000)
MainCanonUp = App.TGPoint3()
MainCanonUp.SetXYZ(0.000000, 0.000000, 1.000000)
MainCanon.SetOrientation(MainCanonForward, MainCanonUp)
MainCanon.SetArcWidthAngles(-0.174533, 0.174533)
MainCanon.SetArcHeightAngles(-0.174533, 0.174533)
MainCanon.SetCooldownTime(0.000000)
MainCanon.SetModuleName("Tactical.Projectiles.F302Cannon")
App.g_kModelPropertyManager.RegisterLocalTemplate(MainCanon)

# Property load function.
def LoadPropertySet(pObj):
	"Sets up the object's properties."
	prop = App.g_kModelPropertyManager.FindByName("F302", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("Canon", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("Main Canon", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
