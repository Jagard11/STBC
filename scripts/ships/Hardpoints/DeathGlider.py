...
#################################################
DeathGlider = App.ShipProperty_Create("Death Glider")

DeathGlider.SetGenus(1)
DeathGlider.SetSpecies(787)
DeathGlider.SetMass(25.000000)
DeathGlider.SetRotationalInertia(2000.000000)
DeathGlider.SetShipName("Death Glider")
DeathGlider.SetModelFilename("data/Models/Ships/sgdg/DG_SG1.NIF")
DeathGlider.SetDamageResolution(0.000100)
DeathGlider.SetAffiliation(0)
DeathGlider.SetStationary(0)
DeathGlider.SetAIString("RomulanAttack")
DeathGlider.SetDeathExplosionSound("g_lsDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(DeathGlider)
#################################################
...
MainEngine.SetPosition2D(64, 82)
...
def LoadPropertySet(pObj):
	...
	prop = App.g_kModelPropertyManager.FindByName("Death Glider", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
