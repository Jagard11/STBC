# C:\Program Files\Activision\Bridge Commander\scripts\ships\Hardpoints\AncientSatellite.py
...
ShieldGenerator.SetPosition2D(65, 55)
...
ShieldGenerator.SetMaxShields(ShieldGenerator.FRONT_SHIELDS, 22000.000000)
ShieldGenerator.SetMaxShields(ShieldGenerator.REAR_SHIELDS, 22000.000000)
ShieldGenerator.SetMaxShields(ShieldGenerator.TOP_SHIELDS, 22000.000000)
ShieldGenerator.SetMaxShields(ShieldGenerator.BOTTOM_SHIELDS, 22000.000000)
ShieldGenerator.SetMaxShields(ShieldGenerator.LEFT_SHIELDS, 22000.000000)
ShieldGenerator.SetMaxShields(ShieldGenerator.RIGHT_SHIELDS, 22000.000000)
...
ReactorModule.SetPosition2D(65, 42)
...
ReactorModule.SetPowerOutput(2300.000000)
...
#################################################
AncientSatellite = App.ShipProperty_Create("Ancient Satellite")

AncientSatellite.SetGenus(1)
AncientSatellite.SetSpecies(772)
AncientSatellite.SetMass(700.000000)
AncientSatellite.SetRotationalInertia(5000.000000)
AncientSatellite.SetShipName("AncientSatellite")
AncientSatellite.SetModelFilename("data/Models/Ships/AncientSatellite/AncientSatellite.nif")
AncientSatellite.SetDamageResolution(0.000100)
AncientSatellite.SetAffiliation(0)
AncientSatellite.SetStationary(0)
AncientSatellite.SetAIString("NonFedAttack")
AncientSatellite.SetDeathExplosionSound("g_lsDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(AncientSatellite)
#################################################
...
RotationalThruster1.SetPosition2D(52, 42)
...
MainWeapon.SetNormalPowerPerSecond(500.000000)
...
RotationalThruster2.SetPosition2D(77, 42)
...
RotationalThruster3.SetPosition2D(52, 57)
...
RotationalThruster4.SetPosition2D(77, 57)
...
def LoadPropertySet(pObj):
	...
	prop = App.g_kModelPropertyManager.FindByName("Ancient Satellite", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
