# C:\Users\Admin\bcsdk1_1\Tools\ModelPropertyEditor\Krenim Warship\JLSKrenimWarship.py
...
KrenimWarship.SetMass(394.000000)
KrenimWarship.SetRotationalInertia(6000.000000)
...
Bridge.SetPrimary(0)
Bridge.SetPosition(0.005724, 1.719810, 0.212624)
Bridge.SetPosition2D(64, 50)
...
ShieldGenerator.SetMaxShields(ShieldGenerator.REAR_SHIELDS, 37000.000000)
ShieldGenerator.SetMaxShields(ShieldGenerator.TOP_SHIELDS, 37000.000000)
ShieldGenerator.SetMaxShields(ShieldGenerator.BOTTOM_SHIELDS, 37000.000000)
ShieldGenerator.SetMaxShields(ShieldGenerator.LEFT_SHIELDS, 37000.000000)
ShieldGenerator.SetMaxShields(ShieldGenerator.RIGHT_SHIELDS, 37000.000000)
...
WarpCore.SetPosition(0.001729, -0.750000, 0.000000)
WarpCore.SetPosition2D(65, 79)
...
ImpulseEngines.SetPosition(0.000000, -2.354617, 0.000000)
ImpulseEngines.SetPosition2D(64, 96)
ImpulseEngines.SetRepairComplexity(4.000000)
ImpulseEngines.SetDisabledPercentage(0.500000)
ImpulseEngines.SetRadius(10.090000)
...
MainEngine.SetPosition(0.008588, -2.484950, -0.005777)
MainEngine.SetPosition2D(65, 110)
...
PortEngine.SetPosition2D(51, 106)
...
StarEngine.SetPosition2D(78, 106)
...
WarpEngines.SetPosition(0.000000, 0.483531, 0.000000)
...
PortWarp.SetPosition(-0.283779, 0.406866, -0.020000)
PortWarp.SetPosition2D(38, 75)
...
StarWarp.SetPosition(0.283779, 0.406866, -0.020000)
StarWarp.SetPosition2D(91, 76)
...
SensorArray.SetPosition(0.000000, 1.688230, -0.104879)
SensorArray.SetPosition2D(65, -3)
...
ViewscreenForwardPosition.SetXYZ(-0.013075, 4.981376, -0.065633)
...
ViewscreenBackPosition.SetXYZ(-0.015883, -2.636061, -0.011674)
...
FirstPersonCameraPosition.SetXYZ(-0.004586, 2.880685, 0.066199)
...
Torpedoes.SetTorpedoScript(0, "Tactical.Projectiles.JLSKrenimChroniton")
...
ForwardTorpedo1.SetIconPositionX(71)
ForwardTorpedo1.SetIconPositionY(28)
...
Disruptors.SetMaxCondition(7000.000000)
Disruptors.SetCritical(0)
Disruptors.SetTargetable(1)
Disruptors.SetPrimary(1)
Disruptors.SetPosition(0.000000, 2.300000, 0.000000)
...
Disruptor1.SetMaxCondition(5000.000000)
Disruptor1.SetCritical(0)
Disruptor1.SetTargetable(1)
Disruptor1.SetPrimary(1)
Disruptor1.SetPosition(-0.163587, 2.654740, 0.000737)
...
Disruptor1.SetIconPositionX(86)
Disruptor1.SetIconPositionY(33)
...
Disruptor1.SetIndicatorIconPositionX(75)
Disruptor1.SetIndicatorIconPositionY(25)
...
Disruptor1.SetArcWidthAngles(-0.174533, 0.523599)
Disruptor1.SetArcHeightAngles(-0.523599, 0.174533)
...
Disruptor2.SetPosition(0.180804, 2.654740, -0.000919)
...
Disruptor2.SetIconPositionX(54)
Disruptor2.SetIconPositionY(33)
...
Disruptor2.SetIndicatorIconPositionX(43)
Disruptor2.SetIndicatorIconPositionY(26)
...
Disruptor2.SetArcWidthAngles(-0.523599, 0.174533)
Disruptor2.SetArcHeightAngles(-0.523599, 0.174533)
