# C:\Program Files (x86)\Activision\Bridge Commander  KM v1 plus\scripts\ships\Hardpoints\AtmosphereV.py
...
#################################################
AtmosphereV = App.ShipProperty_Create("AtmosphereV")

AtmosphereV.SetGenus(2)
AtmosphereV.SetSpecies(145)
AtmosphereV.SetMass(60.000000)
AtmosphereV.SetRotationalInertia(7000.000000)
AtmosphereV.SetShipName("AtmosphereV")
AtmosphereV.SetModelFilename("data/Models/Bases/Vaadwaur/AtmosphereV.nif")
AtmosphereV.SetDamageResolution(75.000000)
AtmosphereV.SetAffiliation(0)
AtmosphereV.SetStationary(0)
AtmosphereV.SetAIString("StarbaseAttack")
AtmosphereV.SetDeathExplosionSound("g_lsBigDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(AtmosphereV)
#################################################
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("AtmosphereV", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
