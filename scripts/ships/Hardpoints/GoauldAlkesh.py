# C:\Program Files\Activision\Bridge Commander\scripts\ships\Hardpoints\GoauldAlkesh.py
...
Launcher1.SetIconPositionY(100)
...
Launcher2.SetIconPositionX(70)
Launcher2.SetIconPositionY(100)
...
Staff1.SetIndicatorIconPositionX(15)
Staff1.SetIndicatorIconPositionY(15)
...
Staff2.SetIndicatorIconPositionX(15)
Staff2.SetIndicatorIconPositionY(15)
...
CloakingDevice.SetPosition2D(65, 44)
