# C:\Program Files\Activision\Bridge Commander\scripts\ships\Hardpoints\Glider5.py
...
#################################################
Glider5 = App.ShipProperty_Create("Glider5")

Glider5.SetGenus(1)
Glider5.SetSpecies(714)
Glider5.SetMass(25.000000)
Glider5.SetRotationalInertia(2000.000000)
Glider5.SetShipName("Glider5")
Glider5.SetModelFilename("data/Models/Ships/sgdg/DG_SG1.NIF")
Glider5.SetDamageResolution(0.000100)
Glider5.SetAffiliation(0)
Glider5.SetStationary(0)
Glider5.SetAIString("RomulanAttack")
Glider5.SetDeathExplosionSound("g_lsDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(Glider5)
#################################################
...
def LoadPropertySet(pObj):
	...
	prop = App.g_kModelPropertyManager.FindByName("Glider5", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
