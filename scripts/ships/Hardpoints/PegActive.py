# C:\Program Files\Activision\Bridge Commander\scripts\ships\Hardpoints\PegActive.py
...
#################################################
PegActive = App.ShipProperty_Create("PegActive")

PegActive.SetGenus(1)
PegActive.SetSpecies(777)
PegActive.SetMass(80.000000)
PegActive.SetRotationalInertia(2000.000000)
PegActive.SetShipName("PegActive")
PegActive.SetModelFilename("data/Models/Ships/Stargates/PegActive.NIF")
PegActive.SetDamageResolution(0.000100)
PegActive.SetAffiliation(0)
PegActive.SetStationary(1)
PegActive.SetAIString("StarbaseAttack")
PegActive.SetDeathExplosionSound("g_lsDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(PegActive)
#################################################
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("PegActive", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
