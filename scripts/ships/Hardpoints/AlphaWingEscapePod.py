# C:\Program Files\Activision\AllStuff\Bridge Commander\scripts\ships\Hardpoints\AlphaWingEscapePod.py
...
EAStarfury.SetShipName("AlphaWingEscapePod")
EAStarfury.SetModelFilename("data/Models/Ships/EAStarfury/EAStarfuryEscapePod.nif")
