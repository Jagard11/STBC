...
BioOrganicHull.SetMaxCondition(300.000000)
...
BioOrganicHull.SetRepairComplexity(2.000000)
...
ShieldGenerator.SetMaxShields(ShieldGenerator.FRONT_SHIELDS, 200.000000)
...
WarpCore.SetMainBatteryLimit(1250000.000000)
WarpCore.SetBackupBatteryLimit(500000.000000)
WarpCore.SetMainConduitCapacity(40.000000)
WarpCore.SetBackupConduitCapacity(20.000000)
WarpCore.SetPowerOutput(40.000000)
...
ImpulseEngines.SetMaxAngularAccel(1.300000)
...
#################################################
VOR_Fighter = App.ShipProperty_Create("VOR_Fighter")
...
VOR_Fighter.SetShipName("VOR_FighterOpen")
VOR_Fighter.SetModelFilename("data/Models/Ships/VOR_Fighter/VOR_FighterOpen.nif")
VOR_Fighter.SetDamageResolution(8.000000)
VOR_Fighter.SetAffiliation(0)
VOR_Fighter.SetStationary(0)
VOR_Fighter.SetAIString("FedAttack")
VOR_Fighter.SetDeathExplosionSound("g_lsDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(VOR_Fighter)
#################################################
...
VorlonBeam.SetNormalPowerPerSecond(20.000000)
...
BiobeamEmitter.SetMaxCondition(800.000000)
BiobeamEmitter.SetCritical(0)
BiobeamEmitter.SetTargetable(0)
BiobeamEmitter.SetPrimary(1)
BiobeamEmitter.SetPosition(-0.010000, 1.880000, -0.100000)
BiobeamEmitter.SetPosition2D(65.000000, 5.000000)
BiobeamEmitter.SetRepairComplexity(3.000000)
...
BiobeamEmitter.SetIconAboveShip(0)
BiobeamEmitter.SetFireSound("VOR_LG")
BiobeamEmitter.SetMaxCharge(3.000000)
BiobeamEmitter.SetMaxDamage(1000.000000)
BiobeamEmitter.SetMaxDamageDistance(180.000000)
BiobeamEmitter.SetMinFiringCharge(2.000000)
BiobeamEmitter.SetNormalDischargeRate(3.000000)
BiobeamEmitter.SetRechargeRate(0.500000)
...
BiobeamEmitterForward.SetXYZ(0.052442, 0.998624, -0.000111)
BiobeamEmitterUp = App.TGPoint3()
BiobeamEmitterUp.SetXYZ(-0.003639, 0.000303, 0.999993)
...
BiobeamEmitter.SetArcWidthAngles(-0.610865, 0.610865)
BiobeamEmitter.SetArcHeightAngles(-0.785398, 0.139626)
BiobeamEmitter.SetPhaserTextureStart(0)
BiobeamEmitter.SetPhaserTextureEnd(7)
BiobeamEmitter.SetPhaserWidth(0.300000)
kColor = App.TGColorA()
kColor.SetRGBA(0.003922, 1.000000, 0.000000, 1.000000)
BiobeamEmitter.SetOuterShellColor(kColor)
kColor.SetRGBA(0.893922, 1.000000, 0.000000, 0.500000)
BiobeamEmitter.SetInnerShellColor(kColor)
kColor.SetRGBA(0.893922, 1.000000, 0.000000, 0.80000)
BiobeamEmitter.SetOuterCoreColor(kColor)
kColor.SetRGBA(0.893922, 1.000000, 0.000000, 0.900000)
BiobeamEmitter.SetInnerCoreColor(kColor)
BiobeamEmitter.SetNumSides(6)
BiobeamEmitter.SetMainRadius(0.040000)
BiobeamEmitter.SetTaperRadius(0.040000)
BiobeamEmitter.SetCoreScale(0.500000)
BiobeamEmitter.SetTaperRatio(0.500000)
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("VOR_Fighter", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
