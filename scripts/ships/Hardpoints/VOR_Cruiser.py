...
# C:\Program Files\Activision\Bridge Commander\scripts\ships\Hardpoints\VOR_Cruiser.py
...
BioOrganicHull.SetMaxCondition(10000.000000)
...
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.FRONT_SHIELDS, 2200.000000)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.REAR_SHIELDS, 2200.000000)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.TOP_SHIELDS, 2200.000000)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.BOTTOM_SHIELDS, 2200.000000)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.LEFT_SHIELDS, 2200.000000)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.RIGHT_SHIELDS, 2200.000000)
...
ImpulseEngines.SetRadius(0.001000)
...
Torpedoes.SetMaxTorpedoes(0, 39999)
...
GraviticEngine.SetMaxCondition(9500.000000)
GraviticEngine.SetCritical(0)
GraviticEngine.SetTargetable(1)
GraviticEngine.SetPrimary(1)
GraviticEngine.SetPosition(0.000000, -5.201430, 0.014255)
...
#################################################
VOR_Cruiser = App.ShipProperty_Create("VOR_Cruiser")
...
VorlonBeam.SetMaxCondition(9400.000000)
...
BiobeamEmitter.SetMaxCondition(9000.000000)
BiobeamEmitter.SetCritical(0)
BiobeamEmitter.SetTargetable(0)
BiobeamEmitter.SetPrimary(1)
BiobeamEmitter.SetPosition(0.000000, 20.440000, 0.000000)
...
BiobeamEmitter.SetMaxCharge(7.000000)
BiobeamEmitter.SetMaxDamage(3100.000000)
...
ForwardTractor.SetPosition(-0.500000, 3.000000, 0.100000)
...
VortexGen.SetPosition(0.000000, -0.600000, 0.000000)
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("VOR_Cruiser", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
