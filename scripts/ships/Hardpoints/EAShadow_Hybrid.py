...
Engine.SetMaxCondition(200.000000)
...
BioOrganicHull.SetMaxCondition(400.000000)
...
BioOrganicHull.SetRepairComplexity(9.000000)
...
HyperspaceTap.SetMainBatteryLimit(7000.000000)
HyperspaceTap.SetBackupBatteryLimit(80.000000)
HyperspaceTap.SetMainConduitCapacity(150.000000)
HyperspaceTap.SetBackupConduitCapacity(1200.000000)
...
Sensor.SetBaseSensorRange(900.000000)
...
ShadowShields.SetMaxCondition(150.000000)
...
ShadowShields.SetMaxShields(ShadowShields.FRONT_SHIELDS, 250.000000)
ShadowShields.SetMaxShields(ShadowShields.REAR_SHIELDS, 180.000000)
ShadowShields.SetMaxShields(ShadowShields.TOP_SHIELDS, 170.000000)
ShadowShields.SetMaxShields(ShadowShields.BOTTOM_SHIELDS, 170.000000)
ShadowShields.SetMaxShields(ShadowShields.LEFT_SHIELDS, 160.000000)
ShadowShields.SetMaxShields(ShadowShields.RIGHT_SHIELDS, 160.000000)
ShadowShields.SetShieldChargePerSecond(ShadowShields.FRONT_SHIELDS, 250.000000)
ShadowShields.SetShieldChargePerSecond(ShadowShields.REAR_SHIELDS, 250.000000)
ShadowShields.SetShieldChargePerSecond(ShadowShields.TOP_SHIELDS, 250.000000)
ShadowShields.SetShieldChargePerSecond(ShadowShields.BOTTOM_SHIELDS, 250.000000)
ShadowShields.SetShieldChargePerSecond(ShadowShields.LEFT_SHIELDS, 250.000000)
ShadowShields.SetShieldChargePerSecond(ShadowShields.RIGHT_SHIELDS, 250.000000)
App.g_kModelPropertyManager.RegisterLocalTemplate(ShadowShields)
#################################################
ShadowBattlecrab = App.ShipProperty_Create("EAShadow Hybrid")
...
ShadowBattlecrab.SetShipName("EAShadow_Hybrid")
ShadowBattlecrab.SetModelFilename("data/Models/Ships/EAShadow_Hybrid/EAShadow_Hybrid.nif")
...
Cockpit.SetMaxCondition(150.000000)
...
LaserEmiter.SetNormalPowerPerSecond(125.000000)
...
ShadowEngine.SetMaxCondition(200.000000)
...
HyperspaceEngine.SetMaxCondition(200.000000)
...
DeathRay.SetMaxCondition(190.000000)
...
DeathRay.SetMaxDamage(1900.000000)
...
ShadowSceam.SetMaxCondition(110.000000)
...
Scream.SetMaxCondition(110.000000)
...
PhaseCloak.SetMaxCondition(110.000000)
...
JumpspaceDrive.SetMaxCondition(210.000000)
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("EAShadow Hybrid", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
