# C:\Program Files (x86)\Activision\Bridge Commander  KM v1 plus\scripts\ships\Hardpoints\WaterPlanet.py
...
#################################################
WaterPlanet = App.ShipProperty_Create("WaterPlanet")

WaterPlanet.SetGenus(2)
WaterPlanet.SetSpecies(145)
WaterPlanet.SetMass(60.000000)
WaterPlanet.SetRotationalInertia(7000.000000)
WaterPlanet.SetShipName("WaterPlanet")
WaterPlanet.SetModelFilename("data/models/bases/WaterPlanet/WaterPlanet.nif")
WaterPlanet.SetDamageResolution(75.000000)
WaterPlanet.SetAffiliation(0)
WaterPlanet.SetStationary(0)
WaterPlanet.SetAIString("StarbaseAttack")
WaterPlanet.SetDeathExplosionSound("g_lsBigDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(WaterPlanet)
#################################################
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("WaterPlanet", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
