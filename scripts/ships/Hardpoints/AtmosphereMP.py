# C:\Program Files (x86)\Activision\Bridge Commander  KM v1 plus\scripts\ships\Hardpoints\AtmosphereMP.py
...
#################################################
AtmosphereMP = App.ShipProperty_Create("AtmosphereMP")

AtmosphereMP.SetGenus(2)
AtmosphereMP.SetSpecies(145)
AtmosphereMP.SetMass(60.000000)
AtmosphereMP.SetRotationalInertia(7000.000000)
AtmosphereMP.SetShipName("AtmosphereMP")
AtmosphereMP.SetModelFilename("data/Models/Bases/Malon/AtmosphereMP.nif")
AtmosphereMP.SetDamageResolution(75.000000)
AtmosphereMP.SetAffiliation(0)
AtmosphereMP.SetStationary(0)
AtmosphereMP.SetAIString("StarbaseAttack")
AtmosphereMP.SetDeathExplosionSound("g_lsBigDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(AtmosphereMP)
#################################################
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("AtmosphereMP", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
