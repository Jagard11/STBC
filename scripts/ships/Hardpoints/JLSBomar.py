# C:\Users\Admin\bcsdk1_1\Tools\ModelPropertyEditor\DQP\JLSBomar\JLSBomar.py
...
ShieldGenerator.SetPosition(0.000000, -0.035100, 0.020000)
...
ShieldGeneratorShieldGlowColor.SetRGBA(0.105882, 0.490196, 0.007843, 0.466667)
...
FrontPhaser1.SetPosition(-0.049000, 0.090000, 0.000000)
...
FrontPhaser1.SetIconPositionX(45.000000)
FrontPhaser1.SetIconPositionY(29.000000)
FrontPhaser1.SetIconAboveShip(1)
FrontPhaser1.SetFireSound("JLSBo Phaser")
...
FrontPhaser1.SetIndicatorIconPositionX(41.000000)
...
FrontPhaser1.SetArcWidthAngles(0.139626, -1.570796)
...
FrontPhaser2.SetPosition(0.049000, 0.090000, 0.000000)
...
FrontPhaser2.SetIconPositionX(83.000000)
FrontPhaser2.SetIconPositionY(29.000000)
FrontPhaser2.SetIconAboveShip(1)
FrontPhaser2.SetFireSound("JLSBo Phaser")
FrontPhaser2.SetMaxCharge(1.500000)
FrontPhaser2.SetMaxDamage(680.000000)
...
FrontPhaser2.SetIndicatorIconPositionX(78.000000)
FrontPhaser2.SetIndicatorIconPositionY(24.000000)
...
SensorArray.SetPosition(0.000000, 0.011000, 0.020000)
...
WarpCore.SetPosition(0.000000, -0.015000, 0.020000)
...
ImpulseEngines.SetPosition(0.000000, -0.020000, 0.020000)
...
Phasers.SetPosition(0.000000, 0.080000, 0.000000)
...
PortImpulse.SetPosition(-0.060000, -0.023000, 0.000000)
...
PortWarp.SetPosition(-0.060000, -0.023000, -0.015000)
...
StarWarp.SetPosition(0.060000, -0.023000, -0.015000)
...
Engineering.SetPosition(0.000000, 0.000000, 0.020000)
...
ForwardTorp1.SetPosition(0.102000, 0.013000, 0.000000)
...
ForwardTorp2.SetPosition(0.105000, 0.012000, 0.000000)
...
ForwardTorp2.SetIconPositionX(99.000000)
ForwardTorp2.SetIconPositionY(46.000000)
...
ForwardTorp3.SetMaxCondition(500.000000)
ForwardTorp3.SetCritical(0)
ForwardTorp3.SetTargetable(1)
ForwardTorp3.SetPrimary(1)
ForwardTorp3.SetPosition(0.108000, 0.006100, 0.000000)
ForwardTorp3.SetPosition2D(75.000000, 40.000000)
...
ForwardTorp3.SetIconPositionX(103.000000)
ForwardTorp3.SetIconPositionY(49.000000)
ForwardTorp3.SetIconAboveShip(1)
ForwardTorp3.SetImmediateDelay(0.150000)
ForwardTorp3.SetReloadDelay(19.000000)
...
#################################################
Bomar = App.ShipProperty_Create("Bomar")

Bomar.SetGenus(1)
Bomar.SetSpecies(114)
Bomar.SetMass(10.000000)
Bomar.SetRotationalInertia(2000.000000)
Bomar.SetShipName("Bomar")
Bomar.SetModelFilename("data/Models/Ships/DQP/JLSBomar/Bomar.nif")
Bomar.SetDamageResolution(1.000000)
Bomar.SetAffiliation(1)
Bomar.SetStationary(0)
Bomar.SetAIString("FedAttack")
Bomar.SetDeathExplosionSound("g_lsDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(Bomar)
#################################################
...
Cockpit.SetMaxCondition(2500.000000)
Cockpit.SetCritical(1)
Cockpit.SetTargetable(1)
Cockpit.SetPrimary(0)
Cockpit.SetPosition(0.000000, 0.090000, 0.010000)
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("Bomar", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
