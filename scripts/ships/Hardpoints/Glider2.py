# C:\Program Files\Activision\Bridge Commander\scripts\ships\Hardpoints\Glider2.py
...
#################################################
Glider2 = App.ShipProperty_Create("Glider2")

Glider2.SetGenus(1)
Glider2.SetSpecies(714)
Glider2.SetMass(25.000000)
Glider2.SetRotationalInertia(2000.000000)
Glider2.SetShipName("Glider2")
Glider2.SetModelFilename("data/Models/Ships/sgdg/DG_SG1.NIF")
Glider2.SetDamageResolution(0.000100)
Glider2.SetAffiliation(0)
Glider2.SetStationary(0)
Glider2.SetAIString("RomulanAttack")
Glider2.SetDeathExplosionSound("g_lsDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(Glider2)
#################################################
...
def LoadPropertySet(pObj):
	...
	prop = App.g_kModelPropertyManager.FindByName("Glider2", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
