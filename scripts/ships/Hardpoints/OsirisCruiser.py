# C:\Program Files\Activision\Bridge Commander\scripts\ships\Hardpoints\OsirisCruiser.py
...
Hull.SetMaxCondition(3750.000000)
Hull.SetCritical(1)
...
SublightEngine.SetMaxCondition(3000.000000)
...
SublightEngine.SetPosition2D(51.000000, 48.000000)
SublightEngine.SetRepairComplexity(1.000000)
SublightEngine.SetDisabledPercentage(0.500000)
SublightEngine.SetRadius(0.003000)
SublightEngine.SetNormalPowerPerSecond(20.000000)
SublightEngine.SetMaxAccel(2.750000)
SublightEngine.SetMaxAngularAccel(0.550000)
SublightEngine.SetMaxAngularVelocity(0.425000)
SublightEngine.SetMaxSpeed(4.750000)
SublightEngine.SetEngineSound("SGDGEngine")
App.g_kModelPropertyManager.RegisterLocalTemplate(SublightEngine)
#################################################
ReactorModule = App.PowerProperty_Create("Reactor Module")

ReactorModule.SetMaxCondition(2500.000000)
ReactorModule.SetCritical(1)
ReactorModule.SetTargetable(1)
ReactorModule.SetPrimary(1)
ReactorModule.SetPosition(0.000000, -0.050000, -0.030000)
ReactorModule.SetPosition2D(65, 59)
...
ShieldGenerator.SetPosition2D(65, 44)
...
#################################################
OsirisCruiser = App.ShipProperty_Create("OsirisCruiser")
...
OsirisCruiser.SetDamageResolution(0.000100)
OsirisCruiser.SetAffiliation(0)
OsirisCruiser.SetStationary(0)
OsirisCruiser.SetAIString("NonFedAttack")
OsirisCruiser.SetDeathExplosionSound("g_lsDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(OsirisCruiser)
#################################################
MainEngine = App.EngineProperty_Create("Main Engine")

MainEngine.SetMaxCondition(1000.000000)
MainEngine.SetCritical(0)
MainEngine.SetTargetable(1)
MainEngine.SetPrimary(1)
MainEngine.SetPosition(0.000000, -0.150000, -0.030000)
MainEngine.SetPosition2D(65, 82)
MainEngine.SetRepairComplexity(2.000000)
MainEngine.SetDisabledPercentage(0.500000)
MainEngine.SetRadius(0.025000)
...
ViewscreenForwardPosition.SetXYZ(0.000000, 0.200000, 0.030000)
...
Hyperdrive1.SetPosition(0.000000, -0.115000, 0.000000)
Hyperdrive1.SetPosition2D(65, 70)
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("OsirisCruiser", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
