# C:\Programme\Activision\Babylon 5 Bridge Commander\scripts\ships\Hardpoints\Shadow_FighterBall.py
...
BioOrganicHull.SetMaxCondition(100.000000)
...
ShadowBattlecrab.SetMass(360.000000)
ShadowBattlecrab.SetRotationalInertia(500.000000)
ShadowBattlecrab.SetShipName("Shadow Fighter Ball")
ShadowBattlecrab.SetModelFilename("data/Models/Ships/Shadow_Fighter/Shadow_FighterBall.nif")
...
ShadowEngine.SetMaxAccel(75.000000)
ShadowEngine.SetMaxAngularAccel(2.400000)
ShadowEngine.SetMaxAngularVelocity(0.400000)
ShadowEngine.SetMaxSpeed(75.000000)
