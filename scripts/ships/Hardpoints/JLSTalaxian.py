# C:\Users\Admin\bcsdk1_1\Tools\ModelPropertyEditor\JLSTalaxian\JLSTalaxian.py
...
ShieldGenerator.SetPosition(0.000000, -0.035100, 0.010000)
...
FrontPhaser1.SetPosition(0.180356, 0.153615, -0.014115)
...
FrontPhaser1.SetIconNum(330)
FrontPhaser1.SetIconPositionX(20.000000)
FrontPhaser1.SetIconPositionY(27.000000)
FrontPhaser1.SetIconAboveShip(1)
FrontPhaser1.SetFireSound("JLSTal Phaser")
FrontPhaser1.SetMaxCharge(1.500000)
FrontPhaser1.SetMaxDamage(1010.000000)
...
FrontPhaser1.SetIndicatorIconNum(505)
FrontPhaser1.SetIndicatorIconPositionX(24.000000)
FrontPhaser1.SetIndicatorIconPositionY(24.000000)
...
FrontPhaser2.SetPosition(-0.180822, 0.152899, -0.017084)
...
FrontPhaser2.SetMaxDamage(1010.000000)
...
SensorArray.SetPosition(0.000000, -0.035100, 0.010000)
...
WarpCore.SetMaxCondition(6900.000000)
WarpCore.SetCritical(1)
WarpCore.SetTargetable(1)
WarpCore.SetPrimary(1)
WarpCore.SetPosition(-0.000061, 0.122694, 0.009540)
...
ImpulseEngines.SetPosition(0.000000, -0.179238, -0.005000)
...
ImpulseDrive.SetPosition(0.000000, -0.179238, -0.005000)
...
ImpulseDrive.SetRadius(0.020000)
...
PortWarp.SetPosition(-0.221193, 0.006075, -0.020000)
...
StarWarp.SetPosition(0.221193, 0.006075, -0.020000)
...
Engineering.SetPosition(0.000000, -0.040000, 0.010000)
...
ForwardTorp1.SetPosition(0.058749, 0.239568, -0.012639)
...
ForwardTorp2.SetPosition(-0.058749, 0.239568, -0.012639)
...
#################################################
Talaxian = App.ShipProperty_Create("Talaxian")

Talaxian.SetGenus(1)
Talaxian.SetSpecies(114)
Talaxian.SetMass(10.000000)
Talaxian.SetRotationalInertia(3800.000000)
Talaxian.SetShipName("Talaxian")
Talaxian.SetModelFilename("data/Models/Ships/DQP/JLSTalaxian/Talaxian.nif")
Talaxian.SetDamageResolution(1.000000)
Talaxian.SetAffiliation(1)
Talaxian.SetStationary(0)
Talaxian.SetAIString("FedAttack")
Talaxian.SetDeathExplosionSound("g_lsDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(Talaxian)
#################################################
...
ViewscreenForwardPosition.SetXYZ(0.000000, 1.200000, 0.060000)
...
Cockpit.SetPosition(-0.001313, 0.249092, 0.005645)
...
LifeSupport.SetPosition(0.000000, -0.114294, 0.030784)
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("Talaxian", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
