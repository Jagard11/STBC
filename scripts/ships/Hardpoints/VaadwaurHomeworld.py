# C:\Program Files (x86)\Activision\Bridge Commander  KM v1 plus\scripts\ships\Hardpoints\KrenimHomeworld.py
...
#################################################
VaadwaurHomeworld = App.ShipProperty_Create("VaadwaurHomeworld")

VaadwaurHomeworld.SetGenus(2)
VaadwaurHomeworld.SetSpecies(145)
VaadwaurHomeworld.SetMass(60.000000)
VaadwaurHomeworld.SetRotationalInertia(7000.000000)
VaadwaurHomeworld.SetShipName("VaadwaurHomeworld")
VaadwaurHomeworld.SetModelFilename("data/models/bases/VaadwaurHomeworld/VaadwaurHomeworld.nif")
VaadwaurHomeworld.SetDamageResolution(75.000000)
VaadwaurHomeworld.SetAffiliation(0)
VaadwaurHomeworld.SetStationary(0)
VaadwaurHomeworld.SetAIString("StarbaseAttack")
VaadwaurHomeworld.SetDeathExplosionSound("g_lsBigDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(VaadwaurHomeworld)
#################################################
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("VaadwaurHomeworld", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
