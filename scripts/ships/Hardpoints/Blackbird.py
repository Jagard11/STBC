# C:\Program Files\Activision\Bridge Commander\scripts\ships\Hardpoints\Blackbird.py
...
IonDrive.SetMaxCondition(150.000000)
...
IonDrive.SetMaxAccel(3.200000)
IonDrive.SetMaxAngularAccel(2.950000)
IonDrive.SetMaxAngularVelocity(2.950000)
IonDrive.SetMaxSpeed(6.000000)
...
TyliumReactor.SetMaxCondition(100.000000)
...
Cannons.SetMaxCondition(100.000000)
...
PortCannon.SetMaxCondition(150.000000)
PortCannon.SetCritical(0)
PortCannon.SetTargetable(1)
PortCannon.SetPrimary(1)
PortCannon.SetPosition(-0.015000, 0.100000, -0.001000)
...
StarCannon.SetMaxCondition(150.000000)
StarCannon.SetCritical(0)
StarCannon.SetTargetable(1)
StarCannon.SetPrimary(1)
StarCannon.SetPosition(0.015000, 0.100000, -0.001000)
...
Engine1.SetMaxCondition(100.000000)
Engine1.SetCritical(0)
Engine1.SetTargetable(1)
Engine1.SetPrimary(1)
Engine1.SetPosition(0.045000, -0.060000, 0.003500)
...
ViperMk2.SetShipName("Blackbird")
ViperMk2.SetModelFilename("data/Models/Ships/Blackbird/Blackbird.nif")
...
Engine2.SetMaxCondition(100.000000)
Engine2.SetCritical(0)
Engine2.SetTargetable(1)
Engine2.SetPrimary(1)
Engine2.SetPosition(-0.045000, -0.060000, 0.003500)
...
Engine3.SetMaxCondition(100.000000)
Engine3.SetCritical(0)
Engine3.SetTargetable(1)
Engine3.SetPrimary(1)
Engine3.SetPosition(0.056500, -0.060000, -0.005000)
...
PortLauncher.SetPosition(-0.016500, -0.020000, -0.007500)
...
StarLauncher.SetPosition(0.016500, -0.020000, -0.007500)
...
FTLDrive.SetNormalPowerPerSecond(5.000000)
App.g_kModelPropertyManager.RegisterLocalTemplate(FTLDrive)
#################################################
FTLDrives = App.EngineProperty_Create("FTL Drives")

FTLDrives.SetMaxCondition(200.000000)
FTLDrives.SetCritical(0)
FTLDrives.SetTargetable(1)
FTLDrives.SetPrimary(1)
FTLDrives.SetPosition(0.000000, -0.030000, 0.005000)
FTLDrives.SetPosition2D(0.000000, 0.000000)
FTLDrives.SetRepairComplexity(1.000000)
FTLDrives.SetDisabledPercentage(0.500000)
FTLDrives.SetRadius(0.002500)
FTLDrives.SetEngineType(FTLDrives.EP_WARP)
