# C:\Program Files (x86)\Activision\Bridge Commander  KM v1 plus\scripts\ships\Hardpoints\AtmosphereC.py
...
#################################################
AtmosphereC = App.ShipProperty_Create("AtmosphereC")

AtmosphereC.SetGenus(2)
AtmosphereC.SetSpecies(145)
AtmosphereC.SetMass(60.000000)
AtmosphereC.SetRotationalInertia(7000.000000)
AtmosphereC.SetShipName("AtmosphereC")
AtmosphereC.SetModelFilename("data/Models/Bases/WaterPlanet/AtmosphereC.nif")
AtmosphereC.SetDamageResolution(75.000000)
AtmosphereC.SetAffiliation(0)
AtmosphereC.SetStationary(0)
AtmosphereC.SetAIString("StarbaseAttack")
AtmosphereC.SetDeathExplosionSound("g_lsBigDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(AtmosphereC)
#################################################
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("AtmosphereC", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
