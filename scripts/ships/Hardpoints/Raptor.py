# C:\Program Files\Activision\Bridge Commander\scripts\ships\Hardpoints\Raptor.py
...
Raptor.SetGenus(1)
Raptor.SetSpecies(108)
Raptor.SetMass(80.000000)
Raptor.SetRotationalInertia(10000.000000)
Raptor.SetShipName("Raptor")
Raptor.SetModelFilename("data/Models/Ships/Raptor/Raptor.nif")
Raptor.SetDamageResolution(0.000100)
