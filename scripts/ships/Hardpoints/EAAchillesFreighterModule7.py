# C:\Program Files\Activision\AllStuff\Bridge Commander\scripts\ships\Hardpoints\EAAchillesFreighterModule7.py
...
#################################################
EAAchillesFreighterModule7 = App.ShipProperty_Create("EAAchillesFreighterModule7")

EAAchillesFreighterModule7.SetGenus(1)
EAAchillesFreighterModule7.SetSpecies(106)
EAAchillesFreighterModule7.SetMass(20.000000)
EAAchillesFreighterModule7.SetRotationalInertia(1000.000000)
EAAchillesFreighterModule7.SetShipName("EAAchillesFreighterModule7")
EAAchillesFreighterModule7.SetModelFilename("data/Models/Ships/EAAchillesFreighter/EAAchillesFreighterLeftModule.nif")
EAAchillesFreighterModule7.SetDamageResolution(5.000000)
EAAchillesFreighterModule7.SetAffiliation(0)
EAAchillesFreighterModule7.SetStationary(0)
EAAchillesFreighterModule7.SetAIString("NonFedAttack")
EAAchillesFreighterModule7.SetDeathExplosionSound("g_lsDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(EAAchillesFreighterModule7)
#################################################
...
#################################################
CargoModule1 = App.HullProperty_Create("Cargo Module 7")
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("EAAchillesFreighterModule7", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)