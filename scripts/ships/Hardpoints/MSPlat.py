# C:\Program Files\Activision\Bridge Commander\scripts\ships\Hardpoints\MSPlat.py
...
PowerCore.SetMaxCondition(2500.000000)
...
SensorArray.SetPosition(-0.125000, 0.500000, -0.525000)
...
PortSublight.SetMaxCondition(4000.000000)
PortSublight.SetCritical(0)
PortSublight.SetTargetable(1)
PortSublight.SetPrimary(1)
PortSublight.SetPosition(-0.335000, -0.500000, -0.055000)
...
StarSublight.SetMaxCondition(4000.000000)
StarSublight.SetCritical(0)
StarSublight.SetTargetable(1)
StarSublight.SetPrimary(1)
StarSublight.SetPosition(0.075000, -0.500000, -0.055000)
...
MobileShipyard.SetMass(80.000000)
MobileShipyard.SetRotationalInertia(10000.000000)
MobileShipyard.SetShipName("Mobile Shipyard")
