# F:\Program Files\Activision\Bridge Commander Enemys Of Life\scripts\ships\Hardpoints\Pod3.py
...
#################################################
Pod3 = App.ShipProperty_Create("Pod 3")

Pod3.SetGenus(1)
Pod3.SetSpecies(747)
Pod3.SetMass(1000.010000)
Pod3.SetRotationalInertia(2000.000000)
Pod3.SetShipName("Pod3")
Pod3.SetModelFilename("data/Models/Ships/Alkesh/Pod.nif")
Pod3.SetDamageResolution(0.000100)
Pod3.SetAffiliation(0)
Pod3.SetStationary(0)
Pod3.SetAIString("FedAttack")
Pod3.SetDeathExplosionSound("g_lsDeathExplosions")
