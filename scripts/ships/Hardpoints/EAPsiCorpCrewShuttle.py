# C:\Program Files\Activision\AllStuff\Bridge Commander\scripts\ships\Hardpoints\EACrewShuttle.py
...
Hull.SetMaxCondition(90.000000)
Hull.SetCritical(1)
...
Cockpit.SetPosition(0.000000, 0.930744, 0.240000)
...
Sensor.SetMaxCondition(80.000000)
...
#################################################
EACrewShuttle = App.ShipProperty_Create("EACrewShuttle")
...
EACrewShuttle.SetDamageResolution(15.000000)
EACrewShuttle.SetAffiliation(0)
EACrewShuttle.SetStationary(0)
EACrewShuttle.SetAIString("NonFedAttack")
EACrewShuttle.SetDeathExplosionSound("g_lsDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(EACrewShuttle)
#################################################
...
Engine1.SetPosition(-0.182342, -0.772331, 0.000000)
...
Engine2.SetPosition(0.182342, -0.772331, 0.000000)
...
ShuttleBay1OEPRight.SetXYZ(0.000000, 0.000000, -0.150000)
...
ShuttleBay1OEPPosition.SetXYZ(0.000000, 0.000000, -0.150000)
...
ShuttleBay1.SetMaxCondition(30.000000)
ShuttleBay1.SetCritical(0)
ShuttleBay1.SetTargetable(1)
ShuttleBay1.SetPrimary(0)
ShuttleBay1.SetPosition(0.000000, 0.000000, -0.150000)
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("EACrewShuttle", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
