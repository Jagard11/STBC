# C:\Program Files\Activision\Bridge Commander\scripts\ships\Hardpoints\ColMvr1.py
...
SensorArray.SetMaxCondition(2750.000000)
...
Freghter.SetShipName("ColMvr1")
Freghter.SetModelFilename("data/Models/Ships/ColMvr1/ColMvr1.nif")
