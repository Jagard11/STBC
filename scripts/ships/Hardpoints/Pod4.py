# F:\Program Files\Activision\Bridge Commander Enemys Of Life\scripts\ships\Hardpoints\Pod4.py
...
#################################################
Pod4 = App.ShipProperty_Create("Pod 4")

Pod4.SetGenus(1)
Pod4.SetSpecies(747)
Pod4.SetMass(1000.010000)
Pod4.SetRotationalInertia(2000.000000)
Pod4.SetShipName("Pod4")
Pod4.SetModelFilename("data/Models/Ships/Alkesh/Pod.nif")
Pod4.SetDamageResolution(0.000100)
Pod4.SetAffiliation(0)
Pod4.SetStationary(0)
Pod4.SetAIString("FedAttack")
Pod4.SetDeathExplosionSound("g_lsDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(Pod4)
#################################################
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("Pod 4", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
