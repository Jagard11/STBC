# C:\Program Files (x86)\Activision\Bridge Commander  KM v1 plus\scripts\ships\Hardpoints\Tarok.py
...
#################################################
Tarok = App.ShipProperty_Create("Tarok")

Tarok.SetGenus(2)
Tarok.SetSpecies(145)
Tarok.SetMass(60.000000)
Tarok.SetRotationalInertia(7000.000000)
Tarok.SetShipName("Tarok")
Tarok.SetModelFilename("data/models/bases/Tarok/Tarok.nif")
Tarok.SetDamageResolution(75.000000)
Tarok.SetAffiliation(0)
Tarok.SetStationary(0)
Tarok.SetAIString("StarbaseAttack")
Tarok.SetDeathExplosionSound("g_lsBigDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(Tarok)
#################################################
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("Tarok", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
