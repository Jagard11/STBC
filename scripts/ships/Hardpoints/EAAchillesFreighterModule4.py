# C:\Program Files\Activision\AllStuff\Bridge Commander\scripts\ships\Hardpoints\EAAchillesFreighterModule4.py
...
#################################################
EAAchillesFreighterModule4 = App.ShipProperty_Create("EAAchillesFreighterModule4")

EAAchillesFreighterModule4.SetGenus(1)
EAAchillesFreighterModule4.SetSpecies(106)
EAAchillesFreighterModule4.SetMass(20.000000)
EAAchillesFreighterModule4.SetRotationalInertia(1000.000000)
EAAchillesFreighterModule4.SetShipName("EAAchillesFreighterModule4")
EAAchillesFreighterModule4.SetModelFilename("data/Models/Ships/EAAchillesFreighter/EAAchillesFreighterRightModule.nif")
EAAchillesFreighterModule4.SetDamageResolution(5.000000)
EAAchillesFreighterModule4.SetAffiliation(0)
EAAchillesFreighterModule4.SetStationary(0)
EAAchillesFreighterModule4.SetAIString("NonFedAttack")
EAAchillesFreighterModule4.SetDeathExplosionSound("g_lsDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(EAAchillesFreighterModule4)
#################################################
...
#################################################
CargoModule1 = App.HullProperty_Create("Cargo Module 4")
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("EAAchillesFreighterModule4", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)