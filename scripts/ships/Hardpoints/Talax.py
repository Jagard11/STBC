# C:\Program Files (x86)\Activision\Bridge Commander  KM v1 plus\scripts\ships\Hardpoints\Talax.py
...
#################################################
Talax = App.ShipProperty_Create("Talax")

Talax.SetGenus(2)
Talax.SetSpecies(145)
Talax.SetMass(60.000000)
Talax.SetRotationalInertia(7000.000000)
Talax.SetShipName("Talax")
Talax.SetModelFilename("data/models/bases/Talax/Talax.nif")
Talax.SetDamageResolution(75.000000)
Talax.SetAffiliation(0)
Talax.SetStationary(0)
Talax.SetAIString("StarbaseAttack")
Talax.SetDeathExplosionSound("g_lsBigDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(Talax)
#################################################
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("Talax", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
