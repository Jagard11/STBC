# C:\Program Files\Activision\Bridge Commander\scripts\ships\Hardpoints\TelTakRefit.py
...
#################################################
TelTakRefit = App.ShipProperty_Create("TelTak Refit")

TelTakRefit.SetGenus(1)
TelTakRefit.SetSpecies(793)
TelTakRefit.SetMass(10000.000000)
TelTakRefit.SetRotationalInertia(2000.000000)
TelTakRefit.SetShipName("TelTakRefit")
TelTakRefit.SetModelFilename("data/Models/Ships/TelTak/TelTak.nif")
TelTakRefit.SetDamageResolution(0.000100)
TelTakRefit.SetAffiliation(0)
TelTakRefit.SetStationary(0)
TelTakRefit.SetAIString("NonFedAttack")
TelTakRefit.SetDeathExplosionSound("g_lsDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(TelTakRefit)
#################################################
...
def LoadPropertySet(pObj):
	...
	prop = App.g_kModelPropertyManager.FindByName("TelTak Refit", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
