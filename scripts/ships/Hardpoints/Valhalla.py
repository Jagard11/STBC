# C:\Program Files\Activision\Bridge Commander\scripts\ships\Hardpoints\Valhalla.py
...
#################################################
Valhalla = App.ShipProperty_Create("Valhalla")
...
Valhalla.SetDamageResolution(0.000100)
Valhalla.SetAffiliation(0)
Valhalla.SetStationary(0)
Valhalla.SetAIString("FedAttack")
Valhalla.SetDeathExplosionSound("g_lsDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(Valhalla)
#################################################
...
Cannon1.SetPosition(0.000000, 3.500000, 0.050000)
Cannon1.SetPosition2D(65, 3)
...
IonCannons.SetTorpedoScript(0, "Tactical.Projectiles.IonCannon2")
...
Cannon2.SetPosition(-2.950000, -0.100000, 0.160000)
Cannon2.SetPosition2D(38, 45)
...
#################################################
Cannon1 = App.BlinkingLightProperty_Create("Cannon1")
...
Cannon1Right = App.TGPoint3()
Cannon1Right.SetXYZ(1.000000, 0.000000, 0.000000)
Cannon1.SetOrientation(Cannon1Forward, Cannon1Up, Cannon1Right)
Cannon1Position = App.TGPoint3()
Cannon1Position.SetXYZ(-2.910000, -0.090000, 0.160000)
Cannon1.SetPosition(Cannon1Position)
Cannon1LightColor = App.TGColorA()
Cannon1LightColor.SetRGBA(1.000000, 1.000000, 1.000000, 1.000000)
Cannon1.SetColor(Cannon1LightColor)
Cannon1.SetRadius(1.150000)
Cannon1.SetPeriod(3.000000)
Cannon1.SetDuration(0.000000)
Cannon1.SetTextureName("scripts/Custom/NanoFXv2/SpecialFX/Gfx/Blinker/Blank.tga")
App.g_kModelPropertyManager.RegisterLocalTemplate(Cannon1)
#################################################
Cannon2 = App.BlinkingLightProperty_Create("Cannon2")
...
Cannon2Right = App.TGPoint3()
Cannon2Right.SetXYZ(1.000000, 0.000000, 0.000000)
Cannon2.SetOrientation(Cannon2Forward, Cannon2Up, Cannon2Right)
Cannon2Position = App.TGPoint3()
Cannon2Position.SetXYZ(2.910000, -0.090000, 0.160000)
Cannon2.SetPosition(Cannon2Position)
Cannon2LightColor = App.TGColorA()
Cannon2LightColor.SetRGBA(1.000000, 1.000000, 1.000000, 1.000000)
Cannon2.SetColor(Cannon2LightColor)
Cannon2.SetRadius(1.150000)
Cannon2.SetPeriod(3.000000)
Cannon2.SetDuration(0.000000)
Cannon2.SetTextureName("scripts/Custom/NanoFXv2/SpecialFX/Gfx/Blinker/Blank.tga")
App.g_kModelPropertyManager.RegisterLocalTemplate(Cannon2)
#################################################
...
def LoadPropertySet(pObj):
	...
	prop = App.g_kModelPropertyManager.FindByName("Valhalla", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
