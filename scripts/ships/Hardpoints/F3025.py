# C:\Program Files\Activision\Bridge Commander\scripts\ships\Hardpoints\F3025.py
...
#################################################
F3025 = App.ShipProperty_Create("F3025")

F3025.SetGenus(1)
F3025.SetSpecies(714)
F3025.SetMass(30.000000)
F3025.SetRotationalInertia(2000.000000)
F3025.SetShipName("F3025")
F3025.SetModelFilename("data/Models/Ships/F302/F3025.NIF")
F3025.SetDamageResolution(0.000100)
F3025.SetAffiliation(0)
F3025.SetStationary(0)
F3025.SetAIString("RomulanAttack")
F3025.SetDeathExplosionSound("g_lsDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(F3025)
#################################################
...
def LoadPropertySet(pObj):
	...
	prop = App.g_kModelPropertyManager.FindByName("F3025", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
