# C:\Program Files\Activision\Bridge Commander\scripts\ships\Hardpoints\ColAgro.py
...
PowerCore.SetMaxCondition(3200.000000)
PowerCore.SetCritical(1)
PowerCore.SetTargetable(1)
PowerCore.SetPrimary(1)
PowerCore.SetPosition(0.000000, -4.000000, 0.000000)
...
SensorArray.SetPosition(0.000000, 10.000000, 0.000000)
...
PortSublight.SetMaxCondition(2000.000000)
PortSublight.SetCritical(0)
PortSublight.SetTargetable(1)
PortSublight.SetPrimary(1)
PortSublight.SetPosition(-1.010000, -11.000000, 0.000000)
...
StarSublight.SetMaxCondition(2000.000000)
StarSublight.SetCritical(0)
StarSublight.SetTargetable(1)
StarSublight.SetPrimary(1)
StarSublight.SetPosition(1.010000, -11.000000, 0.000000)
...
FTLCoil.SetPosition(0.000000, -10.000000, 0.000000)
...
#################################################
AgroVessel = App.ShipProperty_Create("Agro Vessel")

AgroVessel.SetGenus(1)
AgroVessel.SetSpecies(108)
AgroVessel.SetMass(80.000000)
AgroVessel.SetRotationalInertia(10000.000000)
AgroVessel.SetShipName("ColAgro")
AgroVessel.SetModelFilename("data/Models/Ships/ColAgro/Agro.nif")
AgroVessel.SetDamageResolution(10.000000)
AgroVessel.SetAffiliation(0)
AgroVessel.SetStationary(0)
AgroVessel.SetAIString("NonFedAttack")
AgroVessel.SetDeathExplosionSound("g_lsDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(AgroVessel)
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("Agro Vessel", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
