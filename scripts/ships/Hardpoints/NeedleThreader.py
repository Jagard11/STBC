# C:\Program Files\Activision\Bridge Commander\scripts\ships\Hardpoints\NeedleThreader.py
...
SublightEngines.SetMaxAngularAccel(3.500000)
SublightEngines.SetMaxAngularVelocity(0.900000)
SublightEngines.SetMaxSpeed(7.750000)
...
PowerUnit.SetMaxCondition(1800.000000)
PowerUnit.SetCritical(1)
PowerUnit.SetTargetable(1)
PowerUnit.SetPrimary(1)
PowerUnit.SetPosition(0.000000, -0.010000, -0.010000)
...
SensorArray.SetPosition2D(63.000000, 38.000000)
...
#################################################
NeedleThreader = App.ShipProperty_Create("Needle Threader")

NeedleThreader.SetGenus(1)
NeedleThreader.SetSpecies(792)
NeedleThreader.SetMass(35.000000)
NeedleThreader.SetRotationalInertia(2000.000000)
NeedleThreader.SetShipName("NeedleThreader")
NeedleThreader.SetModelFilename("data/Models/Ships/DeathGlider/NeedleThreader.NIF")
NeedleThreader.SetDamageResolution(0.000100)
NeedleThreader.SetAffiliation(0)
NeedleThreader.SetStationary(0)
NeedleThreader.SetAIString("RomulanAttack")
NeedleThreader.SetDeathExplosionSound("g_lsDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(NeedleThreader)
#################################################
MainEngine = App.EngineProperty_Create("Main Engine")

MainEngine.SetMaxCondition(1400.000000)
MainEngine.SetCritical(0)
MainEngine.SetTargetable(1)
MainEngine.SetPrimary(1)
MainEngine.SetPosition(0.000000, -0.030000, 0.000000)
MainEngine.SetPosition2D(63.000000, 65.000000)
...
ViewscreenForwardPosition.SetXYZ(0.000000, 0.048000, 0.015000)
...
ViewscreenLeftPosition.SetXYZ(-0.012000, 0.040000, 0.015000)
...
ViewscreenRightPosition.SetXYZ(0.012000, 0.040000, 0.015000)
...
ViewscreenBackPosition.SetXYZ(0.000000, -0.035000, 0.000000)
...
ViewscreenUpPosition.SetXYZ(0.000000, 0.040000, 0.022000)
...
ViewscreenDownPosition.SetXYZ(0.000000, 0.000000, -0.032000)
...
FirstPersonCameraPosition.SetXYZ(0.000000, 0.048000, 0.015000)
...
Staff1.SetPrimary(1)
Staff1.SetPosition(-0.048750, 0.033000, -0.013000)
Staff1.SetPosition2D(35.000000, 35.000000)
...
Staff1.SetIconPositionX(54.000000)
Staff1.SetIconPositionY(57.000000)
...
Staff1.SetIndicatorIconPositionX(15.000000)
Staff1.SetIndicatorIconPositionY(15.000000)
...
Staff1.SetArcWidthAngles(-0.209066, 0.209066)
Staff1.SetArcHeightAngles(-0.209066, 0.209066)
...
Staff2.SetPrimary(1)
Staff2.SetPosition(0.048750, 0.033000, -0.013000)
Staff2.SetPosition2D(90.000000, 35.000000)
...
Staff2.SetIconPositionX(94.000000)
Staff2.SetIconPositionY(57.000000)
...
Staff2.SetIndicatorIconPositionX(15.000000)
Staff2.SetIndicatorIconPositionY(15.000000)
...
Staff2.SetArcWidthAngles(-0.209066, 0.209066)
Staff2.SetArcHeightAngles(-0.209066, 0.209066)
...
Cockpit.SetMaxCondition(600.000000)
Cockpit.SetCritical(1)
Cockpit.SetTargetable(1)
Cockpit.SetPrimary(1)
Cockpit.SetPosition(0.000000, 0.035000, 0.011500)
Cockpit.SetPosition2D(63.000000, 25.000000)
...
def LoadPropertySet(pObj):
	...
	prop = App.g_kModelPropertyManager.FindByName("Needle Threader", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
