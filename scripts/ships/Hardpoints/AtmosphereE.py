# C:\Program Files (x86)\Activision\Bridge Commander  KM v1 plus\scripts\ships\Hardpoints\AtmoshphereE.py
...
#################################################
AtmoshphereE = App.ShipProperty_Create("AtmoshphereE")

AtmoshphereE.SetGenus(2)
AtmoshphereE.SetSpecies(145)
AtmoshphereE.SetMass(60.000000)
AtmoshphereE.SetRotationalInertia(7000.000000)
AtmoshphereE.SetShipName("AtmoshphereE")
AtmoshphereE.SetModelFilename("data/Models/Bases/DemonPlanet/AtmoshphereE.nif")
AtmoshphereE.SetDamageResolution(75.000000)
AtmoshphereE.SetAffiliation(0)
AtmoshphereE.SetStationary(0)
AtmoshphereE.SetAIString("StarbaseAttack")
AtmoshphereE.SetDeathExplosionSound("g_lsBigDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(AtmoshphereE)
#################################################
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("AtmoshphereE", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
