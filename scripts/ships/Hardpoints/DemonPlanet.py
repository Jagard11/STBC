# C:\Program Files (x86)\Activision\Bridge Commander  KM v1 plus\scripts\ships\Hardpoints\DemonPlanet.py
...
#################################################
DemonPlanet = App.ShipProperty_Create("DemonPlanet")

DemonPlanet.SetGenus(2)
DemonPlanet.SetSpecies(145)
DemonPlanet.SetMass(60.000000)
DemonPlanet.SetRotationalInertia(7000.000000)
DemonPlanet.SetShipName("DemonPlanet")
DemonPlanet.SetModelFilename("data/models/bases/DemonPlanet/DemonPlanet.nif")
DemonPlanet.SetDamageResolution(75.000000)
DemonPlanet.SetAffiliation(0)
DemonPlanet.SetStationary(0)
DemonPlanet.SetAIString("StarbaseAttack")
DemonPlanet.SetDeathExplosionSound("g_lsBigDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(DemonPlanet)
#################################################
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("DemonPlanet", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
