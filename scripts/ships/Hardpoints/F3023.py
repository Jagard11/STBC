# C:\Program Files\Activision\Bridge Commander\scripts\ships\Hardpoints\F3023.py
...
#################################################
F3023 = App.ShipProperty_Create("F3023")

F3023.SetGenus(1)
F3023.SetSpecies(714)
F3023.SetMass(30.000000)
F3023.SetRotationalInertia(2000.000000)
F3023.SetShipName("F3023")
F3023.SetModelFilename("data/Models/Ships/F302/F3023.NIF")
F3023.SetDamageResolution(0.000100)
F3023.SetAffiliation(0)
F3023.SetStationary(0)
F3023.SetAIString("RomulanAttack")
F3023.SetDeathExplosionSound("g_lsDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(F3023)
#################################################
...
def LoadPropertySet(pObj):
	...
	prop = App.g_kModelPropertyManager.FindByName("F3023", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
