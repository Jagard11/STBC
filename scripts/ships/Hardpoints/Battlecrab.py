...
BioOrganicHull.SetMaxCondition(2000.000000)
...
ShadowShields.SetMaxShields(ShadowShields.FRONT_SHIELDS, 500.000000)
ShadowShields.SetMaxShields(ShadowShields.REAR_SHIELDS, 500.000000)
ShadowShields.SetMaxShields(ShadowShields.TOP_SHIELDS, 500.000000)
ShadowShields.SetMaxShields(ShadowShields.BOTTOM_SHIELDS, 500.000000)
ShadowShields.SetMaxShields(ShadowShields.LEFT_SHIELDS, 500.000000)
ShadowShields.SetMaxShields(ShadowShields.RIGHT_SHIELDS, 500.000000)
ShadowShields.SetShieldChargePerSecond(ShadowShields.FRONT_SHIELDS, 500.000000)
ShadowShields.SetShieldChargePerSecond(ShadowShields.REAR_SHIELDS, 500.000000)
ShadowShields.SetShieldChargePerSecond(ShadowShields.TOP_SHIELDS, 500.000000)
ShadowShields.SetShieldChargePerSecond(ShadowShields.BOTTOM_SHIELDS, 500.000000)
ShadowShields.SetShieldChargePerSecond(ShadowShields.LEFT_SHIELDS, 500.000000)
ShadowShields.SetShieldChargePerSecond(ShadowShields.RIGHT_SHIELDS, 500.000000)
App.g_kModelPropertyManager.RegisterLocalTemplate(ShadowShields)
#################################################
ShadowBattlecrab = App.ShipProperty_Create("Shadow Battlecrab")
...
HyperspaceEngine.SetMaxCondition(2000.000000)
...
DeathRay.SetPosition(0.000000, 0.590000, -0.390000)
...
DeathRay.SetDamageRadiusFactor(1.199999)
...
DeathRay.SetMaxDamage(3000.000000)
...
DeathRay.SetArcWidthAngles(-2.999999, 2.999999)
DeathRay.SetArcHeightAngles(-2.999999, 2.999999)
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("Shadow Battlecrab", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
