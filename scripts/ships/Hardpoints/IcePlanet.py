# C:\Program Files (x86)\Activision\Bridge Commander  KM v1 plus\scripts\ships\Hardpoints\IcePlanet.py
...
#################################################
IcePlanet = App.ShipProperty_Create("IcePlanet")

IcePlanet.SetGenus(2)
IcePlanet.SetSpecies(145)
IcePlanet.SetMass(60.000000)
IcePlanet.SetRotationalInertia(7000.000000)
IcePlanet.SetShipName("IcePlanet")
IcePlanet.SetModelFilename("data/models/bases/IcePlanet/IcePlanet.nif")
IcePlanet.SetDamageResolution(75.000000)
IcePlanet.SetAffiliation(0)
IcePlanet.SetStationary(0)
IcePlanet.SetAIString("StarbaseAttack")
IcePlanet.SetDeathExplosionSound("g_lsBigDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(IcePlanet)
#################################################
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("IcePlanet", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
