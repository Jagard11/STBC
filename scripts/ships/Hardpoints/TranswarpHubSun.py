# C:\Program Files (x86)\Activision\Bridge Commander  KM v1 plus\scripts\ships\Hardpoints\TranswarpHubSun.py
...
#################################################
TranswarpHubSun = App.ShipProperty_Create("TranswarpHubSun")

TranswarpHubSun.SetGenus(2)
TranswarpHubSun.SetSpecies(145)
TranswarpHubSun.SetMass(60.000000)
TranswarpHubSun.SetRotationalInertia(7000.000000)
TranswarpHubSun.SetShipName("TranswarpHubSun")
TranswarpHubSun.SetModelFilename("data/models/bases/TranswarpHub/THub.nif")
TranswarpHubSun.SetDamageResolution(75.000000)
TranswarpHubSun.SetAffiliation(0)
TranswarpHubSun.SetStationary(0)
TranswarpHubSun.SetAIString("StarbaseAttack")
TranswarpHubSun.SetDeathExplosionSound("g_lsBigDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(TranswarpHubSun)
#################################################
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("TranswarpHubSun", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
