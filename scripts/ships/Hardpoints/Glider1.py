# C:\Program Files\Activision\Bridge Commander\scripts\ships\Hardpoints\Glider1.py
...
#################################################
Glider1 = App.ShipProperty_Create("Glider1")

Glider1.SetGenus(1)
Glider1.SetSpecies(714)
Glider1.SetMass(25.000000)
Glider1.SetRotationalInertia(2000.000000)
Glider1.SetShipName("Glider1")
Glider1.SetModelFilename("data/Models/Ships/sgdg/DG_SG1.NIF")
Glider1.SetDamageResolution(0.000100)
Glider1.SetAffiliation(0)
Glider1.SetStationary(0)
Glider1.SetAIString("RomulanAttack")
Glider1.SetDeathExplosionSound("g_lsDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(Glider1)
#################################################
...
def LoadPropertySet(pObj):
	...
	prop = App.g_kModelPropertyManager.FindByName("Glider1", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
