# C:\Program Files\Activision\Bridge Commander\scripts\ships\Hardpoints\MilkyWayActive.py
...
#################################################
MilkyWayActive = App.ShipProperty_Create("MilkyWayActive")

MilkyWayActive.SetGenus(1)
MilkyWayActive.SetSpecies(777)
MilkyWayActive.SetMass(80.000000)
MilkyWayActive.SetRotationalInertia(2000.000000)
MilkyWayActive.SetShipName("MilkyWayActive")
MilkyWayActive.SetModelFilename("data/Models/Ships/Stargates/MilkyWayActive.NIF")
MilkyWayActive.SetDamageResolution(0.000100)
MilkyWayActive.SetAffiliation(0)
MilkyWayActive.SetStationary(1)
MilkyWayActive.SetAIString("StarbaseAttack")
MilkyWayActive.SetDeathExplosionSound("g_lsDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(MilkyWayActive)
#################################################
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("MilkyWayActive", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
