...
#################################################
KrenimHomeworld = App.ShipProperty_Create("KrenimHomeworld")

KrenimHomeworld.SetGenus(2)
KrenimHomeworld.SetSpecies(145)
KrenimHomeworld.SetMass(60.000000)
KrenimHomeworld.SetRotationalInertia(7000.000000)
KrenimHomeworld.SetShipName("KrenimHomeworld")
KrenimHomeworld.SetModelFilename("data/models/bases/KrenimHomeworld/KrenimHomeworld.nif")
KrenimHomeworld.SetDamageResolution(75.000000)
KrenimHomeworld.SetAffiliation(0)
KrenimHomeworld.SetStationary(0)
KrenimHomeworld.SetAIString("StarbaseAttack")
KrenimHomeworld.SetDeathExplosionSound("g_lsBigDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(KrenimHomeworld)
#################################################
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("KrenimHomeworld", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
