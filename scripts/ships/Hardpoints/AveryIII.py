# C:\Program Files (x86)\Activision\Bridge Commander  KM v1 plus\scripts\ships\Hardpoints\AveryIII.py
...
#################################################
AveryIII = App.ShipProperty_Create("AveryIII")

AveryIII.SetGenus(2)
AveryIII.SetSpecies(145)
AveryIII.SetMass(600000.000000)
AveryIII.SetRotationalInertia(7000.000000)
AveryIII.SetShipName("AveryIII")
AveryIII.SetModelFilename("data/models/bases/AveryIII/AveryIII.nif")
AveryIII.SetDamageResolution(75.000000)
AveryIII.SetAffiliation(0)
AveryIII.SetStationary(0)
AveryIII.SetAIString("StarbaseAttack")
AveryIII.SetDeathExplosionSound("g_lsBigDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(AveryIII)
#################################################
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("AveryIII", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
