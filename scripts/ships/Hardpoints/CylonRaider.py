# C:\Program Files\Activision\Bridge Commander\scripts\ships\Hardpoints\CylonRaider.py
...
#################################################
CylonRaider = App.ShipProperty_Create("CylonRaider")

CylonRaider.SetGenus(1)
CylonRaider.SetSpecies(107)
CylonRaider.SetMass(11.000000)
CylonRaider.SetRotationalInertia(1.750000)
CylonRaider.SetShipName("CylonRaider")
CylonRaider.SetModelFilename("data/models/ships/CylonRaider/CylonRaider.nif")
CylonRaider.SetDamageResolution(0.000100)
CylonRaider.SetAffiliation(0)
CylonRaider.SetStationary(0)
CylonRaider.SetAIString("NonFedAttack")
CylonRaider.SetDeathExplosionSound("g_lsDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(CylonRaider)
#################################################
IonDrive = App.ImpulseEngineProperty_Create("Ion Drive")

IonDrive.SetMaxCondition(100.000000)
...
IonDrive.SetNormalPowerPerSecond(20.000000)
IonDrive.SetMaxAccel(3.000000)
IonDrive.SetMaxAngularAccel(1.900000)
IonDrive.SetMaxAngularVelocity(1.900000)
IonDrive.SetMaxSpeed(6.500000)
...
Cannons.SetMaxCondition(130.000000)
...
Engine2.SetMaxCondition(125.000000)
...
Engine1.SetMaxCondition(125.000000)
...
FTLDrive.SetMaxCondition(100.000000)
...
FTLDrive1.SetMaxCondition(100.000000)
...
def LoadPropertySet(pObj):
	...
	prop = App.g_kModelPropertyManager.FindByName("CylonRaider", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
