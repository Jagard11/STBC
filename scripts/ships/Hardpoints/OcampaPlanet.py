# C:\Program Files (x86)\Activision\Bridge Commander  KM v1 plus\scripts\ships\Hardpoints\Ocampa.py
...
#################################################
Ocampa = App.ShipProperty_Create("Ocampa")

Ocampa.SetGenus(2)
Ocampa.SetSpecies(145)
Ocampa.SetMass(600000.000000)
Ocampa.SetRotationalInertia(7000.000000)
Ocampa.SetShipName("Ocampa")
Ocampa.SetModelFilename("data/models/bases/Ocampa/Ocampa.nif")
Ocampa.SetDamageResolution(75.000000)
Ocampa.SetAffiliation(0)
Ocampa.SetStationary(0)
Ocampa.SetAIString("StarbaseAttack")
Ocampa.SetDeathExplosionSound("g_lsBigDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(Ocampa)
#################################################
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("Ocampa", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
