# C:\Program Files\Activision\AllStuff\Bridge Commander\scripts\ships\Hardpoints\DraziSkySerpent.py
...
PowerPlant.SetMaxCondition(40.000000)
...
Sensor.SetMaxCondition(32.000000)
...
SubLightSys.SetMaxCondition(30.000000)
...
JumpSys.SetMaxCondition(32.000000)
...
RepairSys.SetMaxCondition(34.000000)
...
#################################################
DraziSkySerpent = App.ShipProperty_Create("DraziSkySerpent")

DraziSkySerpent.SetGenus(1)
DraziSkySerpent.SetSpecies(106)
DraziSkySerpent.SetMass(12.000000)
DraziSkySerpent.SetRotationalInertia(600.000000)
DraziSkySerpent.SetShipName("DraziSkySerpent")
DraziSkySerpent.SetModelFilename("data/Models/Ships/DraziSkySerpent/DraziSkySerpent.nif")
DraziSkySerpent.SetDamageResolution(15.000000)
DraziSkySerpent.SetAffiliation(0)
DraziSkySerpent.SetStationary(0)
DraziSkySerpent.SetAIString("NonFedAttack")
DraziSkySerpent.SetDeathExplosionSound("g_lsDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(DraziSkySerpent)
#################################################
PulseCannonSys = App.WeaponSystemProperty_Create("Pulse Cannon Sys")

PulseCannonSys.SetMaxCondition(39.000000)
...
Engine1.SetMaxCondition(19.000000)
Engine1.SetCritical(0)
Engine1.SetTargetable(1)
Engine1.SetPrimary(0)
Engine1.SetPosition(0.580184, 0.415737, 2.000000)
...
Engine2.SetMaxCondition(19.000000)
Engine2.SetCritical(0)
Engine2.SetTargetable(1)
Engine2.SetPrimary(0)
Engine2.SetPosition(-0.580184, 0.415737, 2.000000)
...
Engine3.SetMaxCondition(19.000000)
...
MainEngine.SetMaxCondition(30.000000)
MainEngine.SetCritical(0)
MainEngine.SetTargetable(1)
MainEngine.SetPrimary(0)
MainEngine.SetPosition(0.000000, -0.252331, 0.000000)
...
PulseCannon1.SetMaxCondition(14.000000)
PulseCannon1.SetCritical(0)
PulseCannon1.SetTargetable(1)
PulseCannon1.SetPrimary(0)
PulseCannon1.SetPosition(0.067822, 0.415737, 0.000000)
...
PulseCannon2.SetModuleName("Tactical.Projectiles.DraziPulse")
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("DraziSkySerpent", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
