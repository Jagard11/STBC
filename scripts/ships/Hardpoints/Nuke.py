# C:\Program Files\Activision\Bridge Commander\scripts\ships\Hardpoints\Nuke.py
...
PowerPlant.SetMainBatteryLimit(1000000.000000)
PowerPlant.SetBackupBatteryLimit(300000.000000)
PowerPlant.SetMainConduitCapacity(15000.000000)
PowerPlant.SetBackupConduitCapacity(15000.000000)
PowerPlant.SetPowerOutput(500.000000)
...
#################################################
Nuke = App.ShipProperty_Create("Nuke")

Nuke.SetGenus(1)
Nuke.SetSpecies(766)
Nuke.SetMass(1.000000)
Nuke.SetRotationalInertia(500.000000)
Nuke.SetShipName("Nuke")
Nuke.SetModelFilename("data/Models/Misc/Nuke/Nuke.nif")
Nuke.SetDamageResolution(0.000100)
Nuke.SetAffiliation(0)
Nuke.SetStationary(1)
Nuke.SetAIString("MineAI")
Nuke.SetDeathExplosionSound("g_lsDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(Nuke)
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("Nuke", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
