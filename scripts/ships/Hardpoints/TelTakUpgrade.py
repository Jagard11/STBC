# C:\Program Files\Activision\Bridge Commander\scripts\ships\Hardpoints\TelTakUpgrade.py
...
#################################################
TelTakUpgrade = App.ShipProperty_Create("TelTak Upgrade")

TelTakUpgrade.SetGenus(1)
TelTakUpgrade.SetSpecies(793)
TelTakUpgrade.SetMass(10000.000000)
TelTakUpgrade.SetRotationalInertia(2000.000000)
TelTakUpgrade.SetShipName("TelTakUpgrade")
TelTakUpgrade.SetModelFilename("data/Models/Ships/TelTak/TelTak.nif")
TelTakUpgrade.SetDamageResolution(0.000100)
TelTakUpgrade.SetAffiliation(0)
TelTakUpgrade.SetStationary(0)
TelTakUpgrade.SetAIString("NonFedAttack")
TelTakUpgrade.SetDeathExplosionSound("g_lsDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(TelTakUpgrade)
#################################################
...
CloakingDevice.SetPosition2D(65, 40)
...
def LoadPropertySet(pObj):
	...
	prop = App.g_kModelPropertyManager.FindByName("TelTak Upgrade", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
