# C:\Program Files\Activision\Bridge Commander\scripts\ships\Hardpoints\Glider4.py
...
#################################################
Glider4 = App.ShipProperty_Create("Glider4")

Glider4.SetGenus(1)
Glider4.SetSpecies(714)
Glider4.SetMass(25.000000)
Glider4.SetRotationalInertia(2000.000000)
Glider4.SetShipName("Glider4")
Glider4.SetModelFilename("data/Models/Ships/sgdg/DG_SG1.NIF")
Glider4.SetDamageResolution(0.000100)
Glider4.SetAffiliation(0)
Glider4.SetStationary(0)
Glider4.SetAIString("RomulanAttack")
Glider4.SetDeathExplosionSound("g_lsDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(Glider4)
#################################################
...
def LoadPropertySet(pObj):
	...
	prop = App.g_kModelPropertyManager.FindByName("Glider4", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
