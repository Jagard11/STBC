# C:\Program Files (x86)\Activision\Bridge Commander  KM v1 plus\scripts\ships\Hardpoints\Sikaris.py
...
#################################################
Sikaris = App.ShipProperty_Create("Sikaris")

Sikaris.SetGenus(2)
Sikaris.SetSpecies(145)
Sikaris.SetMass(60.000000)
Sikaris.SetRotationalInertia(7000.000000)
Sikaris.SetShipName("Sikaris")
Sikaris.SetModelFilename("data/models/bases/Sikaris/Sikaris.nif")
Sikaris.SetDamageResolution(75.000000)
Sikaris.SetAffiliation(0)
Sikaris.SetStationary(0)
Sikaris.SetAIString("StarbaseAttack")
Sikaris.SetDeathExplosionSound("g_lsBigDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(Sikaris)
#################################################
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("Sikaris", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
