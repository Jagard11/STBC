# C:\Program Files (x86)\Activision\Bridge Commander  KM v1 plus\scripts\ships\Hardpoints\Deltoria.py
...
#################################################
Deltoria = App.ShipProperty_Create("Deltoria")

Deltoria.SetGenus(2)
Deltoria.SetSpecies(145)
Deltoria.SetMass(60.000000)
Deltoria.SetRotationalInertia(7000.000000)
Deltoria.SetShipName("Deltoria")
Deltoria.SetModelFilename("data/models/bases/Deltoria/Deltoria.nif")
Deltoria.SetDamageResolution(75.000000)
Deltoria.SetAffiliation(0)
Deltoria.SetStationary(0)
Deltoria.SetAIString("StarbaseAttack")
Deltoria.SetDeathExplosionSound("g_lsBigDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(Deltoria)
#################################################
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("Deltoria", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
