# C:\Program Files\Activision\AllStuff\Bridge Commander\scripts\ships\Hardpoints\EAAchillesFreighterModule8.py
...
#################################################
EAAchillesFreighterModule8 = App.ShipProperty_Create("EAAchillesFreighterModule8")

EAAchillesFreighterModule8.SetGenus(1)
EAAchillesFreighterModule8.SetSpecies(106)
EAAchillesFreighterModule8.SetMass(20.000000)
EAAchillesFreighterModule8.SetRotationalInertia(1000.000000)
EAAchillesFreighterModule8.SetShipName("EAAchillesFreighterModule8")
EAAchillesFreighterModule8.SetModelFilename("data/Models/Ships/EAAchillesFreighter/EAAchillesFreighterRightModule.nif")
EAAchillesFreighterModule8.SetDamageResolution(5.000000)
EAAchillesFreighterModule8.SetAffiliation(0)
EAAchillesFreighterModule8.SetStationary(0)
EAAchillesFreighterModule8.SetAIString("NonFedAttack")
EAAchillesFreighterModule8.SetDeathExplosionSound("g_lsDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(EAAchillesFreighterModule8)
#################################################
...
#################################################
CargoModule1 = App.HullProperty_Create("Cargo Module 8")
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("EAAchillesFreighterModule8", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)