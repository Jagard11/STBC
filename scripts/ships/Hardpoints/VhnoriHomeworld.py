# C:\Program Files (x86)\Activision\Bridge Commander  KM v1 plus\scripts\ships\Hardpoints\Rings.py
...
#################################################
Rings = App.ShipProperty_Create("Rings")

Rings.SetGenus(2)
Rings.SetSpecies(145)
Rings.SetMass(60.000000)
Rings.SetRotationalInertia(7000.000000)
Rings.SetShipName("Rings")
Rings.SetModelFilename("data/models/bases/Rings/Rings.nif")
Rings.SetDamageResolution(75.000000)
Rings.SetAffiliation(0)
Rings.SetStationary(0)
Rings.SetAIString("StarbaseAttack")
Rings.SetDeathExplosionSound("g_lsBigDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(Rings)
#################################################
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("Rings", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
