# C:\Program Files\Activision\Bridge Commander\scripts\ships\Hardpoints\MilkyWayInactive.py
...
#################################################
MilkyWayInactive = App.ShipProperty_Create("MilkyWayInactive")

MilkyWayInactive.SetGenus(1)
MilkyWayInactive.SetSpecies(776)
MilkyWayInactive.SetMass(80.000000)
MilkyWayInactive.SetRotationalInertia(2000.000000)
MilkyWayInactive.SetShipName("MilkyWayInactive")
MilkyWayInactive.SetModelFilename("data/Models/Ships/Stargates/MilkyWayInactive.NIF")
MilkyWayInactive.SetDamageResolution(0.000100)
MilkyWayInactive.SetAffiliation(0)
MilkyWayInactive.SetStationary(1)
MilkyWayInactive.SetAIString("StarbaseAttack")
MilkyWayInactive.SetDeathExplosionSound("g_lsDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(MilkyWayInactive)
#################################################
