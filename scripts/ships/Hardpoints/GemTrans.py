...
SublightEngine1.SetMaxCondition(2500.000000)
...
Freghter.SetShipName("GemTrans")
Freghter.SetModelFilename("data/Models/Ships/GemTrans/GemTrans1.nif")
...
SublightEngine2.SetMaxCondition(2500.000000)
