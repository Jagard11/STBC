# C:\Program Files\Activision\AllStuff\Bridge Commander\scripts\ships\Hardpoints\EAAchillesFreighterModule3.py
...
#################################################
EAAchillesFreighterModule3 = App.ShipProperty_Create("EAAchillesFreighterModule3")

EAAchillesFreighterModule3.SetGenus(1)
EAAchillesFreighterModule3.SetSpecies(106)
EAAchillesFreighterModule3.SetMass(20.000000)
EAAchillesFreighterModule3.SetRotationalInertia(1000.000000)
EAAchillesFreighterModule3.SetShipName("EAAchillesFreighterModule3")
EAAchillesFreighterModule3.SetModelFilename("data/Models/Ships/EAAchillesFreighter/EAAchillesFreighterLeftModule.nif")
EAAchillesFreighterModule3.SetDamageResolution(5.000000)
EAAchillesFreighterModule3.SetAffiliation(0)
EAAchillesFreighterModule3.SetStationary(0)
EAAchillesFreighterModule3.SetAIString("NonFedAttack")
EAAchillesFreighterModule3.SetDeathExplosionSound("g_lsDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(EAAchillesFreighterModule3)
#################################################
...
CargoModule3.SetCritical(1)
CargoModule3.SetTargetable(1)
CargoModule3.SetPrimary(1)
CargoModule3.SetPosition(0.000000, 0.000000, 0.000000)
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("EAAchillesFreighterModule3", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)