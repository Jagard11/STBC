# C:\Program Files\Activision\Bridge Commander\scripts\ships\Hardpoints\ViperMk7.py
...
IonDrive.SetMaxAngularAccel(2.700000)
IonDrive.SetMaxAngularVelocity(2.700000)
IonDrive.SetMaxSpeed(5.800000)
...
PortCannon.SetPosition(-0.062500, 0.000000, -0.015000)
...
StarCannon.SetPosition(0.062500, 0.000000, -0.015000)
...
Engine1.SetPosition(0.000000, -0.070000, 0.014000)
...
#################################################
ViperMk7 = App.ShipProperty_Create("ViperMk7")

ViperMk7.SetGenus(1)
ViperMk7.SetSpecies(107)
ViperMk7.SetMass(10.000000)
ViperMk7.SetRotationalInertia(2.000000)
ViperMk7.SetShipName("ViperMk7")
ViperMk7.SetModelFilename("data/Models/Ships/ViperMk7/ViperMk7.nif")
ViperMk7.SetDamageResolution(0.000100)
ViperMk7.SetAffiliation(0)
ViperMk7.SetStationary(0)
ViperMk7.SetAIString("NonFedAttack")
ViperMk7.SetDeathExplosionSound("g_lsDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(ViperMk7)
#################################################
...
Engine2.SetPosition(-0.009000, -0.065000, -0.001650)
...
Engine3.SetPosition(0.009000, -0.065000, -0.001650)
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("ViperMk7", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
