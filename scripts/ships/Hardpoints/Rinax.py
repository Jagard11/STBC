# C:\Program Files (x86)\Activision\Bridge Commander  KM v1 plus\scripts\ships\Hardpoints\Rinax.py
...
#################################################
Rinax = App.ShipProperty_Create("Rinax")

Rinax.SetGenus(2)
Rinax.SetSpecies(145)
Rinax.SetMass(60.000000)
Rinax.SetRotationalInertia(7000.000000)
Rinax.SetShipName("Rinax")
Rinax.SetModelFilename("data/models/bases/Rinax/Rinax.nif")
Rinax.SetDamageResolution(75.000000)
Rinax.SetAffiliation(0)
Rinax.SetStationary(0)
Rinax.SetAIString("StarbaseAttack")
Rinax.SetDeathExplosionSound("g_lsBigDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(Rinax)
#################################################
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("Rinax", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
