...
def GetShipStats():
	kShipStats = {
		"DamageRadMod" : 0.75, 
		"DamageStrMod" : 0.75, 
		"FilenameHigh": "data/Models/Ships/P$YCH0s_VoyagerA/DJSchumann.nif",
		"FilenameMed": "data/Models/Ships/P$YCH0s_VoyagerA/DJSchumann.nif",
		"FilenameLow": "data/Models/Ships/P$YCH0s_VoyagerA/DJSchumann.nif",
		"Name": "PsVoyagerA",
		"HardpointFile": "PsVoyagerA",
