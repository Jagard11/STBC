...
def CreateAI(pShip, pPlanet):
	...
	pScript.SetRoughDistances(pPlanet.GetRadius() * 1.5 + 150, pPlanet.GetRadius() * 1.5 + 190)
	...
	## Conditions:
	#### Condition InRange
	pInRange = App.ConditionScript_Create("Conditions.ConditionInRange", "ConditionInRange", 300.0 + pPlanet.GetRadius(),  pShip.GetName(), pPlanet.GetName())
	## Evaluation function:
