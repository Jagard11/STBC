...
def BuilderCreate5(pShip, pIntercept, sInitialTarget):
	########## AI Builder End ##########
	#########################################
	# Creating ConditionalAI WayTooFar at (59, 299)
	## Conditions:
	#### Condition Near
...
def BuilderCreate19(pShip, pPriorityList_4):
	########## AI Builder End ##########
	#########################################
	# Creating ConditionalAI ShortTime at (445, 147)
	## Conditions:
	#### Condition TimePassed
	pTimePassed = App.ConditionScript_Create("Conditions.ConditionTimer", "ConditionTimer", 10.0)
	## Evaluation function:
...
def BuilderCreate32(pShip, pWarpBeforeDeath, pNoSensorsEvasive, pSelectTarget, pFollowThroughWarpFlag):
	...
	pFleeAttackOrFollow.AddAI(pWarpBeforeDeath, 2)
...
def BuilderCreate33(pShip, pFleeAttackOrFollow):
	...
	## Setup:
	import AI.Preprocessors
	pScript = AI.Preprocessors.ManagePower(0)
	## The PreprocessingAI:
