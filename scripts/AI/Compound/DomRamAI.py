...
def CreateAI(pShip, *lpTargets, **dKeywords):
	...
	pBuilderAI.AddAIBlock("Ram", "BuilderCreate9")
	pBuilderAI.AddDependencyObject("Ram", "sInitialTarget", sInitialTarget)
	pBuilderAI.AddAIBlock("EnemiesStronger", "BuilderCreate10")
	pBuilderAI.AddDependency("EnemiesStronger", "Ram")
	pBuilderAI.AddAIBlock("RearTorpRun", "BuilderCreate11")
	pBuilderAI.AddDependencyObject("RearTorpRun", "sInitialTarget", sInitialTarget)
	pBuilderAI.AddAIBlock("StillClose", "BuilderCreate12")
	...
	pBuilderAI.AddAIBlock("SlowRearTorpRun", "BuilderCreate13")
	...
	pBuilderAI.AddAIBlock("RearTorpsReadySortaCloseNotInterruptable", "BuilderCreate15")
	...
	pBuilderAI.AddAIBlock("ICOMoveAround", "BuilderCreate16")
	...
	pBuilderAI.AddAIBlock("CloseRangePriorities", "BuilderCreate17")
	...
	pBuilderAI.AddDependency("CloseRangePriorities", "EnemiesStronger")
	...
	pBuilderAI.AddAIBlock("FireAll", "BuilderCreate18")
	...
	pBuilderAI.AddAIBlock("CloseRange", "BuilderCreate19")
	...
	pBuilderAI.AddAIBlock("EvadeTorps_3", "BuilderCreate20")
	...
	pBuilderAI.AddAIBlock("TorpRun", "BuilderCreate21")
	pBuilderAI.AddDependencyObject("TorpRun", "sInitialTarget", sInitialTarget)
	pBuilderAI.AddAIBlock("FwdTorpsOrPulseReady_2", "BuilderCreate22")
	...
	pBuilderAI.AddAIBlock("ICO_ShieldBiasMoveIn", "BuilderCreate23")
	pBuilderAI.AddDependencyObject("ICO_ShieldBiasMoveIn", "sInitialTarget", sInitialTarget)
	pBuilderAI.AddAIBlock("FwdShieldsLow", "BuilderCreate24")
	...
	pBuilderAI.AddAIBlock("Follow", "BuilderCreate25")
	pBuilderAI.AddDependencyObject("Follow", "sInitialTarget", sInitialTarget)
	pBuilderAI.AddAIBlock("MidRangePriorities", "BuilderCreate26")
	...
	pBuilderAI.AddAIBlock("FireAll2", "BuilderCreate27")
	...
	pBuilderAI.AddAIBlock("MidRange", "BuilderCreate28")
	...
	pBuilderAI.AddAIBlock("EvadeTorps", "BuilderCreate29")
	...
	pBuilderAI.AddAIBlock("LongRangePriorities", "BuilderCreate31")
	pBuilderAI.AddDependency("LongRangePriorities", "EvadeTorps")
	pBuilderAI.AddDependency("LongRangePriorities", "MoveIn")
	pBuilderAI.AddAIBlock("FirePulseOnly", "BuilderCreate32")
	...
	pBuilderAI.AddAIBlock("SelectTarget", "BuilderCreate36")
	...
	pBuilderAI.AddAIBlock("FollowTargetThroughWarp", "BuilderCreate37")
	...
	pBuilderAI.AddAIBlock("FollowThroughWarpFlag", "BuilderCreate38")
	...
	pBuilderAI.AddAIBlock("FleeAttackOrFollow", "BuilderCreate39")
	...
	pBuilderAI.AddAIBlock("PowerManagement", "BuilderCreate40")
	...
	pBuilderAI.AddAIBlock("AlertLevel", "BuilderCreate41")
...
def BuilderCreate9(pShip, sInitialTarget):
	########## AI Builder End ##########
	#########################################
	# Creating PlainAI Ram at (261, 369)
	...
	########## AI Builder End ##########
	######### AI Builder Begin #########
def BuilderCreate10(pShip, pRam):
	########## AI Builder End ##########
	#########################################
	# Creating ConditionalAI EnemiesStronger at (223, 324)
	## Conditions:
	#### Condition EnemiesInSetStronger
	pEnemiesInSetStronger = App.ConditionScript_Create("Conditions.EnemiesInSetStronger", "EnemiesInSetStronger", pShip, 3.0)
	## Evaluation function:
	def EvalFunc(bEnemiesInSetStronger):
		ACTIVE = App.ArtificialIntelligence.US_ACTIVE
		DORMANT = App.ArtificialIntelligence.US_DORMANT
		DONE = App.ArtificialIntelligence.US_DONE
		if bEnemiesInSetStronger:
			return ACTIVE
		return DORMANT
	## The ConditionalAI:
	pEnemiesStronger = App.ConditionalAI_Create(pShip, "EnemiesStronger")
	pEnemiesStronger.SetInterruptable(1)
	pEnemiesStronger.SetContainedAI(pRam)
	pEnemiesStronger.AddCondition(pEnemiesInSetStronger)
	pEnemiesStronger.SetEvaluationFunction(EvalFunc)
	# Done creating ConditionalAI EnemiesStronger
	#########################################
	######### AI Builder Begin #########
	return pEnemiesStronger  # Builder Return
	########## AI Builder End ##########
	######### AI Builder Begin #########
def BuilderCreate11(pShip, sInitialTarget):
	...
	########## AI Builder End ##########
	######### AI Builder Begin #########
def BuilderCreate12(pShip, pRearTorpRun, fCloseRange, sInitialTarget):
	########## AI Builder End ##########
	#########################################
...
def BuilderCreate13(pShip, sInitialTarget):
	...
	########## AI Builder End ##########
	######### AI Builder Begin #########
def BuilderCreate14(pShip, pStillClose, pSlowRearTorpRun):
	########## AI Builder End ##########
	#########################################
	...
	########## AI Builder End ##########
	######### AI Builder Begin #########
def BuilderCreate15(pShip, pPriorityList_3, fCloseRange, fMidRange, sInitialTarget, dKeywords):
	########## AI Builder End ##########
	#########################################
	...
	########## AI Builder End ##########
	######### AI Builder Begin #########
def BuilderCreate16(pShip, dKeywords, sInitialTarget):
	########## AI Builder End ##########
	#########################################
	# Creating CompoundAI ICOMoveAround at (354, 279)
	...
	########## AI Builder End ##########
	######### AI Builder Begin #########
def BuilderCreate17(pShip, pEvadeTorps_2, pFwdTorpsOrPulseReady, pEnemiesStronger, pRearTorpsReadySortaCloseNotInterruptable, pICOMoveAround):
	########## AI Builder End ##########
	#########################################
	# Creating PriorityListAI CloseRangePriorities at (108, 291)
	pCloseRangePriorities = App.PriorityListAI_Create(pShip, "CloseRangePriorities")
	pCloseRangePriorities.SetInterruptable(1)
	# SeqBlock is at (230, 281)
	pCloseRangePriorities.AddAI(pEvadeTorps_2, 1)
	pCloseRangePriorities.AddAI(pFwdTorpsOrPulseReady, 2)
	pCloseRangePriorities.AddAI(pEnemiesStronger, 3)
	pCloseRangePriorities.AddAI(pRearTorpsReadySortaCloseNotInterruptable, 4)
	pCloseRangePriorities.AddAI(pICOMoveAround, 5)
	...
	########## AI Builder End ##########
	######### AI Builder Begin #########
def BuilderCreate18(pShip, pCloseRangePriorities, sInitialTarget, dKeywords):
	########## AI Builder End ##########
	#########################################
	# Creating PreprocessingAI FireAll at (48, 350)
	## Setup:
	...
	########## AI Builder End ##########
	######### AI Builder Begin #########
def BuilderCreate19(pShip, pFireAll, fCloseRange, sInitialTarget):
	########## AI Builder End ##########
	#########################################
	...
	########## AI Builder End ##########
	######### AI Builder Begin #########
def BuilderCreate20(pShip, sInitialTarget, dKeywords):
	########## AI Builder End ##########
	#########################################
...
def BuilderCreate21(pShip, sInitialTarget):
	...
	########## AI Builder End ##########
	######### AI Builder Begin #########
def BuilderCreate22(pShip, pTorpRun, dKeywords):
	########## AI Builder End ##########
	#########################################
...
def BuilderCreate23(pShip, sInitialTarget):
	...
	########## AI Builder End ##########
	######### AI Builder Begin #########
def BuilderCreate24(pShip, pICO_ShieldBiasMoveIn, dKeywords):
	########## AI Builder End ##########
	#########################################
...
def BuilderCreate25(pShip, sInitialTarget):
	...
	########## AI Builder End ##########
	######### AI Builder Begin #########
def BuilderCreate26(pShip, pEvadeTorps_3, pFwdTorpsOrPulseReady_2, pFwdShieldsLow, pFollow):
	########## AI Builder End ##########
	#########################################
	...
	########## AI Builder End ##########
	######### AI Builder Begin #########
def BuilderCreate27(pShip, pMidRangePriorities, sInitialTarget, dKeywords):
	########## AI Builder End ##########
	#########################################
	...
	########## AI Builder End ##########
	######### AI Builder Begin #########
def BuilderCreate28(pShip, pFireAll2, fMidRange, sInitialTarget):
	########## AI Builder End ##########
	#########################################
	...
	########## AI Builder End ##########
	######### AI Builder Begin #########
def BuilderCreate29(pShip, sInitialTarget, dKeywords):
	########## AI Builder End ##########
	#########################################
...
def BuilderCreate30(pShip, sInitialTarget):
	...
	########## AI Builder End ##########
	######### AI Builder Begin #########
def BuilderCreate31(pShip, pEvadeTorps, pMoveIn):
	########## AI Builder End ##########
	#########################################
	...
	########## AI Builder End ##########
	######### AI Builder Begin #########
def BuilderCreate32(pShip, pLongRangePriorities, sInitialTarget, dKeywords):
	########## AI Builder End ##########
	#########################################
	...
	########## AI Builder End ##########
	######### AI Builder Begin #########
def BuilderCreate33(pShip, pFirePulseOnly, sInitialTarget):
	########## AI Builder End ##########
	#########################################
	...
	########## AI Builder End ##########
	######### AI Builder Begin #########
def BuilderCreate34(pShip, sInitialTarget):
	########## AI Builder End ##########
	#########################################
	...
	########## AI Builder End ##########
	######### AI Builder Begin #########
def BuilderCreate35(pShip, pCloseRange, pMidRange, pLongRange, pInterceptTarget):
	########## AI Builder End ##########
	#########################################
	...
	########## AI Builder End ##########
	######### AI Builder Begin #########
def BuilderCreate36(pShip, pPriorityList, pAllTargetsGroup, sInitialTarget):
	########## AI Builder End ##########
	#########################################
	...
	########## AI Builder End ##########
	######### AI Builder Begin #########
def BuilderCreate37(pShip, pSelectTarget, sInitialTarget, dKeywords):
	########## AI Builder End ##########
	#########################################
	...
	########## AI Builder End ##########
	######### AI Builder Begin #########
def BuilderCreate38(pShip, pFollowTargetThroughWarp, dKeywords):
	########## AI Builder End ##########
	#########################################
	...
	########## AI Builder End ##########
	######### AI Builder Begin #########
def BuilderCreate39(pShip, pCheckWarpBeforeDeath, pNoSensorsEvasive, pSelectTarget, pFollowThroughWarpFlag):
	########## AI Builder End ##########
	#########################################
	...
	########## AI Builder End ##########
	######### AI Builder Begin #########
def BuilderCreate40(pShip, pFleeAttackOrFollow, dKeywords):
	########## AI Builder End ##########
	#########################################
	...
	########## AI Builder End ##########
	######### AI Builder Begin #########
def BuilderCreate41(pShip, pPowerManagement):
	########## AI Builder End ##########
	#########################################
