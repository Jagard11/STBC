...
def GetShipStats():
	kShipStats = {
		"DamageRadMod" : 0.75, 
		"DamageStrMod" : 0.75, 
		"FilenameHigh": "data/Models/Ships/DJValiant/DJValiant.nif",
		"FilenameMed": "data/Models/Ships/DJValiant/DJValiant.nif",
		"FilenameLow": "data/Models/Ships/DJValiant/DJValiant.nif",
		"Name": "DJValiant",
		"HardpointFile": "DJValiant",
