...
def CreateAI(pShip):
	...
	pAttack = AI.Compound.BorgAttack.CreateAI(pShip, MissionLib.GetEnemyGroup(), Difficulty = 1.0, MaxFiringRange = 300.0, FollowTargetThroughWarp = 1, ChooseSubsystemTargets = 1, AggressivePulseWeapons = 0, DisableBeforeDestroy = 0, InaccurateTorps = 1, SmartWeaponBalance = 0, SmartShields = 1, UseSideArcs = 1, HighPower = 1, PowerManagement = 1)
