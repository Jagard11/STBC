...
def CreateTeamAceEntry (pPlayer):
	...
	# Get the kill total from the score dictionaries
	pDict = Multiplayer.Episode.Mission10.Mission10.g_kKillsDictionary
	...
	# Get the death total from the score dictionaries
	pDict = Multiplayer.Episode.Mission10.Mission10.g_kDeathsDictionary
