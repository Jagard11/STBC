...
import App
def CreateTeamAI(pShip, g_pTeam):
	#########################################
	# Creating CompoundAI Attack at (108, 133)
	debug(__name__ + ", CreateTeamAI")
	import AI.Compound.BasicAttack
	pAttack = AI.Compound.BasicAttack.CreateAI(pShip, g_pTeam, Difficulty = 1, FollowTargetThroughWarp = 1, UseCloaking = 1)
...
def CreateStarbaseTeamAI(pShip, g_pTeam):
	#########################################
	# Creating CompoundAI StarbaseAttack at (194, 57)
	debug(__name__ + ", CreateStarbaseTeamAI")
	import AI.Compound.StarbaseAttack
	pStarbaseAttack = AI.Compound.StarbaseAttack.CreateAI(pShip, g_pTeam)
