...
MAX_TIME_LIMIT						= 200
TIME_LIMIT_INCRIMENT				= 15
MAX_FRAG_LIMIT						= 25
FRAG_LIMIT_INCRIMENT				= 1
MIN_PLAYER_LIMIT					= 2
MAX_PLAYER_LIMIT					= 32
NORMAL_PLAYER_NUM                               = 8
PLAYER_LIMIT_INCRIMENT				= 2
...
g_iTimeLimit = -1
g_iFragLimit = -1
g_iPlayerLimit = NORMAL_PLAYER_NUM
...
def DeleteMissionMenus ():
	debug(__name__ + ", DeleteMissionMenus")
...
def HandleMouseEventsForEndPane(pObject, pEvent):
	debug(__name__ + ", HandleMouseEventsForEndPane")
	pObject.CallNextHandler(pEvent)
...
def BuildShipDescWindow(pDatabase):
	debug(__name__ + ", BuildShipDescWindow")
	import MainMenu.mainmenu
...
def BuildRegionSelectWindow (pMissionPane, pDatabase):
	debug(__name__ + ", BuildRegionSelectWindow")
	import MissionShared
...
def InsertChildSorted (pSubPane, pNewButton):
	debug(__name__ + ", InsertChildSorted")
	pName = App.TGString ()
...
def BuildRegionDescWindow(pDatabase):
	debug(__name__ + ", BuildRegionDescWindow")
	import MainMenu.mainmenu
...
def UpdateTimeLeftDisplay(pTimePane = None, bLayout = 0):
	debug(__name__ + ", UpdateTimeLeftDisplay")
	import MissionShared
	if (pTimePane == None):
...
def UpdateFragLimit (pFragPane, bLayout = 0):
	debug(__name__ + ", UpdateFragLimit")
	import MissionShared
	if (pFragPane == None):
...
def HandleTimeLimitClicked(pObject, pEvent):
	debug(__name__ + ", HandleTimeLimitClicked")
	import MissionShared
	global g_iTimeLimit
...
def HandleFragLimitClicked(pObject, pEvent):
	debug(__name__ + ", HandleFragLimitClicked")
	import MissionShared
	global g_iFragLimit
...
def HandlePlayerLimitClicked(pObject, pEvent):
	debug(__name__ + ", HandlePlayerLimitClicked")
	import MissionShared
...
def ShowShipSelectScreen ():
	debug(__name__ + ", ShowShipSelectScreen")
	import MissionLib
	import BridgeHandlers
	import MainMenu.mainmenu
...
def PreRebuildAfterResChange ():
	debug(__name__ + ", PreRebuildAfterResChange")
	return

def PostRebuildAfterResChange ():
#	print ("Post rebuild after res change called");
	debug(__name__ + ", PostRebuildAfterResChange")
...
def DropOutOfManualFireModeMultiplayer():
	...
	debug(__name__ + ", DropOutOfManualFireModeMultiplayer")
