...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/FedConstOpen/FedConstOpen.nif",
		"FilenameMed": "data/Models/Ships/FedConstOpen/FedConstOpen.nif",
...
def LoadModel(bPreLoad = 0):
	...
	if (not App.g_kLODModelManager.Contains(pStats["Name"])):
		...
		pLODModel.AddLOD(pStats["FilenameMed"],  10, 400.0, 0.0, 0.0, 400, 900, "_glow", None, "_specular")
