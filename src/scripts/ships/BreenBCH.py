...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/BreenBCH/BreenBCH.NIF",
		"FilenameMed": "data/Models/Ships/BreenBCH/BreenBCH.NIF",
		"FilenameLow": "data/Models/Ships/BreenBCH/BreenBCH.NIF",
		"Name": "BreenBCH",
		"HardpointFile": "BreenBCH",
		"Species": Multiplayer.SpeciesToShip.BREENBCH,
		"SpecularCoef": 0.5,
		 }
	return kShipStats
