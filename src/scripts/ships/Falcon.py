...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/Falcon/Falcon.NIF",
		"FilenameMed": "data/Models/Ships/Falcon/Falcon.NIF",
		"FilenameLow": "data/Models/Ships/Falcon/Falcon.NIF",
		"Name": "Falcon",
		"HardpointFile": "falcon",
		"Species": Multiplayer.SpeciesToShip.FALCON
	}
	return kShipStats
