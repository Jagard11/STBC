...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/VasKholhr/Hull.nif",
		"FilenameMed": "data/Models/Ships/VasKholhr/Hull.nif",
		"FilenameLow": "data/Models/Ships/VasKholhr/Hull.nif",
		"Name": "Vas Kholhr Body",
		"HardpointFile": "VasKholhr",
