...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/FedConst/FedConst.NIF",
		"FilenameMed": "data/Models/Ships/FedConst/FedConst.NIF",
		"FilenameLow": "data/Models/Ships/FedConst/FedConst.NIF",
		"Name": "FedConst",
		"HardpointFile": "FedConst",
		"Species": Multiplayer.SpeciesToShip.FEDCONST
	}
	return kShipStats
