...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/venator/venator.nif",
		"FilenameMed": "data/Models/Ships/venator/venator.nif",
		"FilenameLow": "data/Models/Ships/venator/venator.nif",
		"Name": "Venator",
		"HardpointFile": "venator",
