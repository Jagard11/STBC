...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Bases/PSYCH0WormholeGFX-BlackHole/inner.NIF",
		"FilenameMed": "data/Models/Bases/PSYCH0WormholeGFX-BlackHole/inner.NIF",
		"FilenameLow": "data/Models/Bases/PSYCH0WormholeGFX-BlackHole/inner.NIF",
		"Name": "WormholeConeVar2_2",
		"HardpointFile": "WormholeConeVar2_2",
