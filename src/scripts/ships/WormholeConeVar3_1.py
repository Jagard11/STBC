...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Bases/PSYCH0WormholeGFX-Slipstream/outer.NIF",
		"FilenameMed": "data/Models/Bases/PSYCH0WormholeGFX-Slipstream/outer.NIF",
		"FilenameLow": "data/Models/Bases/PSYCH0WormholeGFX-Slipstream/outer.NIF",
		"Name": "WormholeConeVar3_1",
		"HardpointFile": "WormholeConeVar3_1",
