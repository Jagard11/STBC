...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Bases/PsychoRetextureWormholeGFX/inner.NIF",
		"FilenameMed": "data/Models/Bases/PsychoRetextureWormholeGFX/inner.NIF",
		"FilenameLow": "data/Models/Bases/PsychoRetextureWormholeGFX/inner.NIF",
		"Name": "WormholeConeVar1_2",
		"HardpointFile": "WormholeConeVar1_2",
