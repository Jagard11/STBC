...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Bases/BlaxxerWormholeGFX/outer.NIF",
		"FilenameMed": "data/Models/Bases/BlaxxerWormholeGFX/outer.NIF",
		"FilenameLow": "data/Models/Bases/BlaxxerWormholeGFX/outer.NIF",
		"Name": "WormholeCone",
		"HardpointFile": "WormholeCone",
