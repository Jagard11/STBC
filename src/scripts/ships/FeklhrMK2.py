...
def GetShipStats():
	kShipStats = { 
		"FilenameHigh": "data/Models/Ships/FeklhrMK2/FeklhrMK2.NIF",
		"FilenameMed": "data/Models/Ships/FeklhrMK2/FeklhrMK2.NIF",
		"FilenameLow": "data/Models/Ships/FeklhrMK2/FeklhrMK2.NIF",		
		"Name": "FekLhrMK2",
		"HardpointFile": "FekLhrMK2",
		"Species": Multiplayer.SpeciesToShip.FEKLHRMK2
	}
	return kShipStats
