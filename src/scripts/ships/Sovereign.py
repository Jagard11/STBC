...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/WCNemEntE/WCNemEntE.nif",
		"FilenameMed": "data/Models/Ships/WCNemEntE/WCNemEntE.nif",
		"FilenameLow": "data/Models/ships/WCNemEntE/WCNemEntE.nif",
		"Name": "WCNemEntE",
