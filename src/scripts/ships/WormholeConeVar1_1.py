...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Bases/PsychoRetextureWormholeGFX/outer.NIF",
		"FilenameMed": "data/Models/Bases/PsychoRetextureWormholeGFX/outer.NIF",
		"FilenameLow": "data/Models/Bases/PsychoRetextureWormholeGFX/outer.NIF",
		"Name": "WormholeConeVar1_1",
		"HardpointFile": "WormholeConeVar1_1",
