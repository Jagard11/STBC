...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Bases/PSYCH0WormholeGFX-BlackHole/outer.NIF",
		"FilenameMed": "data/Models/Bases/PSYCH0WormholeGFX-BlackHole/outer.NIF",
		"FilenameLow": "data/Models/Bases/PSYCH0WormholeGFX-BlackHole/outer.NIF",
		"Name": "WormholeConeVar2_1",
		"HardpointFile": "WormholeConeVar2_1",
