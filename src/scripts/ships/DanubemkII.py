...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/SKDanube/danube.NIF",
		"FilenameMed": "data/Models/Ships/SKDanube/danube.NIF",
		"FilenameLow": "data/Models/Ships/SKDanube/danube.NIF",
		"Name": "DanubemkII",
		"HardpointFile": "DanubemkII",
		"Species": Multiplayer.SpeciesToShip.DANUBEMKII
	}
	return kShipStats
