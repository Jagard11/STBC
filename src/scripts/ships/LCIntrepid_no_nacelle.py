...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/LCIntrepid/Intrepid_no_nacelles.NIF",
		"FilenameMed": "data/Models/Ships/LCIntrepid/Intrepid_no_nacelles.NIF",
		"FilenameLow": "data/Models/Ships/LCIntrepid/Intrepid_no_nacelles.NIF",
		"Name": "Intrepid No",
		"HardpointFile": "LCIntrepid_no",
