...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/scorpion/scorpion.nif",
		"FilenameMed": "data/Models/Ships/scorpion/scorpion.nif",
		"FilenameLow": "data/Models/Ships/scorpion/scorpion.nif",
		"Name": "scorpion",
		"HardpointFile": "scorpion",
		"Species": Multiplayer.SpeciesToShip.SCORPION
		 }
	return kShipStats
