...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/VasKholhr/VasCruise.NIF",
		"FilenameMed": "data/Models/Ships/VasKholhr/VasCruise.NIF",
		"FilenameLow": "data/Models/Ships/VasKholhr/VasCruise.NIF",
		"Name": "Vas Kholhr",
