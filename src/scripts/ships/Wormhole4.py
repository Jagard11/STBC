...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Bases/Wormhole4/wormhole-outerring.NIF",
		"FilenameMed": "data/Models/Bases/Wormhole4/wormhole-outerring.NIF",
		"FilenameLow": "data/Models/Bases/Wormhole4/wormhole-outerring.NIF",
		"Name": "Wormhole4",
		"HardpointFile": "Wormhole4",
