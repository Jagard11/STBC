...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/Karemman/Karemman.NIF",
		"FilenameMed": "data/Models/Ships/Karemman/Karemman.NIF",
		"FilenameLow": "data/Models/Ships/Karemman/Karemman.NIF",
		"Name": "Karemman",
		"HardpointFile": "Karemman",
		"Species": Multiplayer.SpeciesToShip.KAREMMA
	 }
	return kShipStats
