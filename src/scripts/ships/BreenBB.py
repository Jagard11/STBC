...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/BreenBB/BreenBB.NIF",
		"FilenameMed": "data/Models/Ships/BreenBB/BreenBB.NIF",
		"FilenameLow": "data/Models/Ships/BreenBB/BreenBB.NIF",
		"Name": "BreenBB",
		"HardpointFile": "BreenBB",
		"Species": Multiplayer.SpeciesToShip.BREENBB,
		"SpecularCoef": 0.5,
		 }
	return kShipStats
