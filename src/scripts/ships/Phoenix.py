...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/Nebula/High/Phoenix.nif",
		"FilenameMed": "data/Models/Ships/Nebula/High/Phoenix.nif",
		"FilenameLow": "data/Models/Ships/Nebula/High/Phoenix.nif",
		"Name": "Phoenix",
