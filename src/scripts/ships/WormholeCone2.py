...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Bases/BlaxxerWormholeGFX/inner.NIF",
		"FilenameMed": "data/Models/Bases/BlaxxerWormholeGFX/inner.NIF",
		"FilenameLow": "data/Models/Bases/BlaxxerWormholeGFX/inner.NIF",
		"Name": "WormholeCone2",
		"HardpointFile": "WormholeCone2",
