...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Bases/Wormhole/wormhole-cone.NIF",
		"FilenameMed": "data/Models/Bases/Wormhole/wormhole-cone.NIF",
		"FilenameLow": "data/Models/Bases/Wormhole/wormhole-cone.NIF",
		"Name": "Wormhole",
		"HardpointFile": "Wormhole",
