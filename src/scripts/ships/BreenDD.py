...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/BreenDD/BreenDD.NIF",
		"FilenameMed": "data/Models/Ships/BreenDD/BreenDD.NIF",
		"FilenameLow": "data/Models/Ships/BreenDD/BreenDD.NIF",
		"Name": "BreenDD",
		"HardpointFile": "BreenDD",
		"Species": Multiplayer.SpeciesToShip.BREENDD,
		"SpecularCoef": 0.5,
		 }
	return kShipStats
