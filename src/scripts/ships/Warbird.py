...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/LCWarbird/LCdderidex_late.NIF",
		"FilenameMed": "data/Models/Ships/LCWarbird/LCdderidex_late.NIF",
		"FilenameLow": "data/Models/Ships/LCWarbird/LCdderidex_late.NIF",
		"Name": "Warbird",
		"HardpointFile": "warbird",
