...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Bases/Wormhole3/wormhole-cone.NIF",
		"FilenameMed": "data/Models/Bases/Wormhole3/wormhole-cone.NIF",
		"FilenameLow": "data/Models/Bases/Wormhole3/wormhole-cone.NIF",
		"Name": "Wormhole3",
		"HardpointFile": "Wormhole3",
