...
def GetShipStats():
	kShipStats = { 
		"FilenameHigh": "data/Models/Ships/type9/type9.NIF",
		"FilenameMed": "data/Models/Ships/type9/type9Med.NIF",
		"FilenameLow": "data/Models/Ships/type9/type9Low.NIF",		
		"Name": "type9",
		"HardpointFile": "type9",
		"Species": Multiplayer.SpeciesToShip.TYPE9
	}
	return kShipStats
