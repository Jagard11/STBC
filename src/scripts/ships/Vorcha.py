...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/Vorcha/Bortas.nif",
		"FilenameMed": "data/Models/Ships/Vorcha/Bortas.nif",
		"FilenameLow": "data/Models/Ships/Vorcha/Bortas.nif",
		"Name": "Vorcha",
		"HardpointFile": "vorcha",
