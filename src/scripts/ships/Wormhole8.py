...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Bases/CordWormhole/wormhole-cone.nif",
		"FilenameMed": "data/Models/Bases/CordWormhole/wormhole-cone.nif",
		"FilenameLow": "data/Models/Bases/CordWormhole/wormhole-cone.nif",
		"Name": "Wormhole8",
		"HardpointFile": "Wormhole8",
