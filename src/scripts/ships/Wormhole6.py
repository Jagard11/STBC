...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Bases/Wormhole6/wormhole-outerring.NIF",
		"FilenameMed": "data/Models/Bases/Wormhole6/wormhole-outerring.NIF",
		"FilenameLow": "data/Models/Bases/Wormhole6/wormhole-outerring.NIF",
		"Name": "Wormhole6",
		"HardpointFile": "Wormhole6",
