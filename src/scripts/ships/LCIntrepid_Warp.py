...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/LCIntrepid/Intrepid_Warp.NIF",
		"FilenameMed": "data/Models/Ships/LCIntrepid/Intrepid_Warp.NIF",
		"FilenameLow": "data/Models/Ships/LCIntrepid/Intrepid_Warp.NIF",
		"Name": "Intrepid Warp",
		"HardpointFile": "LCIntrepid_warp",
