...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Bases/CordanilusWormholeGFX/inner2.nif",
		"FilenameMed": "data/Models/Bases/CordanilusWormholeGFX/inner2.nif",
		"FilenameLow": "data/Models/Bases/CordanilusWormholeGFX/inner2.nif",
		"Name": "WormholeConeVar5_3",
		"HardpointFile": "WormholeConeVar5_3",
