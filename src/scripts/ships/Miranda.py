...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/MirandaPack/ZZSitak.nif",
		"FilenameMed": "data/Models/Ships/MirandaPack/ZZSitak.nif",
...
def LoadModel(bPreLoad = 0):
	...
	if (not App.g_kLODModelManager.Contains(pStats["Name"])):
		...
		pLODModel.AddLOD(pStats["FilenameLow"],  10, 400.0, 15.0, 30.0, 400, 900, "_glow", None, None)
