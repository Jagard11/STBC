...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/Junk/Junk.NIF",
		"FilenameMed": "data/Models/Ships/Junk/Junk.NIF",
		"FilenameLow": "data/Models/Ships/Junk/Junk.NIF",
		"Name": "Junk",
		"HardpointFile": "Junk",
		"Species": Multiplayer.SpeciesToShip.JUNK
		 }
	return kShipStats
