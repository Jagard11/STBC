...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/CardHybrid/CardHybrid.NIF",
		"FilenameMed": "data/Models/Ships/CardHybrid/CardHybridMed.NIF",
		"FilenameLow": "data/Models/Ships/CardHybrid/CardHybridLow.NIF",
		"Name": "CardHybrid",
		"HardpointFile": "cardhybrid",
