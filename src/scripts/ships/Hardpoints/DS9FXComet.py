# C:\Program Files\Activision\Bridge Commander\scripts\ships\Hardpoints\DS9-Hardpoints\DS9FXComet.py
...
WarpCore.SetPosition(0.100000, 0.100000, 0.100000)
...
Phaser.SetMaxDamage(500.000000)
...
#################################################
CometAlpha = App.ShipProperty_Create("CometAlpha")

CometAlpha.SetGenus(3)
CometAlpha.SetSpecies(712)
CometAlpha.SetMass(400.000000)
CometAlpha.SetRotationalInertia(10000.000000)
CometAlpha.SetShipName("CometAlpha")
CometAlpha.SetModelFilename("data/Models/Ships/DS9FXComet/asteroid.NIF")
CometAlpha.SetDamageResolution(10.000000)
CometAlpha.SetAffiliation(0)
CometAlpha.SetStationary(0)
CometAlpha.SetAIString("FedAttack")
CometAlpha.SetDeathExplosionSound("g_lsDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(CometAlpha)
#################################################
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("CometAlpha", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
