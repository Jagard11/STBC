# C:\Program Files\Activision\Bridge Commander\scripts\ships\Hardpoints\DS9-Hardpoints\DS9FXDummy.py
...
Shuttle.SetModelFilename("data/Models/Ships/DS9FXShuttle/Shuttle.nif")
