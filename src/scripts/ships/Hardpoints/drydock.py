# C:\Users\Owner\Documents\FinalHP_Changes_Bases\drydock.py
...
DockingEntryStartForward.SetXYZ(0.035268, -0.999361, 0.005795)
DockingEntryStartUp = App.TGPoint3()
DockingEntryStartUp.SetXYZ(0.006218, 0.006018, 0.999963)
DockingEntryStartRight = App.TGPoint3()
DockingEntryStartRight.SetXYZ(-0.999359, -0.035231, 0.006428)
...
DockingEntryStartPosition.SetXYZ(-0.915300, 55.365299, 0.048690)
...
DockingEntryEndForward.SetXYZ(0.019280, -0.999791, -0.006777)
DockingEntryEndUp = App.TGPoint3()
DockingEntryEndUp.SetXYZ(-0.011128, -0.006992, 0.999914)
DockingEntryEndRight = App.TGPoint3()
DockingEntryEndRight.SetXYZ(-0.999752, -0.019203, -0.011260)
...
DockingEntryEndPosition.SetXYZ(-0.009504, -6.395690, -0.418340)
...
DockingExitStartForward.SetXYZ(0.001523, -0.999211, -0.039688)
DockingExitStartUp = App.TGPoint3()
DockingExitStartUp.SetXYZ(0.027297, -0.039632, 0.998841)
DockingExitStartRight = App.TGPoint3()
DockingExitStartRight.SetXYZ(-0.999626, -0.002605, 0.027215)
...
DockingExitStartPosition.SetXYZ(0.186851, -11.828100, -0.101312)
