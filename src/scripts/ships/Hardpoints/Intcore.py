...
#################################################
Intcore = App.ShipProperty_Create("Intcore")

Intcore.SetGenus(1)
Intcore.SetSpecies(198)
Intcore.SetMass(1000.000000)
Intcore.SetRotationalInertia(500.000000)
Intcore.SetShipName("Intrepid Warpcore")
Intcore.SetModelFilename("data/Models/Misc/Intcore/intrepid core 1.NIF")
Intcore.SetDamageResolution(10.000000)
Intcore.SetAffiliation(0)
Intcore.SetStationary(0)
Intcore.SetAIString("FedAttack")
Intcore.SetDeathExplosionSound("g_lsDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(Intcore)
#################################################
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("Intcore", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
