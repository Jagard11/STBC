# C:\Program Files\Bridge Commander\scripts\ships\Hardpoints\Warpcore.py
...
#################################################
Smallcore = App.ShipProperty_Create("Smallcore")

Smallcore.SetGenus(1)
Smallcore.SetSpecies(198)
Smallcore.SetMass(1000.000000)
Smallcore.SetRotationalInertia(500.000000)
Smallcore.SetShipName("Smallcore")
Smallcore.SetModelFilename("data/Models/Misc/Smallcore/smaller core.NIF")
Smallcore.SetDamageResolution(10.000000)
Smallcore.SetAffiliation(0)
Smallcore.SetStationary(0)
Smallcore.SetAIString("FedAttack")
Smallcore.SetDeathExplosionSound("g_lsDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(Smallcore)
#################################################
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("Smallcore", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
