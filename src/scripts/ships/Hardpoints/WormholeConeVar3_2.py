# C:\unzipped\DS9FX\DS9FX\DS9FX Full\scripts\ships\Hardpoints\WormholeConeVar3_2.py
...
Wormhole.SetModelFilename("data/Models/Bases/PSYCH0WormholeGFX-Slipstream/inner.NIF")
