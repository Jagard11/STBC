# C:\Program Files\Activision\Bridge Commander Enemys Of Life\scripts\ships\Hardpoints\defpod.py
...
PortImpulse.SetPosition(-0.033682, -0.024085, -0.082367)
...
StarImpulse.SetPosition(0.030369, -0.023173, -0.081305)
...
ViewscreenForwardPosition.SetXYZ(0.000000, 3.900000, 0.500000)
...
ViewscreenBackPosition.SetXYZ(0.000000, 0.000000, 1.560000)
...
ViewscreenDownPosition.SetXYZ(0.000000, 4.000000, 0.000000)
...
FirstPersonCameraPosition.SetXYZ(0.000000, 0.200000, 0.200000)
...
PodlightPosition.SetXYZ(-0.000055, 0.000224, 0.064190)
Podlight.SetPosition(PodlightPosition)
PodlightLightColor = App.TGColorA()
PodlightLightColor.SetRGBA(1.000000, 0.000000, 0.000000, 1.000000)
Podlight.SetColor(PodlightLightColor)
Podlight.SetRadius(0.100000)
