# C:\Downloads\DS9FX\scripts\ships\Hardpoints\DS9FXVortex4.py
...
Hull.SetPrimary(1)
Hull.SetPosition(0.000000, 5.000000, 0.000000)
...
#################################################
DS9FXVortex4 = App.ShipProperty_Create("DS9FXVortex4")

DS9FXVortex4.SetGenus(1)
DS9FXVortex4.SetSpecies(710)
DS9FXVortex4.SetMass(0.000000)
DS9FXVortex4.SetRotationalInertia(500.000000)
DS9FXVortex4.SetShipName("DS9FXVortex4")
DS9FXVortex4.SetModelFilename("data/Models/Ships/DS9FX/Vortex2/BadlandsVortex2.nif")
DS9FXVortex4.SetDamageResolution(10.000000)
DS9FXVortex4.SetAffiliation(0)
DS9FXVortex4.SetStationary(0)
DS9FXVortex4.SetAIString("FedAttack")
DS9FXVortex4.SetDeathExplosionSound("g_lsDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(DS9FXVortex4)
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("DS9FXVortex4", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
