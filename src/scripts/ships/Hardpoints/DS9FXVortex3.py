# C:\Downloads\DS9FX\scripts\ships\Hardpoints\DS9FXVortex3.py
...
#################################################
DS9FXVortex3 = App.ShipProperty_Create("DS9FXVortex3")

DS9FXVortex3.SetGenus(1)
DS9FXVortex3.SetSpecies(710)
DS9FXVortex3.SetMass(0.000000)
DS9FXVortex3.SetRotationalInertia(500.000000)
DS9FXVortex3.SetShipName("DS9FXVortex3")
DS9FXVortex3.SetModelFilename("data/Models/Ships/DS9FX/Vortex2/BadlandsVortex.nif")
DS9FXVortex3.SetDamageResolution(10.000000)
DS9FXVortex3.SetAffiliation(0)
DS9FXVortex3.SetStationary(0)
DS9FXVortex3.SetAIString("FedAttack")
DS9FXVortex3.SetDeathExplosionSound("g_lsDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(DS9FXVortex3)
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("DS9FXVortex3", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
