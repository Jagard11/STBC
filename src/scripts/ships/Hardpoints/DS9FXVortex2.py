# C:\Downloads\DS9FX\scripts\ships\Hardpoints\DS9FXVortex2.py
...
#################################################
DS9FXVortex2 = App.ShipProperty_Create("DS9FXVortex2")

DS9FXVortex2.SetGenus(1)
DS9FXVortex2.SetSpecies(710)
DS9FXVortex2.SetMass(0.000000)
DS9FXVortex2.SetRotationalInertia(500.000000)
DS9FXVortex2.SetShipName("DS9FXVortex2")
DS9FXVortex2.SetModelFilename("data/Models/Ships/DS9FX/Vortex/BadlandsVortex2.nif")
DS9FXVortex2.SetDamageResolution(10.000000)
DS9FXVortex2.SetAffiliation(0)
DS9FXVortex2.SetStationary(0)
DS9FXVortex2.SetAIString("FedAttack")
DS9FXVortex2.SetDeathExplosionSound("g_lsDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(DS9FXVortex2)
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("DS9FXVortex2", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
