# C:\J-Single-testing-KM1\scripts\ships\Hardpoints\Shuttle.py
...
Phasers.SetPosition2D(1.000000, 35.000000)
...
Phaser.SetPrimary(1)
Phaser.SetPosition(0.000000, 0.051000, 0.000000)
Phaser.SetPosition2D(2.000000, 54.000000)
...
Phaser.SetIconPositionY(48.000000)
...
Phaser.SetIndicatorIconPositionX(60.000000)
Phaser.SetIndicatorIconPositionY(43.000000)
...
Phaser.SetMainRadius(0.009000)
Phaser.SetTaperRadius(0.010000)
Phaser.SetCoreScale(0.300000)
...
PortImpulse.SetPosition(-0.020987, -0.036423, 0.010434)
PortImpulse.SetPosition2D(118.000000, 73.000000)
PortImpulse.SetRepairComplexity(1.000000)
PortImpulse.SetDisabledPercentage(0.500000)
PortImpulse.SetRadius(0.007000)
...
StarImpulse.SetPosition(0.018482, -0.036427, 0.012829)
StarImpulse.SetPosition2D(138.000000, 73.000000)
...
WarpEngines.SetPosition2D(128.000000, 104.000000)
...
PortWarp.SetPosition(-0.033392, -0.001779, -0.015820)
PortWarp.SetPosition2D(116.000000, 118.000000)
...
StarWarp.SetPosition(0.034480, 0.000565, -0.013936)
StarWarp.SetPosition2D(138.000000, 117.000000)
...
Tractors.SetPosition2D(59.000000, 116.000000)
