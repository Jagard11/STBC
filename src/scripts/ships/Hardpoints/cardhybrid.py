# C:\Users\Owner\Documents\FinalHP_Changes_Cardassians\cardhybrid.py
...
Torpedoes.SetTorpedoScript(1, "Tactical.Projectiles.PositronTorpedo")
...
ForwardCompressor.SetDamageRadiusFactor(0.150000)
...
ForwardCompressor.SetMaxDamage(800.000000)
ForwardCompressor.SetMaxDamageDistance(30.000000)
ForwardCompressor.SetMinFiringCharge(5.000000)
ForwardCompressor.SetNormalDischargeRate(1.000000)
ForwardCompressor.SetRechargeRate(0.200000)
...
ForwardCompressor.SetTextureName("data/CACardassian.tga")
...
VentralBeam1.SetMaxDamage(800.000000)
...
VentralBeam1.SetRechargeRate(0.100000)
...
VentralBeam2.SetMaxDamage(800.000000)
...
VentralBeam2.SetRechargeRate(0.100000)
...
DorsalBeam1.SetMaxDamage(800.000000)
...
DorsalBeam1.SetRechargeRate(0.100000)
...
DorsalBeam2.SetMaxDamage(800.000000)
...
DorsalBeam2.SetRechargeRate(0.100000)
...
ForwardBeam1.SetMaxDamage(1200.000000)
...
ForwardBeam1.SetRechargeRate(0.170000)
...
ForwardBeam2.SetRechargeRate(0.170000)
...
Cannon.SetRechargeRate(0.050000)
...
Torpedo1.SetDamageRadiusFactor(0.500000)
...
Torpedo2.SetDamageRadiusFactor(0.500000)
