...
HeavyDisruptor.SetNormalDischargeRate(1.000000)
...
LightDisruptor1.SetNormalDischargeRate(1.000000)
...
LightDisruptor2.SetNormalDischargeRate(1.000000)
...
FwdTorpedo.SetDamageRadiusFactor(0.300000)
