# C:\Documents and Settings\Owner.STARFLEETHQ\My Documents\KM 1.0 Changes (2)\scripts\ships\Hardpoints\cowpasteroid.py
...
AsteroidMass.SetSpecies(208)
AsteroidMass.SetMass(200.000000)
AsteroidMass.SetRotationalInertia(30000.000000)
