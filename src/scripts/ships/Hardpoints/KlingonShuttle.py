# D:\Spiele\Bridge Commander\scripts\ships\Hardpoints\KlingonShuttle.py
...
FwdTorpedo.SetPosition(0.003490, 0.076635, 0.000416)
FwdTorpedo.SetPosition2D(67.000000, 15.000000)
...
ShieldGenerator.SetPosition2D(100.000000, 118.000000)
...
SensorArray.SetPosition(-0.002142, 0.034769, 0.019117)
SensorArray.SetPosition2D(128.000000, 115.000000)
...
WarpCore.SetPosition2D(81.000000, 72.000000)
...
PortCannon.SetPosition(-0.065000, 0.022000, -0.012714)
...
PortCannon.SetMaxCharge(2.000000)
...
PortCannon.SetModuleName("Tactical.Projectiles.Energy Dissipator")
...
StarCannon.SetPosition(0.067580, 0.018000, -0.014840)
...
StarCannon.SetMaxCharge(2.000000)
...
StarCannon.SetModuleName("Tactical.Projectiles.Energy Dissipator")
...
Torpedoes.SetPosition(0.003372, 0.076633, -0.001036)
...
CloakingDevice.SetPosition(0.014971, -0.031943, 0.020944)
CloakingDevice.SetPosition2D(48.000000, 68.000000)
CloakingDevice.SetRepairComplexity(6.000000)
CloakingDevice.SetDisabledPercentage(0.750000)
CloakingDevice.SetRadius(0.010000)
...
ImpulseEngine1.SetMaxCondition(2400.000000)
ImpulseEngine1.SetCritical(0)
ImpulseEngine1.SetTargetable(0)
ImpulseEngine1.SetPrimary(1)
ImpulseEngine1.SetPosition(-0.030000, -0.052000, 0.000000)
ImpulseEngine1.SetPosition2D(43.000000, 97.000000)
ImpulseEngine1.SetRepairComplexity(4.000000)
ImpulseEngine1.SetDisabledPercentage(0.500000)
ImpulseEngine1.SetRadius(0.010000)
...
PortWarp.SetPosition(-0.063000, 0.000000, -0.010000)
PortWarp.SetPosition2D(12.000000, 107.000000)
...
StarWarp.SetPosition(0.063000, 0.000000, -0.010000)
StarWarp.SetPosition2D(120.000000, 108.000000)
...
#################################################
KlingonShuttle = App.ShipProperty_Create("KlingonShuttle")

KlingonShuttle.SetGenus(1)
KlingonShuttle.SetSpecies(401)
KlingonShuttle.SetMass(45.000000)
KlingonShuttle.SetRotationalInertia(2000.000000)
KlingonShuttle.SetShipName("Bird of Prey")
KlingonShuttle.SetModelFilename("data/Models/Ships/KlingonShuttle/KlingonShuttle.NIF")
KlingonShuttle.SetDamageResolution(10.000000)
KlingonShuttle.SetAffiliation(0)
KlingonShuttle.SetStationary(0)
KlingonShuttle.SetAIString("NonFedAttack")
KlingonShuttle.SetDeathExplosionSound("g_lsDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(KlingonShuttle)
#################################################
...
ImpulseEngine2.SetMaxCondition(2400.000000)
ImpulseEngine2.SetCritical(0)
ImpulseEngine2.SetTargetable(1)
ImpulseEngine2.SetPrimary(1)
ImpulseEngine2.SetPosition(0.028000, -0.052000, 0.000000)
ImpulseEngine2.SetPosition2D(89.000000, 96.000000)
ImpulseEngine2.SetRepairComplexity(4.000000)
ImpulseEngine2.SetDisabledPercentage(0.500000)
ImpulseEngine2.SetRadius(0.010000)
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("KlingonShuttle", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
