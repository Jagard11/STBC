...
AuxPhsr1.SetDamageRadiusFactor(0.250000)
...
AuxPhsr1.SetNormalDischargeRate(1.000000)
...
AuxPhsr2.SetDamageRadiusFactor(0.250000)
...
AuxPhsr2.SetNormalDischargeRate(1.000000)
...
AuxPhsr3.SetDamageRadiusFactor(0.250000)
...
AuxPhsr3.SetNormalDischargeRate(1.000000)
...
AuxPhsr4.SetDamageRadiusFactor(0.250000)
...
AuxPhsr4.SetNormalDischargeRate(1.000000)
