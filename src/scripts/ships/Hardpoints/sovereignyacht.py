# C:\J-Single-testing-KM1\scripts\ships\Hardpoints\sovereignyacht.py
...
Torpedo1.SetPosition(0.001861, 0.125518, 0.014161)
Torpedo1.SetPosition2D(1.000000, 118.000000)
...
Torpedo2.SetPosition(-0.003084, 0.125502, 0.014171)
Torpedo2.SetPosition2D(21.000000, 118.000000)
...
ForPhaser1.SetPosition2D(-3.000000, 31.000000)
...
ForPhaser2.SetPosition2D(13.000000, 31.000000)
...
PortAftPhaser.SetPosition2D(-3.000000, 50.000000)
...
StarImpulse.SetPosition2D(135.000000, 60.000000)
...
PortImpulse.SetPosition2D(120.000000, 59.000000)
...
SensorArray.SetPosition2D(124.000000, -4.000000)
...
WarpCore.SetPosition2D(126.000000, 19.000000)
...
WarpCore.SetPowerOutput(140.000000)
...
ShieldGenerator.SetPosition2D(100.000000, 5.000000)
...
Hull.SetPosition2D(64.000000, 57.000000)
...
PhaserArray.SetNormalPowerPerSecond(1.000000)
...
StarAftPhaser.SetPosition(0.039848, -0.090950, 0.010171)
StarAftPhaser.SetPosition2D(13.000000, 50.000000)
