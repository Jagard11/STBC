# C:\Utopia\Current\Build\scripts\ships\Hardpoints\peregrine.py
...
ImpulseEngines.SetPosition2D(64.000000, 80.000000)
...
Phasers.SetMaxCondition(400.000000)
...
DorsalPhaser1.SetMaxCondition(1200.000000)
DorsalPhaser1.SetCritical(0)
DorsalPhaser1.SetTargetable(1)
DorsalPhaser1.SetPrimary(1)
DorsalPhaser1.SetPosition(0.000000, 0.430000, 0.260000)
...
DorsalPhaser1.SetIndicatorIconPositionX(12.000000)
...
DorsalPhaser1.SetWidth(1.170000)
DorsalPhaser1.SetLength(1.500000)
DorsalPhaser1.SetArcWidthAngles(-0.698132, 1.047198)
DorsalPhaser1.SetArcHeightAngles(-0.034907, 1.221731)
...
DorsalPhaser2.SetMaxCondition(1200.000000)
DorsalPhaser2.SetCritical(0)
DorsalPhaser2.SetTargetable(1)
DorsalPhaser2.SetPrimary(1)
DorsalPhaser2.SetPosition(0.000000, 0.430000, 0.260000)
...
DorsalPhaser2.SetIndicatorIconPositionX(7.000000)
DorsalPhaser2.SetIndicatorIconPositionY(3.000000)
...
DorsalPhaser2.SetLength(1.170000)
DorsalPhaser2.SetArcWidthAngles(-0.349066, 1.221731)
DorsalPhaser2.SetArcHeightAngles(-0.034907, 1.221731)
...
DorsalPhaser3.SetMaxCondition(1200.000000)
DorsalPhaser3.SetCritical(0)
DorsalPhaser3.SetTargetable(1)
DorsalPhaser3.SetPrimary(1)
DorsalPhaser3.SetPosition(0.000000, 0.430000, 0.260000)
...
DorsalPhaser3.SetIndicatorIconPositionX(3.000000)
DorsalPhaser3.SetIndicatorIconPositionY(3.000000)
...
DorsalPhaser3.SetLength(1.170000)
DorsalPhaser3.SetArcWidthAngles(-1.221731, 0.349066)
DorsalPhaser3.SetArcHeightAngles(-0.034907, 1.221731)
...
DorsalPhaser4.SetMaxCondition(1200.000000)
DorsalPhaser4.SetCritical(0)
DorsalPhaser4.SetTargetable(1)
DorsalPhaser4.SetPrimary(1)
DorsalPhaser4.SetPosition(0.000000, 0.430000, 0.260000)
...
DorsalPhaser4.SetIndicatorIconPositionX(-16.000000)
DorsalPhaser4.SetIndicatorIconPositionY(11.000000)
...
DorsalPhaser4.SetWidth(1.170000)
DorsalPhaser4.SetLength(1.500000)
DorsalPhaser4.SetArcWidthAngles(-1.047198, 0.698132)
DorsalPhaser4.SetArcHeightAngles(-0.034907, 1.221731)
...
VentralPhaser1.SetMaxCondition(1200.000000)
...
VentralPhaser1.SetIndicatorIconPositionX(12.000000)
VentralPhaser1.SetIndicatorIconPositionY(11.000000)
...
VentralPhaser1.SetArcHeightAngles(-0.209440, 0.052360)
...
VentralPhaser2.SetMaxCondition(1200.000000)
...
VentralPhaser2.SetIndicatorIconPositionX(7.000000)
VentralPhaser2.SetIndicatorIconPositionY(3.000000)
...
VentralPhaser2.SetLength(0.940000)
VentralPhaser2.SetArcWidthAngles(-0.349066, 1.221731)
...
VentralPhaser3.SetMaxCondition(1200.000000)
...
VentralPhaser3.SetIndicatorIconPositionX(3.000000)
VentralPhaser3.SetIndicatorIconPositionY(3.000000)
...
VentralPhaser3.SetLength(0.940000)
VentralPhaser3.SetArcWidthAngles(-1.221731, 0.349066)
...
VentralPhaser4.SetMaxCondition(1200.000000)
...
VentralPhaser4.SetIndicatorIconPositionX(-16.000000)
VentralPhaser4.SetIndicatorIconPositionY(11.000000)
...
VentralPhaser4.SetWidth(0.940000)
VentralPhaser4.SetLength(1.190000)
VentralPhaser4.SetArcWidthAngles(-0.872665, 0.872665)
VentralPhaser4.SetArcHeightAngles(-0.209440, 0.052360)
...
PortImpulse.SetPosition2D(29.000000, 80.000000)
...
StarImpulse.SetPosition2D(100.000000, 80.000000)
...
PortWarp.SetPosition(-1.200000, -1.200000, -0.500000)
...
StarWarp.SetPosition(1.200000, -1.200000, -0.500000)
...
#################################################
ScienceModule = App.HullProperty_Create("Science Module")

ScienceModule.SetMaxCondition(3000.000000)
ScienceModule.SetCritical(0)
ScienceModule.SetTargetable(1)
ScienceModule.SetPrimary(0)
ScienceModule.SetPosition(0.000000, -1.400000, 0.500000)
ScienceModule.SetPosition2D(64.000000, 95.000000)
ScienceModule.SetRepairComplexity(3.000000)
ScienceModule.SetDisabledPercentage(0.000000)
ScienceModule.SetRadius(0.500000)
App.g_kModelPropertyManager.RegisterLocalTemplate(ScienceModule)
#################################################
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("Science Module", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
