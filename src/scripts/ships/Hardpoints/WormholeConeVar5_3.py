# C:\unzipped\DS9FX\DS9FX\DS9FX Full\scripts\ships\Hardpoints\WormholeConeVar5_3.py
...
Wormhole.SetModelFilename("data/Models/Bases/CordanilusWormholeGFX/inner2.nif")
