# C:\unzipped\DS9FX\DS9FX\DS9FX Full\scripts\ships\Hardpoints\WormholeConeVar1_1.py
...
Wormhole.SetModelFilename("data/Models/Bases/PsychoRetextureWormholeGFX/outer.NIF")
