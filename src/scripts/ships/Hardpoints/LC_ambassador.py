# D:\Spiele\Bridge Commander\scripts\ships\Hardpoints\LC_ambassador.py
...
ShieldGenerator.SetPosition(0.000000, -0.293800, 0.000000)
...
SensorArray.SetPosition(0.000000, 0.146900, -0.350000)
...
WarpCore.SetPosition(0.000000, -0.400000, -0.300000)
...
WarpEngines.SetPosition(-0.146900, -0.734500, -0.440700)
...
Torpedoes.SetPosition(0.000000, 0.146900, -0.350000)
Torpedoes.SetPosition2D(64.000000, 45.000000)
...
VentralPhaser1.SetPosition(-0.500000, 1.023540, 0.200000)
...
VentralPhaser1.SetWidth(0.500000)
...
VentralPhaser2.SetPosition(0.011082, 1.500000, 0.200000)
...
VentralPhaser2.SetWidth(0.500000)
...
VentralPhaser3.SetPosition(0.500000, 1.023540, 0.200000)
...
VentralPhaser3.SetWidth(0.500000)
...
ForwardTorpedo1.SetPosition(0.001069, 0.484920, 0.102482)
...
ForwardTorpedo2.SetPosition(0.001850, 0.450405, 0.060484)
...
AftTorpedo1.SetPosition(-0.016228, -1.030920, -0.409659)
...
AftTorpedo2.SetPosition(0.035366, -1.033010, -0.408891)
...
PortWarp.SetPosition(-1.050000, -1.700000, 0.293800)
...
StarWarp.SetPosition(1.050000, -1.700000, 0.293800)
...
Engineering.SetPosition(0.000000, -0.734500, -0.440700)
...
ForwardTractor.SetPosition(0.007846, 0.077094, -0.569240)
...
Bridge.SetPrimary(0)
Bridge.SetPosition(0.004651, 1.046690, 0.500000)
...
AftTractor.SetPosition(0.010656, -0.879335, -0.560073)
...
DorsalPhaser1.SetPosition(-0.907514, 1.038650, 0.484715)
...
DorsalPhaser2.SetPosition(0.001590, 1.953880, 0.484715)
...
DorsalPhaser2.SetWidth(0.550000)
...
DorsalPhaser3.SetPosition(0.907514, 1.038650, 0.484715)
...
AftPhaser1.SetPosition(-0.338323, -0.020000, 0.485350)
...
AftPhaser1.SetMaxDamageDistance(90.000000)
...
AftPhaser1Forward.SetXYZ(-0.287348, -0.957826, 0.000000)
...
AftPhaser2.SetPosition(0.338323, -0.020000, 0.485350)
...
AftPhaser2.SetMaxDamageDistance(90.000000)
...
AftPhaser2Forward.SetXYZ(0.287348, -0.957826, 0.000000)
...
ViewscreenForwardPosition.SetXYZ(0.000000, 2.602010, 0.369685)
...
ViewscreenBackPosition.SetXYZ(0.000000, -0.519405, 0.379807)
...
ViewscreenLeftPosition.SetXYZ(-1.567930, 1.014540, 0.364249)
...
ViewscreenRightPosition.SetXYZ(1.567930, 1.014540, 0.364249)
...
ViewscreenUpPosition.SetXYZ(0.000000, 1.048450, 0.631950)
...
ViewscreenDownPosition.SetXYZ(0.000000, 1.034740, 0.128465)
...
FirstPersonCameraPosition.SetXYZ(0.000000, 2.602010, 0.369685)
