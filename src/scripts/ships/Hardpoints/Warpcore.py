...
Warpcore.SetGenus(1)
Warpcore.SetSpecies(198)
Warpcore.SetMass(1000.000000)
Warpcore.SetRotationalInertia(500.000000)
Warpcore.SetShipName("Warpcore")
Warpcore.SetModelFilename("data/Models/Misc/Warpcore/sovvy core.NIF")
Warpcore.SetDamageResolution(10.000000)
Warpcore.SetAffiliation(0)
Warpcore.SetStationary(0)
Warpcore.SetAIString("FedAttack")
