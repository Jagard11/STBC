...
PhasedPoleronBeam1.SetMaxCharge(1.000000)
...
PhasedPoleronBeam1.SetNormalDischargeRate(1.000000)
...
PhasedPoleronBeam2.SetMaxCharge(1.000000)
...
AftPolaronBeam.SetMaxCharge(1.000000)
...
AftPolaronBeam.SetNormalDischargeRate(1.000000)
