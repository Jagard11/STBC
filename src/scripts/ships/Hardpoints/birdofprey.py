# C:\Users\Owner\Documents\KMFinalHP_Changes_(2)\birdofprey.py
...
FwdTorpedo.SetPosition(-0.000515, 0.529539, 0.024180)
...
PortCannon.SetPosition(-0.607458, 0.314755, -0.245047)
...
PortCannon.SetArcWidthAngles(-0.261799, 0.261799)
...
StarCannon.SetPosition(0.610079, 0.314755, -0.244837)
...
StarCannon.SetArcWidthAngles(-0.261799, 0.261799)
...
ImpulseEngine.SetMaxCondition(7000.000000)
...
BirdofPrey.SetModelFilename("data/Models/Ships/BirdOfPrey/Birdofprey.NIF")
...
TractorBeams.SetMaxCondition(800.000000)
...
TractorBeams.SetNormalPowerPerSecond(200.000000)
...
ForwardTractor.SetPosition(0.006630, 0.144347, 0.006736)
...
ShuttleBayOEPPosition.SetXYZ(0.000047, -0.241618, -0.010667)
...
ShuttleBay.SetPosition(0.000572, -0.234905, -0.012614)
ShuttleBay.SetPosition2D(0.000000, 0.000000)
ShuttleBay.SetRepairComplexity(1.000000)
ShuttleBay.SetDisabledPercentage(0.950000)
