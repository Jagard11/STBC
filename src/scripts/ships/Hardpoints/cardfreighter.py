# C:\Documents and Settings\Owner.STARFLEETHQ\My Documents\KM 1.0 Changes (2)\scripts\ships\Hardpoints\CardFreighter.py
...
#################################################
DisruptorBeamSystem = App.WeaponSystemProperty_Create("Disruptor Beam System")

DisruptorBeamSystem.SetMaxCondition(1000.000000)
DisruptorBeamSystem.SetCritical(0)
DisruptorBeamSystem.SetTargetable(1)
DisruptorBeamSystem.SetPrimary(1)
DisruptorBeamSystem.SetPosition(0.000000, 0.000000, 0.000000)
DisruptorBeamSystem.SetPosition2D(0.000000, 0.000000)
DisruptorBeamSystem.SetRepairComplexity(1.000000)
DisruptorBeamSystem.SetDisabledPercentage(0.500000)
DisruptorBeamSystem.SetRadius(0.250000)
DisruptorBeamSystem.SetNormalPowerPerSecond(1.000000)
DisruptorBeamSystem.SetWeaponSystemType(DisruptorBeamSystem.WST_PHASER)
DisruptorBeamSystem.SetSingleFire(1)
DisruptorBeamSystem.SetAimedWeapon(0)
kFiringChainString = App.TGString()
kFiringChainString.SetString("")
DisruptorBeamSystem.SetFiringChainString(kFiringChainString)
App.g_kModelPropertyManager.RegisterLocalTemplate(DisruptorBeamSystem)
#################################################
DisruptorBeam = App.PhaserProperty_Create("Disruptor Beam")

DisruptorBeam.SetMaxCondition(1000.000000)
DisruptorBeam.SetCritical(0)
DisruptorBeam.SetTargetable(1)
DisruptorBeam.SetPrimary(1)
DisruptorBeam.SetPosition(-0.002533, 1.843660, 0.015748)
...
DisruptorBeam.SetDumbfire(0)
DisruptorBeam.SetWeaponID(0)
DisruptorBeam.SetGroups(0)
DisruptorBeam.SetDamageRadiusFactor(0.250000)
DisruptorBeam.SetIconNum(0)
DisruptorBeam.SetIconPositionX(0.000000)
DisruptorBeam.SetIconPositionY(0.000000)
DisruptorBeam.SetIconAboveShip(1)
DisruptorBeam.SetFireSound("CardBeam")
DisruptorBeam.SetMaxCharge(5.000000)
DisruptorBeam.SetMaxDamage(300.000000)
DisruptorBeam.SetMaxDamageDistance(100.000000)
DisruptorBeam.SetMinFiringCharge(1.000000)
DisruptorBeam.SetNormalDischargeRate(1.000000)
DisruptorBeam.SetRechargeRate(0.300000)
DisruptorBeam.SetIndicatorIconNum(0)
DisruptorBeam.SetIndicatorIconPositionX(0.000000)
DisruptorBeam.SetIndicatorIconPositionY(0.000000)
DisruptorBeamForward = App.TGPoint3()
DisruptorBeamForward.SetXYZ(-0.000417, 0.995563, 0.094095)
DisruptorBeamUp = App.TGPoint3()
DisruptorBeamUp.SetXYZ(-0.730257, -0.064579, 0.680113)
DisruptorBeam.SetOrientation(DisruptorBeamForward, DisruptorBeamUp)
DisruptorBeam.SetWidth(0.001000)
DisruptorBeam.SetLength(0.001000)
DisruptorBeam.SetArcWidthAngles(-0.349066, 0.349066)
DisruptorBeam.SetArcHeightAngles(-0.349066, 0.349066)
DisruptorBeam.SetPhaserTextureStart(8)
DisruptorBeam.SetPhaserTextureEnd(15)
DisruptorBeam.SetPhaserWidth(0.300000)
kColor = App.TGColorA()
kColor.SetRGBA(1.000000, 0.501961, 0.000000, 1.000000)
DisruptorBeam.SetOuterShellColor(kColor)
kColor.SetRGBA(1.000000, 0.501961, 0.247059, 1.000000)
DisruptorBeam.SetInnerShellColor(kColor)
kColor.SetRGBA(1.000000, 1.000000, 0.000000, 1.000000)
DisruptorBeam.SetOuterCoreColor(kColor)
kColor.SetRGBA(0.992157, 1.000000, 0.247059, 1.000000)
DisruptorBeam.SetInnerCoreColor(kColor)
DisruptorBeam.SetNumSides(6)
DisruptorBeam.SetMainRadius(0.100000)
DisruptorBeam.SetTaperRadius(0.010000)
DisruptorBeam.SetCoreScale(0.500000)
DisruptorBeam.SetTaperRatio(0.250000)
DisruptorBeam.SetTaperMinLength(2.000000)
DisruptorBeam.SetTaperMaxLength(10.000000)
DisruptorBeam.SetLengthTextureTilePerUnit(0.500000)
DisruptorBeam.SetPerimeterTile(1.000000)
DisruptorBeam.SetTextureSpeed(2.500000)
DisruptorBeam.SetTextureName("data/CACardassian.tga")
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("Disruptor Beam System", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
