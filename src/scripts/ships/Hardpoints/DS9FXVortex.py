# C:\Downloads\DS9FX\scripts\ships\Hardpoints\DS9FXVortex.py
...
#################################################
DS9FXVortex = App.ShipProperty_Create("DS9FXVortex")

DS9FXVortex.SetGenus(1)
DS9FXVortex.SetSpecies(710)
DS9FXVortex.SetMass(0.000000)
DS9FXVortex.SetRotationalInertia(500.000000)
DS9FXVortex.SetShipName("DS9FXVortex")
DS9FXVortex.SetModelFilename("data/Models/Ships/DS9FX/Vortex/BadlandsVortex.nif")
DS9FXVortex.SetDamageResolution(10.000000)
DS9FXVortex.SetAffiliation(0)
DS9FXVortex.SetStationary(0)
DS9FXVortex.SetAIString("FedAttack")
DS9FXVortex.SetDeathExplosionSound("g_lsDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(DS9FXVortex)
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("DS9FXVortex", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
