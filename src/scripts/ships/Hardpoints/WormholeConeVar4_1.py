# C:\unzipped\DS9FX\DS9FX\DS9FX Full\scripts\ships\Hardpoints\WormholeConeVar4_1.py
...
Wormhole.SetModelFilename("data/Models/Bases/PSYCH0WormholeGFX-RedDawn/outer.NIF")
