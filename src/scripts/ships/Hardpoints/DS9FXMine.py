# C:\Program Files\Activision\Bridge Commander\scripts\ships\Hardpoints\DS9-Hardpoints\DS9FXMine.py
...
Asteroid.SetMaxCondition(3000.000000)
...
Asteroid.SetRepairComplexity(1.000000)
Asteroid.SetDisabledPercentage(0.000000)
Asteroid.SetRadius(0.800000)
...
AsteroidMass.SetMass(400.000000)
AsteroidMass.SetRotationalInertia(10000.000000)
AsteroidMass.SetShipName("DS9FXMine")
AsteroidMass.SetModelFilename("data/Models/Ships/DS9FX/Mine/mine.NIF")
