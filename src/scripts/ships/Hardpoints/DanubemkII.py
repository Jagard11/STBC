...
RollbarTorp.SetDamageRadiusFactor(0.200000)
...
RollbarTorp.SetReloadDelay(25.000000)
...
RollbarTorp2.SetDamageRadiusFactor(0.200000)
...
RollbarTorp2.SetReloadDelay(25.000000)
