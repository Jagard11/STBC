# C:\unzipped\DS9FX\DS9FX\DS9FX Full\scripts\ships\Hardpoints\WormholeConeVar1_2.py
...
Wormhole.SetModelFilename("data/Models/Bases/PsychoRetextureWormholeGFX/inner.NIF")
