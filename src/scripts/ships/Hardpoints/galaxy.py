...
ForwardTorpedo1.SetMaxCondition(6000.000000)
ForwardTorpedo1.SetCritical(0)
ForwardTorpedo1.SetTargetable(1)
ForwardTorpedo1.SetPrimary(1)
ForwardTorpedo1.SetPosition(-0.016759, 0.283280, -0.090587)
...
ForwardTorpedo2.SetPosition(-0.026163, 0.283333, -0.090487)
...
ForwardTorpedo3.SetPosition(-0.037102, 0.283268, -0.090610)
...
ForwardTorpedo4.SetMaxCondition(6000.000000)
ForwardTorpedo4.SetCritical(0)
ForwardTorpedo4.SetTargetable(1)
ForwardTorpedo4.SetPrimary(1)
ForwardTorpedo4.SetPosition(-0.046507, 0.283321, -0.090510)
...
AftTorpedo1.SetMaxCondition(6000.000000)
AftTorpedo1.SetCritical(0)
AftTorpedo1.SetTargetable(1)
AftTorpedo1.SetPrimary(1)
AftTorpedo1.SetPosition(-0.036060, -2.215020, -0.386379)
...
AftTorpedo2.SetMaxCondition(6000.000000)
AftTorpedo2.SetCritical(0)
AftTorpedo2.SetTargetable(1)
AftTorpedo2.SetPrimary(1)
AftTorpedo2.SetPosition(-0.022993, -2.215530, -0.387013)
...
DorsalMainArray.SetPosition(0.000000, 1.450000, 0.510000)
...
VentralMainArray.SetPosition(0.000000, 1.450000, 0.220000)
...
SensorArray.SetPosition(-0.034344, 1.435140, 0.080000)
...
WarpCore.SetPosition(0.000000, -1.350000, -0.480000)
...
AftTractor2.SetPosition(-0.040194, -1.059640, -0.638574)
...
Engineering.SetPosition(0.000000, -1.500000, -0.400000)
...
PortWarp.SetPosition(-1.300000, -1.600000, -0.060000)
...
StarWarp.SetPosition(1.300000, -1.600000, -0.060000)
...
PortImpulse.SetPosition(-1.150000, 0.035380, 0.336546)
...
StarImpulse.SetPosition(1.130000, 0.035380, 0.336546)
...
CenterImpulse.SetPosition(-0.031871, -0.793152, -0.009642)
...
CenterImpulse.SetRadius(0.130000)
...
AftTractor1.SetPosition(-0.036161, 0.458088, 0.523673)
...
ProbeLauncherPosition.SetXYZ(-0.024900, 0.286387, -0.084653)
...
Bridge.SetPrimary(0)
Bridge.SetPosition(-0.033275, 1.300790, 0.600000)
...
ForwardTractor1.SetPosition(-0.022710, 2.420220, 0.523904)
...
ShuttleBay.SetPosition(-0.011680, 0.493654, 0.550699)
