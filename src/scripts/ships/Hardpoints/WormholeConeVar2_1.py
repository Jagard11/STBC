# C:\unzipped\DS9FX\DS9FX\DS9FX Full\scripts\ships\Hardpoints\WormholeConeVar2_1.py
...
Wormhole.SetModelFilename("data/Models/Bases/PSYCH0WormholeGFX-BlackHole/outer.NIF")
