...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Bases/StarBase329/StarBase329.NIF",
		"FilenameMed": "data/Models/Bases/StarBase329/StarBase329.NIF",
		"FilenameLow": "data/Models/Bases/StarBase329/StarBase329.NIF",
		"Name": "StarBase329",
		"HardpointFile": "StarBase329",
		"Species": Multiplayer.SpeciesToShip.STARBASE329,
		"DamageRadMod" : 5.0,
		"DamageStrMod" : 0.2
	}
	return kShipStats
