...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Bases/PSYCH0WormholeGFX-RedDawn/outer.NIF",
		"FilenameMed": "data/Models/Bases/PSYCH0WormholeGFX-RedDawn/outer.NIF",
		"FilenameLow": "data/Models/Bases/PSYCH0WormholeGFX-RedDawn/outer.NIF",
		"Name": "WormholeConeVar4_1",
		"HardpointFile": "WormholeConeVar4_1",
