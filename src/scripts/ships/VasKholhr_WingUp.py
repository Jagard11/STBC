...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/VasKholhr/VasWarp.NIF",
		"FilenameMed": "data/Models/Ships/VasKholhr/VasWarp.NIF",
		"FilenameLow": "data/Models/Ships/VasKholhr/VasWarp.NIF",
		"Name": "Vas Kholhr WingUp",
		"HardpointFile": "VasKholhr_up",
