...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Bases/PSYCH0WormholeGFX-RedDawn/inner.NIF",
		"FilenameMed": "data/Models/Bases/PSYCH0WormholeGFX-RedDawn/inner.NIF",
		"FilenameLow": "data/Models/Bases/PSYCH0WormholeGFX-RedDawn/inner.NIF",
		"Name": "WormholeConeVar4_2",
		"HardpointFile": "WormholeConeVar4_2",
