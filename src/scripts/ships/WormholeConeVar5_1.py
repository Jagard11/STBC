...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Bases/CordanilusWormholeGFX/outer.nif",
		"FilenameMed": "data/Models/Bases/CordanilusWormholeGFX/outer.nif",
		"FilenameLow": "data/Models/Bases/CordanilusWormholeGFX/outer.nif",
		"Name": "WormholeConeVar5_1",
		"HardpointFile": "WormholeConeVar5_1",
