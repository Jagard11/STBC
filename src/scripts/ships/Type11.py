...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/Type11/Type11.NIF",
		"FilenameMed": "data/Models/Ships/Type11/Type11.NIF",
		"FilenameLow": "data/Models/Ships/Type11/Type11.NIF",
		"Name": "Type11",
		"HardpointFile": "Type11",
		"Species": Multiplayer.SpeciesToShip.TYPE11
		 }
	return kShipStats
