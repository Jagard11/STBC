...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Bases/BrenWormhole/brenwormhole.NIF",
		"FilenameMed": "data/Models/Bases/BrenWormhole/brenwormhole.NIF",
		"FilenameLow": "data/Models/Bases/BrenWormhole/brenwormhole.NIF",
		"Name": "Wormhole7",
		"HardpointFile": "Wormhole7",
