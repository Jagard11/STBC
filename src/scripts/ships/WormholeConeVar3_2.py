...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Bases/PSYCH0WormholeGFX-Slipstream/inner.NIF",
		"FilenameMed": "data/Models/Bases/PSYCH0WormholeGFX-Slipstream/inner.NIF",
		"FilenameLow": "data/Models/Bases/PSYCH0WormholeGFX-Slipstream/inner.NIF",
		"Name": "WormholeConeVar3_2",
		"HardpointFile": "WormholeConeVar3_2",
