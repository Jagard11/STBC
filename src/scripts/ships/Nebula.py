...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/Nebula/High/Nebula.nif",
		"FilenameMed": "data/Models/Ships/Nebula/High/Nebula.nif",
		"FilenameLow": "data/Models/Ships/Nebula/High/Nebula.nif",
		"Name": "Nebula",
