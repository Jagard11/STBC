...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/BreenCA/BreenCA.NIF",
		"FilenameMed": "data/Models/Ships/BreenCA/BreenCA.NIF",
		"FilenameLow": "data/Models/Ships/BreenCA/BreenCA.NIF",
		"Name": "BreenCA",
		"HardpointFile": "BreenCA",
		"Species": Multiplayer.SpeciesToShip.BREENCA,
		"SpecularCoef": 0.5,
		 }
	return kShipStats
