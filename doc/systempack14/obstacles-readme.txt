...
encourage Tourism and stimulates the economy.

SYSTEM NOTES
These are a few obstacles courses to run through, each with its own solar 
system with obstacles.
 Obstacles 1: Short race with a few curves and challenges.
 Obstacles 2: Longer race with more complicated hurdles.
