...
This particular set is to install the The Galaxy Set as a new location in QuickBattle 
...
encourage TheGalaxy Tourism and stimulates the TheGalaxy economy.

SYSTEM NOTES
Several warp points, many of them are populated. Feel free to explore.

The Galaxy:
One: Galactic Core, a dense cluster of stars
Two: Earth, with orbiting stations, Moon and ground targets.
Three: Vulcan, with targetable location.
Four: Kronos, with moons, stations and ground targets.
Five: Romulus, with stations, system and ground targets
Six: The Rim of the galaxy.
Seven: Intergalactic Space, where its very dark.
