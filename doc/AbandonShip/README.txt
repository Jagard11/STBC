...
This is the Abandon Ship Script by Defiant & scottpkeene.


Authors:
<---------->
Models by scottpkeene
script by Defiant
http://defiant.homedns.org/~bccorps


Requirements:
<---------->
-The Engineering script 0.5 or higher


Bugs:
<---------->
none known, If you find one, contact us please on http://defiant.homedns.org/~bccorps/
